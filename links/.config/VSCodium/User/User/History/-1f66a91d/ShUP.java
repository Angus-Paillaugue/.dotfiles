...
public class ControleurAjouterGarant implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (target.getName().equals("saveButton")) {
      ...
      try {
        ...
        Personne garant =
            new Personne(
                ...
                VuesUtils.getInputValue(vue.panel,
                    "lieuNaissance"),
        ...
        personneDAO.create(garant);
        GarantDAO garantDAO = new GarantDAO();
        garantDAO.ajouterGarant(garant, l, this.isColocation);

        new ProfilLocataire(this.vue.locataire, this.vue.location, false, this.vue.lo).setVisible(true);
      ...
      vue.dispose();
      new ProfilLocataire(this.vue.locataire, this.vue.location, false, this.isColocation).setVisible(true);
    }
  }
}
