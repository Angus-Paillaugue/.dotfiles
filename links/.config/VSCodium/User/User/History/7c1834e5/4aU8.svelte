...
<div id={title+"Window"} class={cn("flex absolute flex-col rounded-lg overflow-hidden border transition-[scale,opacity] border-neutral-700/50", className)} bind:this={windowElement}>
  <div class="flex flex-row shrink-0 items-center w-full bg-neutral-800 p-2 gap-2 titleBar">
    ...
    <div class="size-4 rounded-full flex flex-col items-center bg-[#14c01e] border border-[#10c20c] text-[#097402] hover:bg-[#3aea49] transition-all group justify-center maximizeBtn">
      <svg viewBox="0 0 59.999996 60" version="1.1" fill="currentColor" stroke="none" xmlns="http://www.w3.org/2000/svg" stroke-width="0" stroke-linecap="round" stroke-linejoin="round" class="size-2 opacity-0 group-hover:opacity-100 transition-opacity"><path d="M 0,0 V 43.632743 A 6.3672573,6.3672573 45 0 0 6.3672573,50 H 50 Z" transform="translate(0,10)" /><path d="M 0,0 V 43.632743 A 6.3672573,6.3672573 45 0 0 6.3672573,50 H 50 Z" transform="rotate(180,30,25)" /></svg>
    </div>
  </div>
