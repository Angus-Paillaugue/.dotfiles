<script lang="ts">
	...
	import { Pause, Play, SkipBack, SkipForward, EllipsisVertical, ChevronDown, Plus } from 'lucide-svelte';
			...
			>
				...
				>
					...
					<Dropdown position="top" align="end">
						<Dropdown.Trigger variant="none" class="size-8 shrink-0 rounded-full p-2 transition-all hover:bg-background max-md:hidden">
