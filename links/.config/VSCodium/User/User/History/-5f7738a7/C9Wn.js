...
import fs from 'fs';
import { createTheme } from 'shiki'; // Assuming you're using Shiki

const theme = createTheme('one-dark-pro'); // Replace with your desired theme

// Extract background color (replace with actual logic)
const bgColor = theme.tokenColors.find((token) => token.name === 'background').settings.background;

// Set the custom property
document.documentElement.style.setProperty('--shiki-bg-color', bgColor);
