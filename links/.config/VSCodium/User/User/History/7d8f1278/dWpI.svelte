...
<div class="h-screen flex flex-col overflow-hidden">
  ...
  <div class="w-full flex flex-row grow overflow-hidden">
    <!-- Sidebar -->
    <!-- TODO: Make it responsive -->
    <div class="flex flex-col max-w-[250px] w-full h-full shrink-0 border-r border-border">
      <div class="p-4">
      ...
      <hr>
      <div class="flex flex-col gap-2 mt-4 mb-2 overflow-y-auto">
        <div class="flex flex-row gap-2 items-center px-4 group shrink-0">
        ...
        <div class="flex flex-col p-2 gap-2 max-h-[400px] overflow-y-auto shrink-0">
