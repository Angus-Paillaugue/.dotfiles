<script>
  ...
  import { toggleMode, mode, theme } from 'mode-watcher';
...
>
  ...
  <div class="flex flex-col pl-4 pr-2 pt-4">
    <a href="/">
      <h3 class="m-0 flex flex-row gap-2 items-center">
        <img src="/logos/{project.name}-{$mode ?? "light"}.svg" alt="{project.name}'s logo" class="w-12 h-8 object-contain">
        {project.name}
      </h3>
    </a>
