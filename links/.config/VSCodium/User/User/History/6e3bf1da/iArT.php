...
<body>
  ...
  <div class="fixed inset-0 bg-black/50 p-2 -z-10 transition-opacity opacity-0 flex flex-col items-center justify-center" id="modal">
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" class="p-4 border mb-8 grid grid-cols-2 gap-6 rounded-xl relative max-w-screen-md bg-white prose">
      <button class="absolute top-2 right-2 size-8" variant="ghost square" type="button" id="close-modal">
  ...
  <div class="max-w-screen-lg mx-auto w-full p-4 prose">
    <div class="border p-4 rounded-xl">
      <div class='flex flex-row justify-between w-full mb-4'>
        ...
        <button type='button' variant='primary square' class='p-2 rounded-full' id='open-modal'>
