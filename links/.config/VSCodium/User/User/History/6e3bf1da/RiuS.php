...
<body>
  ...
  <div class="fixed inset-0 bg-black/50 -z-10 opacity-0" id="modal">
  ...
  <div class="max-w-screen-lg mx-auto w-full p-4 prose">
    <div class="flex flex-row justify-between">
      <h1 class="col-span-2">Ajouter un contract</h1>
    </div>
    ...
    <?php
      ...
      echo "
        <div class='flex flex-row'>
          <h1>Contracts</h1>
          <button type="button" variant="primary" id="open-modal">
          <svg xmlns="http://www.w3.org/2000/svg" class="size-6 text-white p-2 rounded-full" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-plus"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
        </button>
        </div>
