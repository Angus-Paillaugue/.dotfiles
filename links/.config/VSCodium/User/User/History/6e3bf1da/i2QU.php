...
<body>
  ...
  <div class="fixed inset-0 bg-black/50 p-2 transition-opacity flex flex-col items-center justify-center" id="modal" style="z-index:<?php echo $error ? '10' : '0'; ?>; opacity:<?php echo $error ? '1' : '0'; ?>;">
