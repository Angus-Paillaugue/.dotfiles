  ...
  <div class="max-w-screen-lg mx-auto w-full p-4 prose">
    <div class="border p-4 rounded-xl">
      <div class='flex flex-row justify-between w-full mb-4'>
          ...
          <svg xmlns='http://www.w3.org/2000/svg' class='size-10 text-white p-2 rounded-full' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M5 12h14'/><path d='M12 5v14'/></svg>
        </button>
        </div>
