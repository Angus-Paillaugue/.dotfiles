<script lang="ts">
    ...
    navMain: [
      {
        ...
        url: '/app',
        icon: Settings2,
        isActive: $page.url.pathname === '/app' || $page.url.pathname === '/app/logs',
        items: [
          {
            title: 'Overview',
            url: '/app'
      ...
      },
      {
        ...
        icon: ServerIcon,
        url: '/app/servers',
        isActive: $page.url.pathname.startsWith('/app/servers'),
  ...
  $inspect($page.url.pathname === '/app' || $page.url.pathname === '/app/logs', $page.url.pathname.startsWith('/app/servers'));
</script>
