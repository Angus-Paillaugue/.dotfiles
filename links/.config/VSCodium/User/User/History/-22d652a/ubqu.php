...
try {
  ...
  ErrorHandling::setFatalError('Erreur lors de la récupération des données');
}
?>
...
<div class="max-w-screen-xl w-full mx-auto p-4 rounded-xl border space-y-6 border-neutral-900">
  ...
  foreach ($joueurs as $joueur) {
    echo "<tr class='even:bg-neutral-900'><td class='px-4 py-1 align-middle'><a class='hover:underline' href='/dashboard/joueur.php?id=" . $joueur->getId() . "'>" .
      $joueur->getNom() .
