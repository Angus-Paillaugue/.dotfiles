...
<div class="max-w-screen-xl w-full mx-auto p-4 rounded-xl border space-y-6 border-neutral-300/50 dark:border-neutral-900">
  ...
  <?php
  echo "<div class='flex max-md:flex-col md:grid grid-cols-2 gap-8'><div class='flex flex-row items-start justify-start gap-4 flex-wrap'>";
  Components::Button([
  ...
  foreach ($joueurs as $joueur) {
    echo "<tr class='even:bg-neutral-100 dark:even:bg-neutral-900'><td class='px-4 py-1 align-middle'><a class='hover:underline' href='/dashboard/joueur.php?id=" .
      $joueur->getId() .
      "'>" .
      $joueur->getNom() .
