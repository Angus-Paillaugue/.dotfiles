...
<div class="max-w-screen-xl w-full mx-auto p-4 rounded-xl border space-y-6 border-neutral-300/50 dark:border-neutral-900">
  ...
  Components::Button([
    ...
    'href' => '/vue/dashbaord/add-rencontre.php',
    'icon' => 'plus',
  ]);
  Components::Button([
    'label' => 'Ajouter un joueur',
    'href' => '/vue/dashbaord/add-joueur.php',
    'icon' => 'plus',
  ]);
  Components::Button([
    'label' => 'Statistiques',
    'href' => '/vue/dashbaord/statistiques.php',
    'icon' => 'chart',
  ]);
  echo '</div>';
  ...
  foreach ($joueurs as $joueur) {
    echo "<tr class='even:bg-neutral-100 dark:even:bg-neutral-900'><td class='px-4 py-1 align-middle'><a class='hover:underline' href='/vue/dashbaord/joueur.php?id=" .
      $joueur->getId() .
      "'>" .
      $joueur->getNom() .
  ...
  if (count($rencontres['previous']) > 0) {
    ...
    Components::Button([
      'label' => 'Voir tout',
      'variant' => 'primary',
      'href' => '/vue/dashbaord/rencontres.php?previous',
      'icon' => 'plus',
    ]);
    echo "</div><div class='grid grid-cols-1 lg:grid-cols-2 gap-4'>";
