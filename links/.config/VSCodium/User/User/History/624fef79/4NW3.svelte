...
<nav class={cn("sticky flex transition-all z-20 text-primary mx-auto flex-row duration-500 justify-between items-center top-2 px-3 h-16 rounded-2xl border max-w-screen-xl", isNavActive ? 'w-2/3 bg-background shadow border-border' : 'w-full bg-sidebar border-sidebar')}>
