...
<div class="relative left-0 right-0 top-4 flex flex-row items-start justify-center">
    ...
    <Toast />
		{#if $toasts.length > 1}
			<div
				class="flex h-14 shrink-0 flex-row items-center justify-center rounded-full overflow-hidden absolute top-0 left-full ml-4 bg-black text-xl font-bold text-white md:h-14 shadow-lg"
