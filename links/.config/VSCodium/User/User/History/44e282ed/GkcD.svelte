<script lang="ts">
  ...
  let { songs, class: className, rows = 2, cols = 3, ...restProps }: (Props & SvelteHTMLElements['div']) = $props();
...
<div class={cn("w-full overflow-hidden relative pb-7", className)} {...restProps}>
