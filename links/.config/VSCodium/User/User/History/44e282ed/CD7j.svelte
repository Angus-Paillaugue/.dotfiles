...
<div class={cn("w-full overflow-hidden relative pb-8", className)}>
  <div class='w-full flex flex-row overflow-x-auto snap-x snap-mandatory no-scrollbar' onscroll={setCurrentPage} bind:this={carouselElement}>
