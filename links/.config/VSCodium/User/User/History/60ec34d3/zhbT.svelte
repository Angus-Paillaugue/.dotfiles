  ...
  >
    {#if previousPage}
      <a
        ...
        class="relative h-full cursor-pointer flex flex-col gap-2 rounded p-2 pr-8 transition-colors md:p-4 md:pr-8 hover:bg-sidebar"
      >
    ...
    {#if nextPage}
      <a
        href={nextPage.url}
        class="relative h-full cursor-pointer flex flex-col justify-end text-end items-end gap-2 rounded p-2 pr-8 transition-colors md:p-4 md:pr-8 hover:bg-sidebar"
      >
