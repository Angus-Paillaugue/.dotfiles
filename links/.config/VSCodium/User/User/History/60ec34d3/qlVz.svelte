...
<div class="mt-auto">
  ...
  >
    {#if previousPage}
      ...
      >
        ...
        <div class="flex flex-row items-center justify-start gap-1">
          ...
          />
          <span
            class="text-lg font-semibold text-muted-foreground line-"
          >
            {previousPage.name}
          </span>
        </div>
    ...
    {#if nextPage}
      <a
        href={nextPage.url}
        class="relative h-full cursor-pointer flex flex-col justify-end text-end items-end gap-2 rounded p-2 pr-8 transition-all md:p-4 md:pr-8"
      >
