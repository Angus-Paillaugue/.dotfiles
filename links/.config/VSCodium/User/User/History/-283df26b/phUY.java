...
public class PersonneDAO {
  ...
  public Personne create(Personne p, int idLocation, int idColocation) {
    try {
      ...
      String query =
          "INSERT INTO Personne (nom, prenom, dateNaissance, situationFamiliale, profession, employeur, typeContratDeTravail, remunerationMensuelleNette, autreRevenus, email, telephone, idAdresseResidence, idAdresseNaissance) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
      int idPersonne =
          db.executeUpdate(
              query,
              Arrays.asList(
