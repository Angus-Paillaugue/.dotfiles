...
public class PersonneDAO implements PersonneDAODef {
  ...
  public Personne wcreate(Personne p, int idAdresseResidence) {
    try {
      Connector db = Connector.getInstance();

      String query =
          "INSERT INTO Personne (id, nom, prenom, dateNaissance, situationFamiliale, profession, employeur, typeContratDeTravail, remunerationMensuelleNette, autreRevenus, email, telephone, idAdresseResidence, idAdresseNaissance) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
      int idPersonne =
          db.executeUpdate(
              query,
              Arrays.asList(
