...
public class PersonneDAO {
  ...
  public int create(Personne p, int idAdresseResidence) {
    try {
      ...
      String query =
          "INSERT INTO Personne (nom, prenom, dateNaissance, profession, employeur, typeContratDeTravail, remunerationMensuelleNette, autreRevenus, email, telephone, idLocation, idLocation, IdAdresseResidence, IdAdresseNaissance) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
      int idPersonne =
          db.executeUpdate(
              query,
              Arrays.asList(
