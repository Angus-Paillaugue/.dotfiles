...
<div class="codeContainer my-4">
  {#if name}
    <p class="flex flex-row items-center gap-4 rounded-t-md px-3 py-1 text-base font-medium text-body-dark dark:text-body border border-b-0 border-main dark:border-main-dark m-0">
      {name}
    </p>
  {/if}
...
<style lang="postcss">
  :global(.codeContainer+ div .shiki ) {
