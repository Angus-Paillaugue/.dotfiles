...
<div class={cn("rounded-lg flex items-center flex-row gap-2 py-1 text-neutral-400 log-row", className, rowClasses.get(log.level))} data-log-id={log.id}>
  <div class="flex items-center flex-row gap-2 pl-2" style="width: {tableColumnWidths[0]};">
