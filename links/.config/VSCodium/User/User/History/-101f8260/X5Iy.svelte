...
<div class="flex h-full grow flex-col overflow-hidden">
	<div
		class="flex h-10 shrink-0 flex-row items-center border-b border-neutral-800 bg-neutral-800/50 p-2 text-neutral-400"
	>
		<!-- File dropdown -->
		<Dropdown align="start">
			<Dropdown.Trigger
				variant="none"
				class="w-fit gap-2 rounded-lg px-3 py-1 text-base text-neutral-100 hover:bg-neutral-800/50"
	...
	<div class="relative h-full grow overflow-hidden rounded-b-xl bg-neutral-900/50 pt-2">
		{#if loaded}
