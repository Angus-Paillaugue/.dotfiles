	...
	<div class="max-w-[2000px] h-full w-full mx-auto flex flex-row p-4 md:p-6 lg:p-8 gap-8">
		...
		<main class="grow rounded-2xl bg-white h-full w-full overflow-y-auto text-black no-scrollbar">
			...
			<section id="projects">
				...
				<div class="flex flex-row flex-nowrap overflow-y-auto max-w-screen-xl mx-auto">
					<div class="aspect-square group rounded-xl bg-blue-600 relative flex flex-col min-h-[400px]">
