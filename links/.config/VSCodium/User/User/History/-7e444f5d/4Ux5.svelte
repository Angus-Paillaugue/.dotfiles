...
<div class="w-screen h-screen bg-blue-600">
	<div class="max-w-[2000px] h-full w-full mx-auto flex flex-row p-4 md:p-6 lg:p-8 gap-8">
		...
		<button
			...
			class={cn(
				'fixed bottom-8 left-1/2 -translate-x-1/2 z-40 text-white bg-blue-600 rounded-2xl p-4 lg:hidden transition-color duration-500 flex flex-row gap-4 items-center',
