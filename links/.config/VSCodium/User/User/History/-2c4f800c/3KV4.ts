...
import { exercises, exerciseTests, languages, learningPaths, submissions, users } from './schema';

// Infer TypeScript types
type Exercise = InferModel<typeof exercises>;
type ExerciseTest = InferModel<typeof exerciseTests>;
type Language = InferModel<typeof languages>;
type LearningPath = InferModel<typeof learningPaths>;
