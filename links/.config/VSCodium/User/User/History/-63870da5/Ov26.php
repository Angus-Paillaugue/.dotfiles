...
class Components
{
  ...
  public static function Alert($params = [])
  {
    ...
    echo '<div ' .
      ($id && 'id=' . $id) .
      " class='rounded-lg px-4 py-2 flex flex-row border gap-4 items-center before:size-10 before:bg-cover before:bg-center before:bg-no-repeat before:block $variantClasses[$variant] $class'><p class='p-0 m-0'>$text</p></div>";
  }
}
