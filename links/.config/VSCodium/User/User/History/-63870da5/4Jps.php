...
class Components
{
  ...
  public static function Button($params = [])
  {
    ...
    if($href) {
      echo "<a href='$href' class='cursor-pointer transition-all duration-200 ease-in-out px-4 py-2 font-medium rounded-lg disabled:opacity-50 disabled:cursor-not-allowed items-center justify-center flex flex-row gap-2 text-center $variantClasses $class' $disabled type='$type'>$label</a>";
    }else {
