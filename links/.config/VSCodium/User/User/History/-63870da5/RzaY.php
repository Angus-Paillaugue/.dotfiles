...
class Components
{
  ...
  public static function Button($params = [])
  {
    ...
    if($href) {
      echo "<a href='$href' class='$baseClasses $variantClasses $class' $disabled type='$type'>$label</a>";
    }else {
      echo "<button type='submit' class='$baseClasses $variantClasses $class' $disabled type='$type'>$label</button>";
    }
  }
