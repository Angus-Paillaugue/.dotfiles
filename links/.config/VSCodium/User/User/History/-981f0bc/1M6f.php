        ...
        ?>
            ...
            <?php if ($isInPast) {
              if ($rencontre->getFeuilleMatch()) {
                echo '<div class="bg-primary-50 p-4 lg:col-span-2 rounded-xl border border-primary-100">
          ...
          <table class="w-full table-auto text-sm">
            ...
            <tr class='border-b border-border transition-colors even:bg-white'>
              ...
              <td class='w-1/12 px-4 align-middle'>
                ...
                echo '<div class="bg-primary-50 p-4 lg:col-span-2 space-y-2 rounded-xl border border-primary-100">
