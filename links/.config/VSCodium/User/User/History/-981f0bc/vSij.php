...
<div class="max-w-screen-xl w-full mx-auto p-4 rounded-xl border space-y-4 border-neutral-300/50">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    <div class="bg-neutral-50 p-4 rounded-lg border border-neutral-300/50">
    ...
    <div class="bg-neutral-50 p-4 lg:col-span-2 rounded-lg border border-neutral-300/50">
      ...
      <div class="border border-neutral-300/50 block rounded-xl max-h-[500px] overflow-auto">
        <table class="w-full table-auto text-sm">
          <thead class="border-b sticky top-0 border-neutral-300/50 bg-white bg-card">
            <tr>
          ...
          <tbody class="[&amp;_tr:last-child]:border-0">
            ...
            foreach ($rencontre->getFeuilleMatch() as $feuille_match) {
              ...
              echo "
              <tr class='border-b border-border transition-colors even:bg-card'>
