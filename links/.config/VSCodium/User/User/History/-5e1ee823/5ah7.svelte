...
<div class="fixed bottom-4 left-1/2 -translate-x-1/2 flex flex-row gap-2 rounded-full p-2 bg-neutral-900">
  <a href="/" class="size-14 rounded-full bg-neutral-800 text-text-heading-dark p-2" aria-label="Home">
  ...
  <a href="/" class="size-14 rounded-full bg-neutral-800 text-text-heading-dark p-2" aria-label="Search">
  ...
  <a href="/" class="size-14 rounded-full bg-neutral-800 text-text-heading-dark p-2" aria-label="Bookmarks">
