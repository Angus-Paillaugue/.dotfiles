...
<div class="fixed bottom-4 left-1/2 -translate-x-1/2 flex flex-row gap-2 rounded-full p-2 bg-neutral-900">
  <a href="/" class={cn("size-14 rounded-full bg-neutral-800 text-text-heading-dark p-2 transition-colors", activeNavLink === 'home' && 'bg-neutral-100 text-text-heading')} aria-label="Home">
  ...
  <a href="/search" class={cn("size-14 rounded-full bg-neutral-800 text-text-heading-dark p-2 transition-colors", activeNavLink === 'search' && 'bg-neutral-100 text-text-heading')} aria-label="Search">
  ...
  <a href="/bookmarks" class={cn("size-14 rounded-full bg-neutral-800 text-text-heading-dark p-2 transition-colors", activeNavLink === 'bookmarks' && 'bg-neutral-100 text-text-heading')} aria-label="Bookmarks">
