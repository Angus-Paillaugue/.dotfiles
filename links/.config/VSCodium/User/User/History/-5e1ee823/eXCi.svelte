...
<div class="min-h-screen flex flex-col">
  ...
  <div class="flex flex-row items-center justify-center p-4 fixed bottom-0 left-0 right-0 z-[10001]">
    <div class="flex flex-row gap-4 rounded-full p-2 bg-neutral-900">
      ...
      <a href="/search" class={cn("size-14 rounded-full bg-neutral-800 text-neutral-100 p-2 transition-colors flex flex-col items-center justify-center", bionicReadingEnabled && 'bg-neutral-100 text-neutral-800')} aria-label="Search">
