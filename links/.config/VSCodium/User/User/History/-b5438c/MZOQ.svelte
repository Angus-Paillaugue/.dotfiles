...
{#if format === 'list'}
	...
	<div
		onmouseup={play}
		class='text-text track flex w-full shrink-0 cursor-pointer flex-row items-center justify-start gap-4 overflow-hidden rounded-lg p-2 transition-colors [data-focused="true"]:bg-secondary [data-focused="true"]:ring-2 [data-focused="true"]:ring-secondary'
