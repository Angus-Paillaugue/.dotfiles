<script lang="ts">
	...
	function play(e: MouseEvent) {
		...
		// Do not play the song if the user clicks on a button or the track is disabled
		if(target.closest('button') || target.closest('.track')?.classList.contains('disabled') || e.which) return;
