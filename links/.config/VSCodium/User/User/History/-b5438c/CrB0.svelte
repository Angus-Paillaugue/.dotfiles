...
{#if format === 'list'}
	...
	<div
		onmouseup={play}
		class='text-text track flex w-full shrink-0 cursor-pointer flex-row items-center justify-start gap-4 overflow-hidden rounded-lg p-2 transition-colors [data-focused="true"]:bg-secondary [data-focused="true"]:ring-2 [data-focused="true"]:ring-secondary hover:bg-secondary hover:ring-2 hover:ring-secondary'
		data-track-id={song.id}
		data-focussed={isSongSelected}
		{...restProps}
	>
		<!-- cover -->
...
{:else}
	...
	<div
		onmouseup={play}
		class='text-text track flex shrink-0 cursor-pointer flex-col gap-2 rounded-xl p-2 [data-focused="true"]:bg-secondary [data-focused="true"]:ring-2 [data-focused="true"]:ring-secondary hover:bg-secondary hover:ring-2 hover:ring-secondary'
		data-track-id={song.id}
		data-focussed={isSongSelected}
		{...restProps}
	>
