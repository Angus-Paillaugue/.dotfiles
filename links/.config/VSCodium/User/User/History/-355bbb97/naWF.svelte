...
<div class="rounded-full fixed z-50 pointer-events-none transition-colors border-2 border-black" style="top: {$pos.y}px; left:{$pos.x}px; width: {$pos.width}px; height: {$pos.height}px;" bind:this={cursor}></div>
