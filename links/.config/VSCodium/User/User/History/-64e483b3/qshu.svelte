...
{#if $searchModalShown}
  <div class="fixed inset-0 z-50 flex flex-col items-center justify-end md:justify-center bg-neutral-950/50 backdrop-blur-sm" transition:fade={{ duration:300 }}>
  </div>
  <div class="bg-neutral-100 dark:bg-neutral-800 rounded-t-md w-full max-w-screen-md md:rounded-md dark:text-white text-neutral-900 overflow-hidden" transition:fly={{ y:"12", duration:300 }}>
