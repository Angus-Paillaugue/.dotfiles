...
export const artistsDirName = '.artists';
export const artistCoverDirName = 'cover';
...
export const artistsDir = path.join(songsDir, artistsDirName);
export const artistCoverDir = path.join(artistsDir, artistCoverDirName);
