...
<div class="mx-auto flex w-full max-w-screen-lg flex-col gap-10 p-4 md:gap-8">
	<div class="overflow-hidden rounded-xl border border-border">
		<div class="flex flex-row items-center gap-4 bg-card p-6 px-7">
		...
		{:else}
			{#each path.exercises as exercise}
				<a
					...
					class="flex w-full flex-row items-center border-b border-border p-4 text-neutral-100 transition-colors last:border-none hover:bg-neutral-700/50"
				>
