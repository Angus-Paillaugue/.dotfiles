...
if ($payload) {
    echo "<div class='p-2'><nav class='flex flex-row gap-4 items-center px-8 py-4 max-w-screen-xl mx-auto rounded-xl bg-neutral-100 dark:bg-neutral-900 w-full border border-neutral-300/50 dark:border-neutral-900'><div class='flex flex-row gap-2 items-center'>";
    Components::Link([
      'label' => 'Dashboard',
      'href' => '/vue/dashboard',
    ]);
