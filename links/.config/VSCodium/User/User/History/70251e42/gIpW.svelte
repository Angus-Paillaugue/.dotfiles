<script>
  ...
  const arrowPositionClasses = {
    ...
    left: "right-2 -translate-x-1/2 top-1/2 -translate-y-1/2 rotate-90",
    right: "left-2 -translate-x-1/2 top-1/2 -translate-y-1/2 -rotate-90"
  };
</script>
...
{#if isHovered}
  ...
  >
    <div class="text-sm dark:bg-neutral-950 bg-neutral-200 text-neutral-500 dark:text-neutral-400 p-2 rounded-md relative">
      {@render children()}
      <svg xmlns="http://www.w3.org/2000/svg" class="size-6 absolute {arrowPositionClasses[position]}" viewBox="0 0 24 24">
