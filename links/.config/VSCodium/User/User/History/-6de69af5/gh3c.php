...
class sql_connector
{
  ...
  public function insert($sql, ...$params)
  {
    try {
      ...
      echo 'Last Insert ID: ' . $lastInsertId; // Debugging statement

      // Additional debugging: Check if the row was inserted
      $rowCount = $stmt->rowCount();
      echo 'Number of rows inserted: ' . $rowCount; // Debugging statement
