<script>
  ...
  const typeClasses = {
    ...
    custom: {
      note: "text-blue-600 border-blue-600 bg-blue-50/50 dark:bg-blue-500/30",
      tip: "text-emerald-600 border-emerald-600 bg-emerald-50/50 dark:bg-emerald-500/30",
      important: "text-indigo-600 border-indigo-600 bg-indigo-50/50 dark:bg-indigo-500/30",
      warning: "text-amber-600 border-amber-600 bg-amber-50/50 dark:bg-amber-500/30",
      caution: "text-red-600 border-red-600 bg-red-50/50 dark:bg-red-500/30",
    },
  };
  const iconClasses = {
    github: {
