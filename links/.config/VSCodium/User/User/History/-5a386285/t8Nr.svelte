<script>
  ...
  const typeClasses = {
    ...
    custom: {
      ...
      important: "text-indigo-600 dark:text-indigo-500 border-indigo-600 bg-indigo-50/50 dark:bg-indigo-500/30",
      warning: "text-amber-600 dark:text-amber-500 border-amber-600 bg-amber-50/50 dark:bg-amber-500/30",
