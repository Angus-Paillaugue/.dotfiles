...
<!-- Footer -->
 <div class="custom-shape-divider-bottom-1732013462">
...
<style>
	...
	.custom-shape-divider-bottom-1732013462 {
    position: absolute;
    bottom: 0;
    left: 0;
    width: 100%;
...
.custom-shape-divider-bottom-1732013462 svg {
    position: relative;
    display: block;
...
.custom-shape-divider-bottom-1732013462 .shape-fill {
    fill: #FFFFFF;
}
</style>
