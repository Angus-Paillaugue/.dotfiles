...
<div class="h-screen w-screen overflow-y-auto flex flex-col text-neutral-100 p-2 ligatures-normal font-semibold tracking-normal">
  ...
  <div id="prompt" class="relative">
    <span class="whitespace-pre text-wrap inline-block font-mono text-base text-neutral-100 h-6">{@html terminal.parseTerminalLine(terminal.prompt)} {terminal.input}</span>
    <!-- Cursor -->
