...
<div class="grid grid-cols-2 gap-4 items-end justify-between py-4 mt-auto">
  {#if previousPage}
    <a
      ...
      class="p-4 rounded-md border border-neutral-300/50 dark:border-neutral-800 hover:gap-4 flex flex-row gap-2 items-center justify-start transition-all"
    >
  ...
  {#if nextPage}
    <a
      href={nextPage.url}
      class="col-start-2 p-4 rounded-md border border-neutral-300/50 dark:border-neutral-800 hover:gap-4 flex flex-row gap-2 items-center justify-end transition-all"
    >
