<script lang="ts">
  ...
  let card2Data = $state();
	...
	export const swipe = (direction = 'right') => {
  ...
  let { minSwipeDistance = 0.5, minSwipeVelocity = 0.5, arrowKeys = true, thresholdPassed= 0, anchor = null } = $props();
</script>
