...
public class EnumReports {
	...
	private static Color[] colors = {new Color(25, 109, 25), new Color(96, 153, 70), new Color(144, 179, 61), new Color(254, 219, 45), new Color(250, 183, 40), new Color(243, 132, 36), new Color(234, 27, 42)};


	/**
	 * Creates and returns a JLabel component representing the given noteEnergetique.
	 * The label is styled with a background color, font, and border based on the note.
	 *
