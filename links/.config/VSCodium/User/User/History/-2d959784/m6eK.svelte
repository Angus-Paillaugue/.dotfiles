        ...
        <div class="p-2" id="results">
          {#each results as result, index}
            <a
              href={result.url}
              class={cn(
                'group relative m-0 flex list-none flex-row items-center justify-between rounded-xl p-2 px-4 py-2 transition-colors                 'group relative m-0 flex list-none flex-row items-center justify-between rounded-xl p-2 px-4 py-2 transition-colors hover:bg-neutral-300/50 focus:bg-neutral-300/50 focus:outline-none dark:hocus:bg-neutral-800/50',
:bg-neutral-300/50 focus:bg-neutral-300/50 focus:outline-none dark:hocus:bg-neutral-800/50',
