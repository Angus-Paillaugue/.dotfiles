      ...
      <div class="w-full sticky top-0 z-10 bg-neutral-100 dark:bg-neutral-950 p-2 border-b border-transparent transition-all" id="searchContainer">
        <div class="relative">
          ...
          <input
            ...
            name="search"
            id="search"
            class="w-full bg-transparent pl-8 md:px-12 py-4 text-xl focus:outline-none dark:bg-transparent rounded-xl border border-neutral-300/50 dark:border-neutral-700/50 {results.length >
              0 && 'border-b'}"
