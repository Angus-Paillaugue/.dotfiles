        ...
        >
          {#each results as result, index}
            ...
            >
              ...
              <Icon icon="material-symbols:arrow-forward-ios-rounded" class="text-primary-500 transition-opacity opacity-0 group-hover:opacity-100 group-focus:opacity-100 [.group.selected_&]:opacity-100" />
            </a>
          {/each}
        </div>
      {/if}
