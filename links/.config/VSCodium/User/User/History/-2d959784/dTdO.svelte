<script>
  ...
  /**
   * This component represents a search feature.
   *
   * @component Search
   * @filepath /home/angus/Documents/perso/SvelteShine/src/lib/components/core/Search.svelte
   *
   * @description
   * The `Search` component provides a search feature that can be used to search for specific items.
   *
   * @example
   * ```svelte
   * <Search />
   ...
   * @async
   * @description
   * This event is fired when the component is mounted.
   *
   * @usage
   * ```svelte
   * <script>
