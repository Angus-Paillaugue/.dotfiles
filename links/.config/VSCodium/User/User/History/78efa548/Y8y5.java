...
public class LogementDAO implements LogementDAODef {
  ...
  public Logement create(Logement l, int idBatiment) {
    try {
      ...
      String query =
          "INSERT INTO Bien_louable (idAdresse, refCadastrale, bati, numeroFiscal, taxeFonciere, idBatiment, surfaceTotale, surfaceHabitable, typeLogement, nbPieces, numeroContract) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
      int idBienLouable =
          db.executeUpdate(
              query,
              Arrays.asList(
