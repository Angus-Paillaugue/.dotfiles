<script lang="ts">
  ...
  let { card = $bindable(), onDragStart, onDragEnd, deleteCard, onEditCard }: { card: Card; onDragStart: (card: Card) => void; onDragEnd: () => void; deleteCard: (card:Card) => void; onEditCard: () => void } = $props();
