<script>
	...
	const baseToastClasses = 'rounded-xl border bg-white dark:bg-primary-950 border-neutral-300 dark:border-neutral-700 p-4 relative text-primary-600 dark:text-primary-300';
