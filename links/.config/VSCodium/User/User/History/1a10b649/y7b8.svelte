<script>
	...
	const baseToastClasses = 'rounded-xl border bg-white dark:bg-neutral-950 border-neutral-300 dark:border-neutral-700 p-4 relative text-neutral-600 dark:text-neutral-300';

	// USER CONFIG : Customize the toast svg colors
	const toastColors = {
		red: 'bg-red-600 dark:bg-red-200',
		green: '',
...
>
	{#each $toasts.slice(0, 4) as toast (toast.id)}
		<div
			role="alert"
			class={twMerge(baseToastClasses, toastColors[toast.type])}
