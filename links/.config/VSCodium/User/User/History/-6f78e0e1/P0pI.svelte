...
<div class="flex flex-col h-screen gap-2 p-2">
	...
	<header class="flex shrink-0 justify-between items-center h-10">
		<div class="group rounded-lg overflow-hidden h-10">
			<button class="flex flex-row gap-2 items-center text-base transition-colors group-hover:bg-neutral-800 h-full px-2">
