...
<div class="flex flex-col h-screen gap-2 p-2">
	<!-- Top part -->
	<header class="flex shrink-0 justify-between items-center h-10 relative">
		...
		<!-- Code action buttons -->
		<div class="grid grid-cols-2 items-center gap-px absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
			<!-- Run button -->
		...
		<!-- Account buttons -->
		 <img src="/default_avatar.jpg" alt="" class="size-8">
	</header>
	...
	<PaneGroup direction="horizontal" class="grow" autoSaveId="exercisePage">
		...
		<Pane defaultSize={50} class="flex w-full flex-col">
			...
			<div class={cn("flex flex-col", editorFullScreen ? "fixed inset-2" : "")}>
				<!-- Full screen button -->
				<div class="flex flex-row items-center px-2 gap-2 h-10 rounded-t-xl bg-neutral-800 text-neutral-400">
					<div class="flex flex-row items-center px-2 gap-2">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-5"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>
						Code
					</div>
				</div>
			</div>
