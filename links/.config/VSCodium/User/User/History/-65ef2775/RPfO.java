...
public class AjouterGarage extends JFrame {
  ...
  public AjouterGarage() {
    ...
    addLabelAndCustomField(
        formPanel, gbc, "Montant taxe foncière", new MoneyTextField(null, null, "taxeFonciere").build(), 18);
    ...
    rentGbc.weightx = 1.0;
    addLabelAndCustomField(
        rentPanel, gbc, "Date prochaine révision", new DateField(null, "dateProchaineRevision").build(), 4);
    addLabelAndCustomField(
        rentPanel, gbc, "Montant dépôt de garantie", new MoneyTextField(null, null, "montantDepotGarantie").build(), 5);
    addLabelAndComboBox(rentPanel, gbc, "modeDePayment", "Mode de payment", ModeDePaiment.getValues(), 6);
		addLabelAndCustomField(rentPanel, gbc, "Jour versement", new MoneyTextField(null, 5,
				"jourVersement").build(), 8);
		...
		addLabelAndCustomField(
				chargesPanel, gbc, "Nouvel index eau", new MoneyTextField(null, null, "nouvelIndexEau").build(), 0);
		addLabelAndCustomField(
				chargesPanel, gbc, "Ordures ménagères", new MoneyTextField(null, null, "orduresMenageres").build(), 1);
		addLabelAndCustomField(
				chargesPanel, gbc, "Entretien parties communes", new MoneyTextField(null, null,
						"entretienPartiesCommunes").build(), 2);
		addLabelAndCustomField(
				chargesPanel, gbc, "Eclairage parties communes", new MoneyTextField(null, null,
						"eclairagePartiesCommunes").build(), 3);
		addLabelAndCustomField(
				chargesPanel, gbc, "Eau partie fixe", new MoneyTextField(null, null, "eauPartieFixe").build(), 4);
		addLabelAndCustomField(
				chargesPanel, gbc, "Prix eau", new MoneyTextField(null, null, "prixEau").build(), 5);
		addLabelAndCustomField(
				chargesPanel, gbc, "Ancien index eau", new MoneyTextField(null, null, "ancienIndexEau").build(), 6);
		addLabelAndCustomField(
				chargesPanel, gbc, "Provision sur charge", new MoneyTextField(null, null, "provisionSurCharge").build(), 7);
