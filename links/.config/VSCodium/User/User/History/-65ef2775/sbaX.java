...
public class AjouterGarage extends JFrame {
  ...
  public AjouterGarage() {
    setTitle("Ajouter un garage");
    setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    setSize(900, 1200);

		AjouterGarageControleur controleur = new AjouterGarageControleur(this);
    ...
    gbc.gridx = 0;
		gbc.gridy = 11;
    gbc.gridwidth = 1;
    formPanel.add(new JLabel("Superficie"), gbc);
    ...
    addLabelAndComboBox(formPanel, gbc, "noteEnergetique", "Note énergétique", noteEnergetique.getNames(), 13);
    addLabelAndComboBox(
        formPanel, gbc, "emissionsGazEffetDeSerre", "Emissions gaz à effet de serre", noteEnergetique.getNames(), 14);
    ...
    addLabelAndComboBox(
        formPanel, gbc, "typeLogement", "Type de logement", new String[] {"Location", "Co-location"}, 17);
    addLabelAndCustomField(
        formPanel, gbc, "taxeFonciere", "Montant taxe foncière", new MoneyTextField(null, null).build(), 18);
    addLabelAndCustomField(
        formPanel, gbc, "datePermisConstruire", "Date permis de construire", new DateField(null).build(), 19);
    addLabelAndCustomField(
        formPanel, gbc, "dateConstructionBatiment", "Date construction bâtiment", new DateField(null).build(), 20);
    addLabelAndRadioButtons(formPanel, gbc, "typePorte", "Type de porte", new String[] {"Gauche", "Droite"}, 21);
    addLabelAndTextField(formPanel, gbc, "accesTechnologique", "Access technologique", 22);
    ...
    addLabelAndCustomField(
        rentPanel, gbc, "montantHorsCharges", "Montant hors charges", new MoneyTextField(null, null).build(), 0);
		addLabelAndCustomField(
				rentPanel, gbc, "montantCaution", "Montant caution", new MoneyTextField(null, null).build(), 1);
    addLabelAndCustomField(rentPanel, gbc, "montantCharges", "Charges", new MoneyTextField(null, null).build(), 2);
    addLabelAndCustomField(rentPanel, gbc, "datePayment", "Date payment", new DateField(null).build(), 3);
    addLabelAndCustomField(
        rentPanel, gbc, "dateProchaineRevision", "Date prochaine révision", new DateField(null).build(), 4);
    addLabelAndCustomField(
        rentPanel, gbc, "montantDepotGarantie", "Montant dépôt de garantie", new MoneyTextField(null, null).build(), 5);
    addLabelAndComboBox(rentPanel, gbc, "modeDePayment", "Mode de payment", ModeDePaiment.getValues(), 6);
    addLabelAndCustomField(rentPanel, gbc, "totalTTC", "Total TTC", new MoneyTextField(null, null).build(), 7);
		addLabelAndCustomField(rentPanel, gbc, "jourVersement", "Jour versement", new MoneyTextField(null, 5).build(), 8);
		...
		addLabelAndCustomField(
				chargesPanel, gbc, "nouvelIndexEau", "Nouvel index eau", new MoneyTextField(null, null).build(), 0);
		addLabelAndCustomField(
				chargesPanel, gbc, "orduresMenageres", "Ordures ménagères", new MoneyTextField(null, null).build(), 1);
		addLabelAndCustomField(
				chargesPanel, gbc, "entretienPartiesCommunes", "Entretien parties communes", new MoneyTextField(null, null).build(), 2);
		addLabelAndCustomField(
				chargesPanel, gbc, "eclairagePartiesCommunes", "Eclairage parties communes", new MoneyTextField(null, null).build(), 3);
		addLabelAndCustomField(
				chargesPanel, gbc, "eauPartieFixe", "Eau partie fixe", new MoneyTextField(null, null).build(), 4);
		addLabelAndCustomField(
				chargesPanel, gbc, "prixEau", "Prix eau", new MoneyTextField(null, null).build(), 5);
		addLabelAndCustomField(
				chargesPanel, gbc, "ancienIndexEau", "Ancien index eau", new MoneyTextField(null, null).build(), 6);
		addLabelAndCustomField(
				chargesPanel, gbc, "provisionSurCharge", "Provision sur charge", new MoneyTextField(null, null).build(), 7);
  ...
  private void addLabelAndRadioButtons(
      JPanel panel, GridBagConstraints gbc, String name, String labelText, String[] options, int gridy) {
    gbc.gridx = 0;
    gbc.gridy = gridy;
    gbc.gridwidth = 2;
    panel.add(new JLabel(labelText), gbc);
  ...
  private void addLabelAndCustomField(
      JPanel panel, GridBagConstraints gbc, String name, String labelText, JPanel customField, int gridy) {
    gbc.gridx = 0;
    gbc.gridy = gridy;
    gbc.gridwidth = 1;
    panel.add(new JLabel(labelText), gbc);
