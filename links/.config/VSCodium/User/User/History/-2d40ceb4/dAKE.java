...
public class ApartmentDetailsView extends JFrame {
    ...
    public ApartmentDetailsView(BienLouable appartment) {
        ...
        apartmentImage.setIcon(new CustomImage(Constants.ICONS_PATH + "apartmentImage.jpg").resize(250, 350).round(Constants.BR_LG).build());
        ...
        locatairePanel.setBorder(BorderFactory.createCompoundBorder(locataireBorder, BorderFactory.createEmptyBorder(5, 5, 5, 5)));
    ...
    // Helper method to create locataire (tenant) panel
    private JPanel createLocatairePanel(String locataireName) {
        ...
        locatairePanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(Color.LIGHT_GRAY, 1), BorderFactory.createEmptyBorder(5, 5, 5, 5)));
