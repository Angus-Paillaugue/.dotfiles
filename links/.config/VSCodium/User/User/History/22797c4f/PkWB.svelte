<script>
   ...
   * @property {string} summary - The summary of the collapsible.
   * @property {string} icon - The icon for the collapsible.
   * @property {boolean} open - Whether the collapsible is open. Default is false.
   * @property {Function} children - The children of the component.
   */
