...
>
  <button
    ...
    class="items-between flex w-full cursor-pointer flex-row items-center px-4 py-2 text-base font-semibold transition-colors hocus:bg-neutral-200/50 dark:bg-inherit focus:-outline-offset-1"
  >
