...
public class GenererContractDeLocation extends JFrame {
  ...
  public GenererContractDeLocation(Proprietaire proprietaire) {
    ...
    // Radio buttons
    radioPanel =
        new JPanel(new GridLayout(0, 3, 10, 10)); // Grid layout with three columns and spacing
  ...
  private void addBien(BienLouable bien, int index) {
    JRadioButton radioButton = new JRadioButton(bien.getAdresse().toString());
    group.add(radioButton);
    radioButton.setName(String.valueOf(index));
