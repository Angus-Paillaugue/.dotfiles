...
public class GenererContractDeLocation extends JFrame {
  ...
  public static void main(String[] args) {
    ...
    EventQueue.invokeLater(
        () -> {
          try {
            GenererContractDeLocation frame =
                new GenererContractDeLocation(SharedState.getInstance().getProprietaire());
  ...
  public GenererContractDeLocation(Proprietaire proprietaire) {
    ...
    radioPanelLocation =
        new JPanel(
            new GridLayout(1, nbLocation, 10, 10));
    ...
    radioPanelColocation =
        new JPanel(
            new GridLayout(1, nbColocation, 10, 10));
