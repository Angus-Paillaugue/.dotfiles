...
public class GenererContractDeLocation extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(
				() -> {
					try {
						GenererContractDeLocation frame = new GenererContractDeLocation(SharedState.getInstance().getProprietaire());
	...
	public GenererContractDeLocation(Proprietaire proprietaire) {
		...
		radioPanelLocation =
				new JPanel(new GridLayout(0, nbLocation, 10, 10)); // Grid layout with three columns and spacing
		...
		radioPanelColocation =
				new JPanel(new GridLayout(0, nbColocation, 10, 10)); // Grid layout with three columns and spacing
