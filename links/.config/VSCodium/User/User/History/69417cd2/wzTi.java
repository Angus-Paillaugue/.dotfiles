...
public class GenererContractDeLocation extends JFrame {
  ...
  public GenererContractDeLocation() {
    ...
    int nbLocation = logements.stream().filter(Logement::isLocation).collect(Collectors.toList()).size();
    int nbColocation = logements.stream().filter(Logement::isColocation).collect(Collectors.toList()).size();
