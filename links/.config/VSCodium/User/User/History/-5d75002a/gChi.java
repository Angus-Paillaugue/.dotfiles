...
public class Location {
	...
	public Location(Personne locataire1, List<Personne> garants, LocalDate dateContrat, Adresse lieuDeContrat, float caution) {
	...
	public Location(Personne locataire1, Personne locataire2, List<Personne> garants,
