...
public class Location {
  ...
  public void addLocataire(Personne personne) {
    if (this.locataires.size() < 2 && personne != null && !this.locataires.contains(personne)) this.locataires.add(personne);
  }
  ...
  public void addGarant(Personne garant) {
	  if(!this.locataires.contains(garant))
  ...
  public void setCaution(float _caution)
  {
	  this.caution = _caution;
  }
  ...
  public void removeGarant(Personne personne) {
    this.garants.remove(personne);
  }
  ...
  public String toString()
  {
	  String r = "Location [ "
			...
			+ " LieuContrat: " + lieuDeContrat
			+ " Caution: " + caution
			+ " IdLogement: " + idLogement
	  		+ " Locataires [ ";
	  for(Personne _loc : locataires)
		  r += _loc + " ";
	  r += "] Garants [ ";
	  for(Personne _gar : garants)
		  r += _gar + " ";
	  return r + "]";
  }
}
