<script>
  ...
  const typeClasses = {
    ...
    ghost:
      'bg-transparent dark:bg-transparent hover:bg-neutral-200/50 dark:hover:bg-neutral-700/50 text-neutral-950 dark:text-neutral-100 border border-neutral-300/50 dark:border-neutral-700/50'
  };
