...
public class LoyerDAO {
  ...
  public int create(Loyer t, int idBienLouable) {
    try {
  ...
  public Loyer find(int id) {
    try {
      ...
      System.out.println(((Double) result.get("montantHorsCharges")).floatValue()((Double) result.get("montantHorsCharges")).floatValue());
      Loyer loyer =
          new Loyer(
              (int) result.get("id"),
              ((Double) result.get("montantHorsCharges")).floatValue(),
  ...
  public void update(Loyer t, int idBienLouable) {
    // This is used to keep a record of the old values in the database
    create(t, idBienLouable);
  }
