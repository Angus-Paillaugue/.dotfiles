...
<div class="isolate flex w-full flex-col bg-body-dark dark:bg-body">
  <main class="overflow-clip rounded-b-[32px] bg-body dark:bg-body-dark">
    ...
    <div id="learn-more">
      ...
      <section
        id="horizontalScroll"
        class="hidden lg:hidden h-screen flex-col justify-center pl-[50vw]"
        data-lenis-prevent
      >
      ...
      >
        ...
        <!-- Accessibility -->
        <div
          class="relative overflow-hidden rounded border border-main p-4 text-center dark:border-main-dark max-md:rounded-t-[50px] md:rounded-t-[50px] xl:p-8 min-h-[40px] "
        >
          <!-- Progress bar -->
        ...
        <!-- Environnement -->
        <div
          class="relative min-h-[400px] overflow-hidden rounded border border-main p-4 text-center dark:border-main-dark xl:p-8"
        >
          <!-- Score blob -->
          <div class="flex flex-col w-[80%] mx-auto h-2/3 items-center justify-center">
            <div class="relative w-fit h-fit">
        ...
        <!-- Configuration -->
        <div
          class="relative flex flex-col items-center gap-2 overflow-hidden rounded border border-main p-4 text-center dark:border-main-dark xl:p-8 md:rounded-bl-[50px]"
        >
        ...
        <!-- Performance -->
        <div
          class="relative flex flex-col items-center gap-2 overflow-hidden rounded border border-main p-4 text-center dark:border-main-dark xl:p-8 rounded-b-[50px] md:rounded-bl-none min-h-[400px]"
        >
          <div class="flex flex-col w-[80%] mx-auto h-2/3 items-center justify-center">
            <!-- Progress bar -->
            <div class="relative size-[200px] rounded-full">
