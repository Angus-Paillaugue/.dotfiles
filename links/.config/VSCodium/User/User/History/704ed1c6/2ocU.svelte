...
<div class="isolate flex w-full flex-col bg-body-dark dark:bg-body">
  <main class="overflow-clip rounded-b-[32px] bg-body dark:bg-body-dark">
    ...
    <div id="learn-more">
      ...
      <section
        id="horizontalScroll"
        class="hidden h-screen flex-col justify-center pl-[50vw]"
        data-lenis-prevent
      >
      ...
      <!-- Mobile bento grid -->
      <section
        class="mx-auto grid max-w-screen-2xl grid-cols-1 ld:grid-cols-5 gap-2 px-4 my-24 grid-rows-4 md:grid-rows-2 md:px-10"
        id="learn-more"
      >

        <!-- Accessibility -->
        <div
          class="relative col-span-1 overflow-hidden rounded border border-main p-4 text-center dark:border-main-dark max-md:rounded-t-[50px] md:rounded-t-[50px] xl:p-8 min-h-[40px] md:col-span-3"
        >
          <!-- Progress bar -->
        ...
        <!-- Environnement -->
        <div
          class="relative col-span-1 min-h-[400px] overflow-hidden rounded border border-main p-4 text-center dark:border-main-dark xl:p-8 md:col-span-2"
        >
          <!-- Score blob -->
          <div class="flex flex-col w-[80%] mx-auto h-2/3 items-center justify-center">
            <div class="relative w-fit h-fit">
        ...
        <!-- Configuration -->
        <div
          class="relative col-span-1 flex flex-col items-center gap-2 overflow-hidden rounded border border-main p-4 text-center dark:border-main-dark xl:p-8 md:rounded-bl-[50px] md:col-span-2"
        >
          <picture class="w-[80%] pb-">
            <source
              media="(max-width: 960px)"
              srcset="/homepage/editConfiguration_720.png"
            />
        ...
        <!-- Performance -->
        <div
          class="relative col-span-1 flex flex-col items-center gap-2 overflow-hidden rounded border border-main p-4 text-center dark:border-main-dark xl:p-8 rounded-b-[50px] md:rounded-bl-none min-h-[400px] md:col-span-2"
        >
          <div class="flex flex-col w-[80%] mx-auto h-2/3 items-center justify-center">
            <!-- Progress bar -->
            <div class="relative size-[200px] rounded-full">
