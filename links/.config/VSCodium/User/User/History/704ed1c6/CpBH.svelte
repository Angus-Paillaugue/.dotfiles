<script>
  ...
  function onScroll() {
    ...
    if (isScrolledIntoView(accessibilityProgress)) {
      accessibilityScore.set(100);
    }
    if (isScrolledIntoView(performanceProgress)) {
      performanceScore.set(98);
    }
  }
    ...
    >
      ...
      >
        ...
        <div class="flex flex-col w-[80%] mx-auto h-2/3 items-center justify-center">
          <div class="relative size-[200px] rounded-full" id="accessibilityProgress">
      ...
      >
        <div class="flex flex-col w-[80%] mx-auto h-2/3 items-center justify-center">
          <!-- Progress bar -->
          <div class="relative size-[200px] rounded-full" id="performanceProgress">
            <svg viewBox="0 0 120 120" class="size-full -rotate-90">
              <circle class="text-green-600/10" fill="currentColor" r="60" cx="60" cy="60" stroke-width="8"></circle>
