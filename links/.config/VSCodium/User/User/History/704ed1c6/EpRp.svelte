  ...
  <main class="overflow-clip rounded-b-[32px] bg-body dark:bg-body-dark">
    ...
    <div id="learn-more">
      ...
      >
        ...
        <!-- Accessibility -->
        <div
          class="relative overflow-hidden rounded border border-main p-4 text-center dark:border-main-dark rounded-t-[50px] md:rounded-tr-none xl:p-8 min-h-[40px] "
        >
          <!-- Progress bar -->
        ...
        <!-- Environnement -->
        <div
          class="relative min-h-[400px] overflow-hidden rounded border border-main p-4 text-center dark:border-main-dark xl:p-8 md:rounded-tr-[50px]"
        >
          <!-- Score blob -->
          <div class="flex flex-col w-[80%] mx-auto h-2/3 items-center justify-center">
            <div class="relative w-fit h-fit">
