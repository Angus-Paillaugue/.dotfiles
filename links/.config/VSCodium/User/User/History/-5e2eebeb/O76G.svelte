				...
				<Table.Root>
					<Table.Header>
						<Table.Row>
							...
							<Table.Head class="text-right">Message</Table.Head>
						</Table.Row>
					</Table.Header>
					<Table.Body>
						{#each statistics?.recentLogs ?? [] as log}
							<Table.Row>
								<Table.Cell class="text-right">{log.level}</Table.Cell>
								<Table.Cell class="text-right">{log.timestamp}</Table.Cell>
								<Table.Cell class="text-right">{log.message}</Table.Cell>
							</Table.Row>
						{/each}
					</Table.Body>
				</Table.Root>
