...
<div class={cn("relative size-full", className)} {...restProps}>
  ...
  {#if isPlaying}
    <div class="absolute inset-0 z-10 bg-background/50 backdrop-blur-sm flex flex-col items-center justify-center p-2 @container">
      <div class="@[100px]:hidden flex flex-row justify-around items-center size-full gap-[2px]">
      ...
      <div class="size-full hidden @[100px]:flex flex-row justify-around items-center gap-[2px]">
