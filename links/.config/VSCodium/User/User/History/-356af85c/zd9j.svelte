	...
	{#if isSelected}
		...
		>
			{#if isPlaying}
				...
				<div
					class="flex size-full max-w-[100px] flex-row items-center justify-around gap-[2px] p-2 @[100px]:hidden"
					transition:fade={{ duration: 300, delay: 0 }}
				>
					<div
				...
				<!-- For covers > 100px wide -->
				<div
					class="hidden size-24 flex-row items-center justify-around gap-[2px] p-2 @[100px]:flex"
					transition:fade={{ duration: 300, delay: 0 }}
				>
					<div
