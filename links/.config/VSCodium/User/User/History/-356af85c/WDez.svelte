...
<div class={cn("relative size-full", className)} {...restProps}>
  ...
  {#if isPlaying}
    <div class="absolute inset-0 z-10 bg-background/50 backdrop-blur-sm flex flex-col items-center justify-center p-2">
      <div class="flex flex-row justify-around items-center size-full gap-[2px]">
        ...
        <!-- <div class="bg-primary rounded-full w-[3px]" style="animation: height-animation 2.2s 0.9s ease-in-out infinite both;"></div> -->
      </div>
    </div>
  {/if}
</div>
