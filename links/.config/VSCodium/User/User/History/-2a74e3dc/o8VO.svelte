<script>
  ...
  function getLocalizedText(text) {
    ...
    const currentLocale = localeConfig.locale || i18n.defaultLocale;
    const localizedText = text.find(t => Object.keys(t)[0] === currentLocale);
    return localizedText ? Object.values(localizedText)[0] : Object.values(text.find(t => Object.keys(t)[0] === i18n.defaultLocale))[0];
  }
