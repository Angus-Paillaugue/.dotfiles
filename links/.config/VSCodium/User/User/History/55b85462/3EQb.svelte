<script>
	...
	let tooltipPos = writable({ x: 0, y: 0 });
...
<div id="contactLinksTooltip" style="opacity: 1; left: {$tooltipPos.x}px; top: {$tooltipPos.y}px;" class="p-4 z-40 rounded-xl fixed bg-black -translate-y-full -translate-x-full">test test</div>
