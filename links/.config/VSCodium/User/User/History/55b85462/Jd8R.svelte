...
<div id="contactLinksTooltip" style="opacity: 0; left: {$tooltipPos.x}px; top: {$tooltipPos.y}px;" class="p-4 z-50 mb-4 rounded-br-none rounded-xl transition-opacity fixed bg-primary text-white -translate-y-full -translate-x-full">test test</div>
