...
<div id="contactLinksTooltip" style="opacity: 1; left: {$tooltipPos.x}px; top: {$tooltipPos.y}px;" class="p-4 z-50 mb-4 rounded-br-none rounded-xl fixed bg-primary text-white -translate-y-full -translate-x-full">test test</div>
