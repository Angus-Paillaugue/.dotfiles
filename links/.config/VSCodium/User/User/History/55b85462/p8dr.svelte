...
<div id="contactLinksTooltip" style="opacity: 1; left: {$tooltipPos.x}px; top: {$tooltipPos.y}px; transform: translate(calc(-100%-5px),calc(-100%-5px));" class="p-4 z-50 rounded-br-none rounded-xl fixed bg-primary text-white ">test test</div>
