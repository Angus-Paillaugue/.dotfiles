...
<div id="contactLinksTooltip" style="opacity: 0; left: {$tooltipPos.x}px; top: {$tooltipPos.y}px;" class="p-4 z-40 rounded-xl fixed pointer-events-none bg-primary"></div>
