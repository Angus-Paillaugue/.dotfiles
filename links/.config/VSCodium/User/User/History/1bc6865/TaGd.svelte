  ...
  >
    ...
    {#if message.content === ''}
      <span in:scale={{ duration: 300 }}>
        <LoaderCircle class="mt-1 size-6 animate-spin text-primary-foreground" />
      </span>
    {:else}
      <div
        class={cn(
          'flex flex-col whitespace-pre-wrap rounded-xl border-border bg-secondary px-4 py-2 text-base font-normal',
