...
<div class="mx-auto w-full grow flex flex-col max-w-screen-lg">
	<Input
		id="search"
	...
	/>
	<div class="relative w-full grow flex flex-col overflow-hidden rounded-lg shadow-md">
		<div class="overflow-x-auto grow">
			<table class="w-full min-w-[700px] table-auto text-sm">
