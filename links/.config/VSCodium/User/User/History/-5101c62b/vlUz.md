...
# Installing
Currently, there is no easy way of installing OwnLogs except cloning the repository and running a bunch of commands. But we are curently working on an interactive install script.
