...
<aside
  class="h-screen p-2 max-xl:pt-0 flex flex-col gap-0 xl:w-[300px] max-xl:top-[3.7rem] pb-[58px] overflow-y-auto pl-0 z-40 fixed xl:sticky max-xl:inset-0 bg-white dark:bg-neutral-900 transition-transform top-0 border-r border-neutral-300/50 dark:border-neutral-700/50 shrink-0 {open
...
>
  ...
  >
    ...
    {#if Object.entries(socials).length > 0}
      <span class="w-px h-10 bg-neutral-300/50 dark:bg-neutral-800"></span>
    {/if}
