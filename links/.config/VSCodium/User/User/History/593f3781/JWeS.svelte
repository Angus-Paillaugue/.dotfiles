...
<aside
  class="h-screen p-2 max-md:pt-0 flex flex-col gap-0 md:w-[300px] max-md:top-[3.7rem] overflow-y-auto pl-0 z-40 fixed md:sticky max-md:inset-0 bg-white dark:bg-neutral-900 transition-transform top-0 border-r border-neutral-300/50 dark:border-neutral-800 shrink-0 {open
