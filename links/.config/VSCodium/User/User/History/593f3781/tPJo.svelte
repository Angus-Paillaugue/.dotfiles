...
<aside
  class="h-screen p-2 flex flex-col gap-0 md:w-[300px] max-md:top-[3.8rem] pb-[3.8rem] overflow-y-auto pl-0 z-40 fixed md:sticky max-md:inset-0 bg-white dark:bg-neutral-900 transition-transform {open
