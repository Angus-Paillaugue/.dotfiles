...
<main class="mx-auto w-full max-w-screen-lg grow space-y-4 md:space-y-8">
	<!-- Hero -->
	<div class="grid w-full grid-cols-1 gap-4 md:gap-8 md:grid-cols-3">
	...
	<Card class="w-full">
		...
		<div class="no-scrollbar relative grow w-full overflow-auto rounded-xl">
