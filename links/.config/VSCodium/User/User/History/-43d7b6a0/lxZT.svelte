<script lang="ts">
	...
	import { Activity, ArrowUpRight, CircleUser, CreditCard, DollarSign, Menu, Package2, Search, Users } from "lucide-svelte";
		...
		<div class="flex w-full items-center gap-4 md:ml-auto md:gap-2 lg:gap-4">
			...
			<DropdownMenu.Root>
				...
				<DropdownMenu.Content align="end">
					<DropdownMenu.$stateLabel>My Account</DropdownMenu.$stateLabel>
					<DropdownMenu.$stateSeparator />
					<DropdownMenu.$stateItem>Settings</DropdownMenu.$stateItem>
					<DropdownMenu.$stateItem>Support</DropdownMenu.$stateItem>
					<DropdownMenu.$stateSeparator />
					<DropdownMenu.$stateItem>Logout</DropdownMenu.$stateItem>
