...
public class ModifierLogement extends JFrame {
  ...
  public ModifierLogement(Logement l) {
    ...
    this.files.put("constatAmiante", l.getConstatAmiante());
    this.files.put("constatPlomb", l.getConstatPlomb());
    this.files.put("constatElectricite", l.getConstatElectricite());
