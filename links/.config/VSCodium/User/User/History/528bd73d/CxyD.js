...
export const pages = [
  {
    name: 'Home',
    icon: {
      name: 'material-symbols:rocket-outline-rounded',
      class: 'rotate-45'
    }
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Tree', icon: 'material-symbols:account-tree-outline-rounded' },
      { name: 'Collapsible', icon: 'material-symbols:collapse-all-rounded' },
      { name: 'Note', icon: 'material-symbols:sticky-note-2-rounded' },
      { name: 'Definition', icon: 'material-symbols:text-snippet-outline-rounded' },
      { name: 'Tooltip', icon: 'material-symbols:tooltip-outline-rounded' },
      { name: 'Images', icon: 'material-symbols:imagesmode-outline' },
      { name: 'Api-reference', icon: 'mdi:api' },
      { name: 'Tables', icon: 'material-symbols:table-rows-narrow-outline' },
      { name: 'ComponentPreview', icon: 'material-symbols:code-rounded' }
    ]
  }
];
