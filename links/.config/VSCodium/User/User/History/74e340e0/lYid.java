...
public class RegularisationDesCharges extends JFrame {
  ...
  public RegularisationDesCharges(BienLouable b) {
    ...
    JLabel sousTotalFixe = new JLabel("Sous total fixe : ");
    ...
    JLabel resSousTotalEau = new JLabel("");
    ...
    JLabel resTotalCharges = new JLabel("");
    resTotalCharges.setName("resTotalCharges");
    ...
    JLabel totalRestantDu = new JLabel("");
