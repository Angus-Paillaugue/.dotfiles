...
public class Batiment {
  ...
  public Batiment(TypeDeBatiment typeBatiment, Adresse adresse) {
    ...
    this.biensLouables = new LinkedList<BienLouable>();
    this.travaux = new LinkedList<Travaux>();
    this.assurances = new LinkedList<Assurance>();
  }
  ...
  public void addBienLouable(BienLouable bienLouable) {
    this.biensLouables.add(bienLouable);
  }
