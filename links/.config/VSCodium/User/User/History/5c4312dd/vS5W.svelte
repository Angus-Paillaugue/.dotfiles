...
<section class="relative isolate transform-gpu h-screen flex flex-col md:py-28" id="home">
  ...
  >
    ...
    <div class="w-full h-full row-span-2 max-sm:hidden max-md:self-start border border-neutral-300/50 dark:border-neutral-700/50">

      <img src="/homepage/mockup/{$mode}/homepagePreview_1920.webp" alt="" class="border-neutral-300/50 dark:border-neutral-700/50 object-contain">
    </div>
