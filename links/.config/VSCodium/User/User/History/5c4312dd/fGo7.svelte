...
<section class="relative isolate transform-gpu h-screen flex flex-col md:pt-28 md: pb-10" id="home">
  <!-- Grid -->
  <svg
  ...
  >
    ...
    <div class="max-h-[60%] max-sm:hidden max-md:self-start border rounded-xl overflow-hidden border-neutral-300/50 dark:border-neutral-700/50">
