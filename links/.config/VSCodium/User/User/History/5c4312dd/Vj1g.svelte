...
<section class="relative isolate transform-gpu h-screen flex flex-col md:py-28" id="home">
  ...
  >
    ...
    {#if $mode}
      <div class="md:row-span-2 max-sm:hidden max-md:self-start overflow-hidden border border-neutral-300/50 dark:border-neutral-700/50 relative rounded-lg w-fit h-full">
        <!-- <picture>
        ...
        <img src="/homepage/mockup/{$mode}/homepagePreview_1920.webp" alt="website mockup" class="object-cover h-full" style="max-width: 100%;" />
      </div>
    {/if}
  </div>
</section>
