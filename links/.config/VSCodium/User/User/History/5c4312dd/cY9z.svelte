...
<section class="relative isolate transform-gpu h-screen flex flex-col md:pt-52 md: pb-10" id="home">
  ...
  <!-- Gradient -->
  <div class="absolute inset-0 -z-10 sm:bg-radient-[45%_25%_at_50%_60%] md:bg-radient-[45%_25%_at_50%_75%] lg:bg-radient-[45%_30%_at_50%_70%] xl:bg-radient-[40%_35%_at_50%_60%] from-primary-600/50 dark:from-primary-600/30" style="animation: float 5s ease-in-out infinite;"></div>
  ...
  <!-- Main content -->
  <div
    class="flex flex-col justify-center max-w-screen-2xl grow h-full w-full mx-auto items-center gap-10 relative px-2 md:px-10"
  >
    <!-- Left content part -->
    ...
    <!-- <div class="max-sm:hidden max-md:self-start border rounded-xl overflow-hidden border-neutral-300/50 dark:border-neutral-700/50">

      <img src="/homepage/mockup/{$mode}/homepagePreview_1920.webp" alt="" class="object-contain">
    </div> -->
