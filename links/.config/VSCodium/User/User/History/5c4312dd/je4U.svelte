...
<section class="relative isolate transform-gpu h-screen flex flex-col md:pt-52 md: pb-10" id="home">
  ...
  <!-- Bottom gradient -->
  <div class="pointer-events-none absolute bottom-0 left-0 right-0 z-20 bg-gradient-to-b from-transparent to-white dark:to-neutral-900 to-70% md:to-80% lg:h-[500px] md:h-[400px] max-sm:hidden"></div>
