<script>
  ...
  const typeClasses = {
    ...
    ghost:
      'bg-white dark:bg-neutral-900 hover:bg-neutral-200/50 dark:hover:bg-neutral-700/50 text-neutral-900 dark:text-neutral-100 border border-main dark:border-main-dark'
  };
