...
<div style="display: flex; flex-direction: row; gap: 20px;">
  <a href="https://github.com/Angus-Paillaugue" style="display: flex; flex-direction: column; align-items: center; gap: 20px; border: 1px solid gray; padding: 10px; border-radius:10px;">
  ...
  <a href="https://github.com/EtienneNo" style="display: flex; flex-direction: column; align-items: center; gap: 20px; border: 1px solid gray; padding: 10px; border-radius:10px;">
    <img src="https://avatars.githubusercontent.com/u/127329381" style="border-radius: 100%; width: 50%" alt="Allart Matheo"/>
    <sub>
      <b>Noel Etienne</b>
      <br />
      <b>@EtienneNo</b>
