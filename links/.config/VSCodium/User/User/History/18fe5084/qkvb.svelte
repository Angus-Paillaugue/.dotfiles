...
<svelte:head>
  ...
  <!-- Favicons -->
  <link rel="apple-touch-icon" sizes="180x180" href="/favicons/{$mode}
  /apple-touch-icon.png">
  <link rel="icon" type="image/png" sizes="32x32" href="/favicons/{$mode}
  /favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="/favicons/{$mode}
  /favicon-16x16.png">
</svelte:head>
