...
public class ProprietaireDAOTests {
  ...
  public void testAjouterLogement() {
    ...
    Batiment b = new Batiment(TypeDeBatiment.MAISON, adresse, "31000");
    Loyer loyer = new Loyer(750.0F, 05, LocalDate.of(2024, 8, 11), LocalDate.of(2025, 9, 11), ModeDePaiment.CB);
    Charges charges1 = new Charges(200.0F, 10.0F, 10.0F, 5.0F, 45.0F);
