...
public class ProprietaireDAOTests {
  ...
  public void testCreate() {
    ...
    int idProprietaire = proprietaireDAO.create(p);
    p.setId(idProprietaire);
    Proprietaire p2 = proprietaireDAO.find(idProprietaire);
    assertNotNull(p2);
  ...
  public void testFindByEmail() {
    ...
    System.out.println(p2.getAdresse().getId());
    System.out.println(p.getAdresse().getId());
    assertEquals(p2, p);
  }
}
