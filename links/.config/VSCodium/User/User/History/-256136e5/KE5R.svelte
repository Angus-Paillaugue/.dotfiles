...
{:else}
  <div class="demo" bind:this={commandsContainer}>
    ...
    <!-- Preview/Code -->
    <div class="demoContainer rounded-xl rounded-tl-none border border-main dark:border-main-dark bg-neutral-50 dark:bg-neutral-950 h-[20rem] overflow-y-auto lg:h-[28rem] lenis-prevent" data-tabs={code}>
        <!-- Preview -->
        <div
...
<style>
  ...
  :global(.demoContainer[data-tabs="true"] pre) {
