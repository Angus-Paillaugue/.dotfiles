...
{:else}
  <div class="demo" bind:this={commandsContainer}>
    ...
    <!-- Preview/Code -->
    <div class={cn("demoContainer rounded-xl border border-main dark:border-main-dark bg-neutral-50 dark:bg-neutral-950 h-[20rem] overflow-y-auto lg:h-[28rem] lenis-prevent", code && 'rounded-tl-none')}>
        <!-- Preview -->
        <div
