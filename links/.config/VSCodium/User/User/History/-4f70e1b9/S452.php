...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) .
  ...
  <textarea name="commentaire" class="w-full h-32 border border-neutral-300/50 rounded-lg p-2" placeholder="Entrez votre commentaire ici"><?php echo $commentaire->getContenu(); ?></textarea>
