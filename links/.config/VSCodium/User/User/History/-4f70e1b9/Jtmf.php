...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $ajoutCommentaire = new ModifierUnCommentaire($joueur->getId(), $commentaire);
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) .
  ...
  <textarea name="commentaire" class="w-full h-32 border border-neutral-300/50 rounded-lg p-2" value="<?php echo $commentaire->getContenu(); ?>" placeholder="Entrez votre commentaire ici"></textarea>
