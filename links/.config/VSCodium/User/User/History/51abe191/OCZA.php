...
<body>
  ...
  require '../controleur/CreerUnContact.php';
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (
      ...
      $newContact = new CreerUnContact($nom, $prenom, $adresse, $telephone, $code_postal, $ville);
      $newContact->exec();
    ...
    <div class="border p-4 rounded-xl">
      ...
      <table class='table-auto border-collapse text-sm w-full rounded border m-0'>
        ...
        <tbody>
          ...
          $contacts = ObtenirTousLesContacts::exec();
          var_dump($contacts[1]);
          echo($contacts[1].getNom());
