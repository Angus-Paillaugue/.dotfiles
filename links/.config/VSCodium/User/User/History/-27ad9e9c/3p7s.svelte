...
<div class="flex w-full flex-col">
  <div class="overflow-x-auto w-full max-w-fit no-scrollbar relative">
    ...
    <div
    class={cn(
      'flex h-6 w-full flex-row items-center justify-between overflow-hidden transition-all duration-300 sticky left-0 bottom-0 right-0',
      showingDetailsTooltip && 'h-0 opacity-0'
    )}
    >
      <div class="text-sm text-muted-foreground">
        {format(subDays(new Date(), NUMBER_OF_COLUMNS), 'MMMM dd yyyy')}
      </div>
