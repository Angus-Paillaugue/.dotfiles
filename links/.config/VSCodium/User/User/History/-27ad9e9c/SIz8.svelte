...
{:else}
  <div class="overflow-x-auto w-full max-w-full no-scrollbar">
    ...
    <div
      onmouseleave={() => {showingDetailsTooltip = false; isHoveringIndex = -1}}
  ...
  {#if showingDetailsTooltip && isHoveringIndex > -1 && filledMonitoring[isHoveringIndex]}
    <!-- svelte-ignore a11y_no_static_element_interactions -->
    <div
      class="uptimeGraphTooltip pt-4 -mt-6 z-10"
      onmouseleave={() => (showingDetailsTooltip = false)}
      onmouseenter={() => {console.log('e');showingDetailsTooltip = true}}
