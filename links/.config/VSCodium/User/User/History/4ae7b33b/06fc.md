...
<Steps>
  ...
  Update the demos registry (used by the `<Demo>` component to fetch the component and code). You onoly need to run this script when adding and removing demo files.
