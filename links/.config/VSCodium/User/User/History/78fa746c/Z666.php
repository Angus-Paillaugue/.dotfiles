...
class Components
{
  ...
  public static function Button($params = [])
  {
    ...
    $variantClasses = [
      'primary' => 'dark:bg-primary-dark dark:text-neutral-200 bg-primary-light text-neutral-100',
      'secondary' => 'dark:bg-neutral-700 dark:text-neutral-400 bg-neutral-300 text-neutral-600',
      'ghost' => 'border dark:text-neutral-600 text-neutral-400',
      'danger' => 'dark:bg-red-600 dark:text-neutral-100 bg-red-400 text-neutral-900',
      'square' => 'size-10',
    ];
  ...
  public static function Alert($params = [])
  {
    ...
    $alertClasses = [
      'danger' => 'bg-neutral-100 text-red-600 dark:bg-neutral-800 dark:text-red-400',
      'warning' => 'bg-neutral-100 text-yellow-600 dark:bg-neutral-800 dark:text-yellow-400',
      'success' => 'bg-neutral-100 text-green-600 dark:bg-neutral-800 dark:text-green-400',
    ...
    $error = str_replace('{classes}', $tw->merge($alertClasses[$variant], Components::merge($params, 'class')), $error);
