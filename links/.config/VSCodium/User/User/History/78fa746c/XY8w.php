...
class Components
{
  ...
  public static function Alert($params = [])
  {
    ...
    echo str_replace('{text}', $text, $alertTemplates[$variant]).str_replace('{icon}', $icons[$variant], $alertTemplates[$variant]).str_replace('{classes}', $alertClasses[$variant], $alertTemplates[$variant]);
  }
