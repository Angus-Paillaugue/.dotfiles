...
class Components
{
  ...
  public static function Alert($params = [])
  {
    ...
    $id = Components::merge($params, 'id');
    $variantClasses = [
      'danger' => 'bg-neutral-900 text-red-600 border-red-800',
      'warning' => 'bg-neutral-900 text-yellow-600 border-yellow-800',
      'success' => 'bg-neutral-900 text-green-600 border-green-800',
      'info' => 'bg-neutral-900 text-primary-600 border-primary-800',
    ];
    $icons = [
      'danger' =>
