...
class Components
{
  ...
  public static function Alert($params = [])
  {
    ...
    $id = Components::merge($params, 'id');
    $variantClasses = [
      'danger' => 'bg-neutral-900 text-red-700 border-red-700',
      'warning' => 'bg-neutral-900 text-yellow-700 border-yellow-700',
      'success' => 'bg-neutral-900 text-green-700 border-green-700',
      'info' => 'bg-neutral-900 text-primary-700 border-primary-700',
    ];
    $icons = [
      'danger' =>
