...
class Components
{
  ...
  public static function Button($params = [])
  {
    ...
    $variantClasses = [
      'primary' => 'dark:bg-primary-700 dark:text-neutral-200 bg-primary-400 text-neutral-100',
      // TODO: fix light theme for variants below
      'secondary' => 'dark:bg-neutral-700 dark:text-neutral-400',
      'ghost' => 'border dark:text-neutral-600',
      'danger' => 'dark:bg-red-600 dark:text-neutral-100',
      'square' => 'size-10',
    ];
