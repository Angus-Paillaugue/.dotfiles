...
class Components
{
  ...
  public static function Link($params = [])
  {
    ...
    $classes = $tw->merge(
      'cursor-pointer font-medium items-center justify-center inline-flex flex-row gap-2 text-neutral-100 hover:text-neutral-400 underline transition-colors',
      $class
    );
    echo "<a href='$href' " .
      ($id && 'id=' . $id) .
  ...
  public static function Alert($params = [])
  {
    ...
    $id = Components::merge($params, 'id');
    $variantClasses = [
      'danger' => 'bg-neutral-900 text-red-600 border-red-200',
      'warning' => 'bg-neutral-900 text-yellow-600 border-yellow-200',
      'success' => 'bg-neutral-900 text-green-600 border-green-200',
      'info' => 'bg-neutral-900 text-primary-600 border-primary-200',
    ];
    $icons = [
      'danger' =>
