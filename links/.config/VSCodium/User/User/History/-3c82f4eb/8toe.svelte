...
<section class="flex h-screen cursor-none flex-col items-center justify-center gap-4">
  <h1
    class="text-8xl font-extrabold transition-all duration-500  :text-shadow-[0px_0px_15px_rgba(0,_0,_0,_1)] dark:hover:text-shadow-[0px_0px_15px_rgba(255,_255,_255,_1)]"
  >
    {$page.status}
  </h1>
