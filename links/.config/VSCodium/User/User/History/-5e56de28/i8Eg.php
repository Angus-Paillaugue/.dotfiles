...
class FeuilleMatchDAO {
  ...
  public function getForRencontre($id) {
    ...
    foreach ($data as $feuilleMatchDB) {
      $feuilleMatch = new FeuilleMatch($feuilleMatchDB['id_rencontre'], $feuilleMatchDB['id_joueur'], $feuilleMatchDB['role_debut'], $feuilleMatchDB['role_fin'], $feuilleMatchDB['poste'], $feuilleMatchDB['evaluation']);
