...
class FeuilleMatchDAO {
  ...
  public function getForRencontre($id) {
    ...
    foreach ($data as $feuillMatch) {
      $feuilleMatch = new FeuilleMatch($feuillMatch['id_rencontre'], $feuillMatch['id_joueur'], $feuillMatch['role_debut'], $feuillMatch['role_fin'], $feuillMatch['poste'], $feuillMatch['evaluation']);
      $feuilleMatch->setId($feuillMatch['id']);
