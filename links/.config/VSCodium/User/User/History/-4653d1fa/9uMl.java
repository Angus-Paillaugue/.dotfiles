...
public class MyApartmentsVue extends JFrame {
    ...
    private JPanel createNavbar() {
        ...
        JButton addApartment = new Button("Ajouter une location", Constants.ICONS_PATH + "plus-16x16-white.png")
                .build();

        JButton addTennant = new Button("Ajouter un locataire", Constants.ICONS_PATH + "plus-16x16-white.png")
                .build();
