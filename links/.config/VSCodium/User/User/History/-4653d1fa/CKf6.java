...
public class MyApartmentsVue extends JFrame {
    ...
    private JPanel createNavbar() {
        ...
        JButton addApartment = new ButtonNeutral("Ajouter une location", Constants.ICONS_PATH + "plus-16x16-black.png")
                .build();

        JButton addTennant = new ButtonNeutral("Ajouter un locataire", Constants.ICONS_PATH + "plus-16x16-white.png")
                .build();

        JButton logOut = new ButtonPrimary("Se déconnecter").build();
