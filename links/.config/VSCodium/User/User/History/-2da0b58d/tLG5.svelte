...
<div class={cn('relative', className)} {...restProps}>
  ...
  {/if}
  <div
    class="component-preview lenis-prevent relative flex flex-col h-[20rem] overflow-auto rounded-xl bg-primary-400 before:absolute before:inset-0 before:opacity-100 before:transition-opacity before:content-[''] before:hover:opacity-0 lg:h-[28rem] before:pointer-events-none"
  >
