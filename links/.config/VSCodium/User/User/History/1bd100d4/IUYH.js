  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        name: 'e.timeout',
        description:
          'The duration in milliseconds before the toast is automatically removed. If false, the toast will not be removed automatically.',
        default: 'false'
      },
      {
        type: 'Object',
      ...
      },
      {
        ...
        description:
          'The callback function to be executed when the action button is clicked. The callback function will be called with the `e` argument.'
      },
      {
        type: 'boolean',
        name: 'e.closeButton',
