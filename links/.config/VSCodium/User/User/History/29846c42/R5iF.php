...
<div class="max-w-screen-xl w-full mx-auto p-4 rounded-xl border space-y-4 border-primary-100">
  ...
  <div class="flex flex-row gap-8 flex-wrap">
    <div class="flex flex-row gap-2 items-center px-4 py-2 border rounded-lg w-fit border-primary-100">
  ...
  <?php if (count($joueur->getCommentaires()) == 0) {
    ...
    foreach ($joueur->getCommentaires() as $commentaire) {
      echo "<div class='bg-primary-50 p-4 rounded-lg border border-primary-100 group/comment relative overflow-hidden'>";
