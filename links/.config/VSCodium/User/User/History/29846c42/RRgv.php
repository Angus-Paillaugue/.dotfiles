...
<div class="max-w-screen-xl w-full mx-auto p-4 rounded-xl border space-y-4 border-neutral-300/50 dark:border-neutral-900">
  <div class="flex flex-row items-center justify-between">
    ...
    <?php Components::Button([
      'label' => 'Modifier',
      'href' => '/vue/dashbaord/edit-joueur.php?id=' . $joueur->getId(),
    ]); ?>
  </div>
  ...
  <?php if (count($joueur->getCommentaires()) == 0) {
    ...
    Components::Link([
      'label' => 'en ajouter',
      'href' => '/vue/dashbaord/add-commentaire.php?id=' . $joueur->getId(),
    ]);
    echo '</p>';
  } else {
    ...
    foreach ($joueur->getCommentaires() as $commentaire): ?>
      ...
      Components::Button([
        'label' => 'Modifier',
        'href' => '/vue/dashbaord/edit-commentaire.php?id=' . $commentaire->getId(),
      ]);
      Components::Button([
        'label' => 'Supprimer',
        'variant' => 'danger',
        'href' =>
          '/vue/dashbaord/delete-commentaire.php?id=' .
          $commentaire->getId() .
          '&redirect=' .
