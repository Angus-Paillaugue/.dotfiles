...
public class ColocationDAOTests {
  ...
  public void setUp() throws SQLException {
    ...
    new LogementDAO().create(this.logement, 543);
  }
  ...
  public void addColoc() {
    ...
    Personne p =
        new Personne(
            ...
            "Etudiant",
            "Université",
            TypeDeContratDeTravail.CDD,
            1000.0F,
            500.0F,
            "",
            "",
            new Adresse(143, "Rue de Paris", "", "Paris", "75001"));
    this.colocationDAO.addColoc(colocation, this.location, p);

    // Checking if colocataire is added
    colocation = this.colocationDAO.findByLogement(this.logement);
    System.out.println(colocation.getContrats().size());
