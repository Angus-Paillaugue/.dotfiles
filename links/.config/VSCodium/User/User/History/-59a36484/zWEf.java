...
public class ColocationDAOTests {
  ...
  public void addColoc() {
    ...
    // Adding colocataire
    Pesonne p = new Personne("Doe", "John", 1, LocalDate.of(2000, 1, 1), "Paris", SituationFamiliale.CELIBATAIRE, "Etudiant", "Université", TypeDeContratDeTravail.CDD, 1000.0F, 500.0F);
  }
