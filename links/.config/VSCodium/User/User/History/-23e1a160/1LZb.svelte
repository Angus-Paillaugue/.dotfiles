...
>
  <button
    onclick={() => (open = !open)}
    {...restProps}
    class="cursor-pointer flex flex-row items-center items-between text-base font-semibold py-2 px-4 hover:bg-neutral-200/50 dark:bg-inherit transition-colors w-full"
  >
