...
<div id={title+"Window"} class={cn("flex absolute flex-col rounded-lg overflow-hidden border transition-[scale] border-neutral-700/50", className)} bind:this={windowElement}>
