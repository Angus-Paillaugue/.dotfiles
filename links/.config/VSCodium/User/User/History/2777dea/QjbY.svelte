<script>
  ...
  $effect(() => {
    windowInstance.visible = visible;
  })
</script>

<div id={title+"Window"} class={cn("flex absolute flex-col rounded-lg overflow-hidden border border-neutral-700/50", className)} bind:this={windowElement}>
  <div class="flex flex-row items-center w-full bg-neutral-800 p-2 gap-2 titleBar">
  ...
  <div class="w-full flex flex-col overflow-y-auto p-2">
    {@render children()}
  </div>
</div>
