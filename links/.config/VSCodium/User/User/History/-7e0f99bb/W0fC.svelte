<script>
  ...
  let { open = $bindable(false), children, items, position = "bottom", align = "center", class:className, ...restProps } = $props();
...
<div class={cn("z-30 w-52 shadow absolute overflow-hidden bg-neutral-100 dark:bg-neutral-950 rounded-md", positionClasses[position].pos, positionClasses[position].align[align])} use:accordion={open}>
