...
# Install the yt-playlist-dl script
sudo cp yt-playlist-dl.sh /usr/local/bin/yt-playlist-dl
sudo chmod +x /usr/local/bin/yt-playlist-dl

echo -e " ${GREEN}✓${NC} The yt-playlist-dl script has been installed successfully."
