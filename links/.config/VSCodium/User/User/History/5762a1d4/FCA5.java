...
public class DetailAppartement extends JFrame {
  ...
  public DetailAppartement(Logement logement) {
    ...
    Logger.log(logement.getIdBatiment());
    ...
    loyerPanel.add(
        createDetailLabel("Loyer hors charges", logement.getLoyer().getMontantHorsCharge() + " €", null), gbc);
    JButton editChargesButton = new Button("", Constants.ICONS_PATH + "edit-16x16-border.png").build();
    ...
    JButton editLoyerButton = new Button("", Constants.ICONS_PATH +"edit-16x16-border.png").build();
