...
public class DetailAppartement extends JFrame {
  ...
  public DetailAppartement(Logement logement) {
    ...
    chargesPanel.add(createDetailLabel("Charges", logement.getCharges().provisionSurChargeAnnuel() + " €", null));
    JButton editChargesButton = new Button("Editer").build();
    chargesPanel.add(editChargesButton);
