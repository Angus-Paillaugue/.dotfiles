...
public class DetailAppartement extends JFrame {
  ...
  public DetailAppartement(Logement logement) {
    ...
    JButton editChargesButton = new Button(" ", Constants.ICONS_PATH + "edit-16x16-border").build();
    ...
    JButton editLoyerButton = new Button(" ", Constants.ICONS_PATH +"edit-16x16-border").build();
    editLoyerButton.addActionListener(
        e -> {
          this.dispose();
          new HistoriqueDesCharges(logement);
        });
    gbc.gridx = 2;
    gbc.weightx = 0.1;
    gbc.anchor = GridBagConstraints.EAST;
