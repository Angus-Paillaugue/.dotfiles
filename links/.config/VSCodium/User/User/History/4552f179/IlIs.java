...
public abstract class BienLouable {
  ...
  public BienLouable(
    ...
    this.loyer = loyer;
    this.travaux = new LinkedList<Travaux>();
    this.assurance = new LinkedList<Assurance>();
  ...
  public Boolean isVide() {
    if (this.isLocation()) {
      return this.location == null || this.location.getLocataires().size() == 0;
    } else if (this.isColocation()) {
      return this.colocation == null || this.colocation.getColocataires().size() == 0;
    }
    return true;
  }
  ...
  public String getTypeLogement() {
    return isColocation() ? "Colocation" : "Location";
  }
