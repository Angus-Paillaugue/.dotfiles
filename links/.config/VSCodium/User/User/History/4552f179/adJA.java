...
public abstract class BienLouable {
  ...
  public Boolean isVide() {
    System.out.println(this.isLocation());
    System.out.println(this.location.getLocataires().size());
    System.out.println(this.colocation.getColocataires().size());
    return this.isLocation() ? this.location.getLocataires().size() == 0 : this.colocation.getColocataires().size() == 0;
  }
