...
public class Logement extends BienLouable {
  ...
  public float surfaceTotale() {
	...
	public String toString() {
		return "Logement [typePorte=" + typePorte + ", datePermisConstruction=" + datePermisConstruction
				+ ", dateConstruction=" + dateConstruction + ", constatAmiante=" + constatAmiante + ", constatPlomb="
				+ constatPlomb + ", constatElectricite=" + constatElectricite + ", constatEnergetique="
				+ constatEnergetique + ", emissionGazEffetDeSerre=" + emissionGazEffetDeSerre + ", referenceLogement="
				+ referenceLogement + ", meuble=" + meuble + ", equipementAccesTechnologie=" + equipementAccesTechnologie
				+ ", pieces=" + pieces + ", elementEquipementLogement=" + elementEquipementLogement + ", garage="
				+ garage + "]";
	}
}
