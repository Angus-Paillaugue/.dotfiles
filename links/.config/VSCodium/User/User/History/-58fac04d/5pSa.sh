...
yt-dlp -x --audio-format flac --audio-quality 320k --embed-thumbnail --embed-metadata --download-archive _songs.txt -o "%(uploader) - %(title)s.%(ext)s" "https://www.youtube.com/playlist?list=$playlistId"
