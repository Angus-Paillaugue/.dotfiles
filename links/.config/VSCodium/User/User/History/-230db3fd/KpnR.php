...
function displayRencontres($r)
{
  ...
  foreach ($r as $rencontre) {
    ...
    <a href='/vue/dashboard/rencontre.php?id=" .
      $rencontre->getId() .
      "' class='bg-neutral-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 transition-colors hover:bg-neutral-200 p-4 rounded-lg border border-neutral-300/50 dark:border-neutral-900'>
