...
function displayRencontres($r)
{
  ...
  foreach ($r as $rencontre) {
    ...
    <a href='/vue/dashboard/rencontre.php?id=" .
      $rencontre->getId() .
      "' class='bg-neutral-100 dark:bg-neutral-900 p-4 rounded-lg'>
...
echo "<div class='max-w-screen-xl w-full mx-auto p-4 rounded-xl space-y-4 border border-neutral-300/50 dark:border-0'>";
