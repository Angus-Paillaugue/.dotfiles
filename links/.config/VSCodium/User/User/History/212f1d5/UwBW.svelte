...
<h2 class="mt-10 scroll-m-20 pb-2 text-3xl font-semibold tracking-tight mb-4">Disks</h2>
{#if disks.length === 0}
					...
					<div class="flex flex-col gap-4 w-full">
						<div class="flex flex-row gap-4 items-center">
							...
							<div class="flex flex-col h-full justify-between">
								<h3 class="scroll-m-20 text-xl font-semibold tracking-tight">{disk.size}</h3>
