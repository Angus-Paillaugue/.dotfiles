...
async function login(page, origin) {
	...
	await page.waitForSelector('#signUp input[type="email"]', { visible: true });

	// Fill in and submit login form.
	const emailInput = await page.$('#signUp input[type="email"]');
	await emailInput.type('admin@example.com');
	const passwordInput = await page.$('#signUp input[type="password"]');
