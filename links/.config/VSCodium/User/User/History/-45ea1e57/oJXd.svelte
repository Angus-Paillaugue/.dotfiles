...
<div class="flex min-h-screen w-full flex-col">
  {#key data?.name}
    ...
    <div class="mx-auto flex h-full w-full grow flex-col-reverse justify-center lg:flex-row">
      <Button onclick={() => (mobileTocVisible = !mobileTocVisible)} type={["square", "ghost"]} class="flex lg:hidden items-center justify-center fixed top-[4.5rem] right-4 z-30">
        <Icon icon="line-md:menu-unfold-right" class="size-4" />
      </Button>
      ...
      <div class="text-nowrap lg:px-2 lg:py-4 lg:sticky lg:top-24 lg:ml-4 lg:h-fit lg:w-[250px] overflow-auto max-lg:fixed max-lg:inset-0 max-lg:bg-white max-lg:dark:bg-neutral-900 max-lg: {mobileTocVisible ? 'max-lg:translate-x-0' : "max-lg:translate-x-full"}">
