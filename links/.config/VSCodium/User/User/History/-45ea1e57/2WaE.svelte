...
<div class="flex min-h-screen w-full flex-col">
  {#key data?.name}
    ...
    <div class="mx-auto flex h-full w-full grow flex-col-reverse justify-center lg:flex-row">
      ...
      <div class="text-nowrap lg:px-2 lg:py-4 lg:sticky lg:top-24 lg:ml-4 lg:h-fit lg:w-[250px] overflow-auto max-lg:fixed max-lg:top-0 maxl {mobileTocVisible ? 'max-lg:translate-x-0' : "max-lg:translate-x-full"}">
