...
<div class="flex min-h-screen w-full flex-col mx-auto max-w-screen-2xl">
  {#key data?.name}
    <Navbar title={data?.name ?? 'Docs'} />

    <div class="flex h-full w-full flex-col-reverse justify-center max-lg:items-center lg:gap-8 lg:flex-row">
      <Sidebar open={sidebarOpen} style={sidebarStyle} />
      <main class="flex h-full grow flex-col p-2 max-w-screen-lg mx-auto">
