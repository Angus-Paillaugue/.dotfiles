  ...
  {#key data?.name}
    ...
    <div class="mx-auto flex h-full w-full grow flex-col-reverse justify-center max-lg:items-center lg:flex-row">
      ...
      {#if headings.length > 0}
        ...
        <Button name="openToc" onclick={() => (mobileTocVisible = !mobileTocVisible)} type={["square", "ghost"]} class="flex lg:hidden items-center justify-center fixed top-[4.5rem] right-4 z-20 p-4">
