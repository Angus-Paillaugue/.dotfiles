...
<div class="flex min-h-screen w-full flex-col">
  {#key data?.name}
    ...
    <div class="mx-auto flex h-full w-full grow flex-col-reverse justify-center max-lg:items-center lg:flex-row">
      <Button name="openToc" onclick={() => (mobileTocVisible = !mobileTocVisible)} type={["square", "ghost"]} class="flex lg:hidden items-center justify-center fixed top-[4.5rem] right-4 z-40 p-4">
      ...
      <div class="text-nowrap lg:px-2 lg:py-4 lg:sticky lg:top-24 lg:ml-4 lg:h-fit lg:w-[250px] overflow-auto max-lg:fixed max-lg:inset-0 max-lg:bg-white max-lg:dark:bg-neutral-900 max-lg:flex max-lg:flex-col max-lg:items-center max-lg:justify-center transition-transform max-lg:z-30 {mobileTocVisible ? 'max-lg:translate-x-0' : "max-lg:-translate-x-full"}" id="toc-container">
