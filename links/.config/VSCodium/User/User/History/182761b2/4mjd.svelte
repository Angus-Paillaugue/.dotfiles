...
<noscript>
  <div class="fixed inset-0 z-50 bg-background text-center flex flex-row gap-2 items-center justify-center">
    <Ban class="w-8 h-8 text-primary" />
    <p>Please allow JavaScript execution</p>
  </div>
</noscript>
