...
You can now test all of the functionalities. When done and confirmed everything works as it's supposed to, you can push the image to the registry by running `./docker/push.sh`
