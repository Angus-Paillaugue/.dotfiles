...
public class LoyerDAOTests {
  ...
  public void setUp() throws SQLException {
    ...
    this.testLoyer = new Loyer(750.0F, 5, LocalDate.of(2024, 8, 11), LocalDate.of(2025, 9, 11), ModeDePaiment.CB);
  }
  ...
  public void testUpdate() {
    int idBienLouable = 1;
    int idLoyer = loyerDAO.create(this.testLoyer, idBienLouable);
    Loyer updatedLoyer = new Loyer(800.0F, 10, LocalDate.of(2024, 8, 11), LocalDate.of(2025, 9, 11), ModeDePaiment.CB);
    loyerDAO.update(updatedLoyer, idLoyer);
    Loyer loyer = loyerDAO.find(idLoyer);
    assertNotNull(loyer);
    assertEquals(updatedLoyer, loyer);
  }
