    ...
    <table class='w-full table-auto text-sm rounded-lg overflow-hidden'>
      <thead class='sticky top-0 bg-neutral-900'>
        <tr>
          ...
          <td scope='col' class='sticky top-0 h-12 px-4 text-left align-middle font-medium text-neutral-600 dark:text-neutral-400'>Nb matches consecutifs</td>
        </tr>
      </thead>
        ...
        <?php foreach ($playersStats as $joueur): ?>
          <tr class='even:bg-neutral-900 text-base font-base'>
            ...
            <td class='px-4 py-1 align-middle'><?php echo $joueur[
              ...
              : ''; ?></td>
            <td class='px-4 py-1 align-middle'><?php echo $joueur['nbMatchConsecutifs'] ?? 0; ?></td>
          </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
