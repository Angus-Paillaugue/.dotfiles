    ...
    <tbody>
      <?php foreach ($playersStats as $joueur): ?>
        <tr class='even:bg-neutral-900 text-base font-base'>
          ...
          <td class='px-4 py-1 align-middle'><?php echo number_format($joueur['moyenne_notes'], 1); ?></td>
          <td class='px-4 py-1 align-middle'><?php echo number_format($joueur['pourcentage_victoire_titulaire'], 1); ?></td>
        </tr>
      <?php endforeach ?>
    </tbody>
  </table>
