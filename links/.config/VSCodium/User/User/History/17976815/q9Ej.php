  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    <div class="bg-neutral-900 transition-colors flex flex-row justify-between p-4 rounded-lg border border-neutral-900">
      ...
      <div class="flex flex-col items-end justify-between">
        <button class="px-3 py-1 rounded bg-green-600 font-mono group flex flex-row">
        ...
        <button class="px-3 py-1 rounded bg-red-600 font-mono group flex flex-row">
        ...
        <button class="px-3 py-1 rounded bg-gray-600 font-mono group flex flex-row">
