    ...
    <tbody>
      <?php foreach ($playersStats as $joueur): ?>
        <tr>
          ...
          <td ><?php echo $joueur['poste_max_victoire']; ?></td>
          <td ><?
            echo $joueur['nbTitulaire'];
          ?></td>
          <td ><?php echo $joueur['nbRemplacant']; ?></td>
          <td ><?php echo $joueur['moyenne_notes']; ?></td>
          <td ><?php echo $joueur['pourcentage_victoire_titulaire']; ?></td>
        </tr>
      <?php endforeach ?>
    </tbody>
  </table>
