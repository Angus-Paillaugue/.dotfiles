  ...
  <table class='w-full table-auto text-sm'>
    ...
    <tbody>
      <?php foreach ($playersStats as $joueur): ?>
        <tr>
          <td class='even:bg-neutral-900'><td class='px-4 py-1 align-middle'><?php echo $joueur['nom'] . ' ' . $joueur['prenom']; ?></td>
          <td class='even:bg-neutral-900'><td class='px-4 py-1 align-middle'><?php echo $joueur['poste_max_victoire']; ?></td>
          <td class='even:bg-neutral-900'><td class='px-4 py-1 align-middle'><?
            echo $joueur['nbTitulaire'];
          ?></td>
          <td class='even:bg-neutral-900'><td class='px-4 py-1 align-middle'><?php echo $joueur['nbRemplacant']; ?></td>
          <td class='even:bg-neutral-900'><td class='px-4 py-1 align-middle'><?php echo $joueur['moyenne_notes']; ?></td>
          <td class='even:bg-neutral-900'><td class='px-4 py-1 align-middle'><?php echo $joueur['pourcentage_victoire_titulaire']; ?></td>
        </tr>
      <?php endforeach ?>
    </tbody>
  </table>
