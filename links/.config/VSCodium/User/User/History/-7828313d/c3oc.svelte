    ...
    <button
      ...
      class={cn(
        ...
        absolute
          ...
          : snippet ? 'max shrink-0 rounded-none bg-body' : 'aspect-square h-full',
        snippet && 'max shrink-0 rounded-none bg-body'
      )}
      name="Copy code"
...
{:else}
  ...
  >
    {#if name}
      <div
        class="codeBlockName relative flex w-full flex-row items-center rounded-t-xl border border-b-0 border-neutral-300 px-3 py-1.5"
      >
        <p
