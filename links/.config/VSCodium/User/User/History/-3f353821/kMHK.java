...
import controleurs.SeConnecterControleur;
...
public class SeConnecter extends JFrame {
  ...
  /**
   * This is the main application entry point. It is responsible for setting up the application
   * theme and creating the main frame.
   */
  ...
  public SeConnecter() {
    ...
    setSize(400, 250); // Set preferred size
    setLayout(new BorderLayout());
    setLocationRelativeTo(null); // Center the frame
    SeConnecterControleur controller = new SeConnecterControleur(this);
    ...
    // Email TextField
    emailField = new JFormattedTextField("test@test.fr");
    gbc.gridx = 1;
    gbc.gridy = 1;
    ...
    addWindowListener(() -> {Connector.closeConnection()});
  }
}
