...
{#if createCategoryModalVisible}
	...
	>
		...
		>
			...
			<input
				type="text"
				class="text-base font-medium md:font-semibold w-full rounded-xl bg-neutral-900 px-4 py-2 text-neutral-100 placeholder:text-neutral-400 focus:outline-0"
				name="name"
			...
			<div class="grid grid-cols-2 gap-4">
				<button
					type="button"
					class="text-base font-medium md:font-semibold w-full rounded-xl bg-neutral-700 px-4 py-2 text-neutral-100 placeholder:text-neutral-400 focus:outline-0"
	...
	<Pane defaultSize={50} class="flex flex-col gap-2">
		...
		<div class="flex flex-col grow bg-neutral-900 h-full rounded-xl">
			<div class="p-4 grow flex flex-col overflow-y-auto">
				...
				<input
					type="text"
					class="mb-2 mt-4 text-3xl font-medium leading-[3.5rem] md:font-semibold md:leading-[4rem] w-full rounded-xl bg-neutral-800 px-4 py-2 text-neutral-100 placeholder:text-neutral-400 focus:outline-0"
					bind:value={title}
				/>
					...
					<div id="pageContainer" class="flex flex-col grow shrink-0">
						...
						{:else}
							<textarea
								...
								class="grow w-full rounded-xl bg-neutral-800 px-6 py-3 text-base resize-none font-medium text-neutral-100 placeholder:text-neutral-400 focus:outline-0"
							></textarea>
						{/if}
					</div>
				</div>
				...
				{#each tests as _test, index}
					...
					<div
						...
						class={cn(
							...
							index === selectedTestIndex && 'bg-neutral-800'
						)}
