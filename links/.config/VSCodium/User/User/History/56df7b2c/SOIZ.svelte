	...
	<Pane defaultSize={50} class="flex flex-col gap-2">
		...
		<div class="flex flex-col grow bg-neutral-900 h-full rounded-xl">
			<div class="p-4 grow flex flex-col overflow-y-auto">
				...
				<input
					type="text"
					class="mb-2 mt-4 text-3xl font-medium leading-[3.5rem] md:font-semibold md:leading-[4rem] w-full rounded-xl bg-neutral-800 px-4 py-2 text-neutral-100 placeholder:text-neutral-400"
					bind:value={title}
				/>
