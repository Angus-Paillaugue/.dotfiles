...
<footer
  class="sticky w-full px-6 pb-6 pt-14 text-text-heading dark:text-text-heading-dark md:bottom-0 md:-z-10 min-h-[300px]"
>
  <div
    class="mx-auto flex max-w-screen-lg gap-8 max-md:flex-col-reverse md:grid md:grid-cols-[auto,400px] mt-auto"
  >
