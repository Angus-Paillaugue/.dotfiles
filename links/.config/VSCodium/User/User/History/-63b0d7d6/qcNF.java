...
public class Colocation {
  ...
  public List<Personne> getColocataires() {
    ...
    public List<Personne> getColocatairesList()
    {
    ...
    {
    	return (List<Personne>)this.colocations.stream()
...
*/
  public Adresse getLieuDeContrat(Personne coloc) {
    return (Adresse) this.colocations.stream()
    		.filter(_loc -> _loc.getLocataires().contains(coloc))
  ...
  {
	  if(this.colocations.size() == 0 || this.colocations.get(0).getLocataires().get(0).getAdresse() == colocataire.getAdresse())
