...
public class AssuranceTests {
	...
	public void testAssuranceConstructor() {
		Assurance assurance = new AssuranceImpl(typeContratAssurance.HABITATION, "Assureur1", 123, 100);

		assertEquals(typeContratAssurance.HABITATION, assurance.getTypeContrat());
