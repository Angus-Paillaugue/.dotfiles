...
public class GarageTests {
  ...
  public void testGarageConstructor() {
    ...
    Loyer loyer =
        new Loyer(1000, 1, LocalDate.now(), LocalDate.now().plusYears(1), ModeDePaiment.CHEQUE);
    Charges charges = new Charges(100, 50, 30, 20, 200, 2, 2, LocalDate.now());
    Garage garage = new Garage(adresse, 10, 10, "RC123", true, "NF123", 300, loyer, charges);
  ...
  public void testSurfaceTotale() {
    ...
    assertEquals(10, garage.getSurfaceTotale(), 0.01);
  }
}
