...
MYSQL_PASSWORD=$(getDotEnvValue './.env' 'MYSQL_PASSWORD')
MYSQL_USER=$(getDotEnvValue './.env' 'MYSQL_USER')
MYSQL_DATABASE=$(getDotEnvValue './.env' 'MYSQL_DATABASE')
JWT_SECRET=$(getDotEnvValue './.env' 'JWT_SECRET')
