...
public class Charges {
	...
	public Charges(int provisionSurCharge, int totalEau, int totalCharges, int provisionSurChargeAnnuel,
			int propositionNouvelleProvisionSurCharge, int restantDu, int eauPartieVariable, int eauConsommation) {
