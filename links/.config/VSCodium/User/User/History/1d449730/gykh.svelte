...
<div class="rounded-full fixed z-50 pointer-events-none transition-colors backdrop-grayscale backdrop-invert lg:hidden" style="top: {$extCirclePos.y}px; left:{$extCirclePos.x}px; width: {$extCirclePos.width}px; height: {$extCirclePos.height}px;" bind:this={cursor}></div>
