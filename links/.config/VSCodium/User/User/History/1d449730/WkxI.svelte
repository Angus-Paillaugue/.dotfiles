...
<div class="rounded-full fixed z-50 pointer-events-none border-2 border-primary max-lg:hidden" style="top: {$extCirclePos.y}px; left:{$extCirclePos.x}px; width: {$extCirclePos.width}px; height: {$extCirclePos.height}px;" bind:this={cursor}></div>
