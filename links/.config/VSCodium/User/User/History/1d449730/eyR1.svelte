<script>
  ...
  function handleMouseMove(e) {
    ...
    if(hoveringActiveElement) {
      cursor.classList.remove("backdrop-grayscale", "backdrop-invert");
      cursor.classList.add("bg-black", "text-white");
    } else {
      cursor.classList.add("backdrop-grayscale", "backdrop-invert");
      cursor.classList.remove("bg-black", "text-white");
    }
  }
