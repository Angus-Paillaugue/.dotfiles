...
class Components
{
  ...
  public static function Icon($params = []) {
    ...
    $class = Components::merge($params, 'class');
    $size = Components::merge($params, 'size', '10');
    $classes = $tw->merge("size-$size", $class);
    echo "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='$classes'>$icon</svg>";
  }
}
