...
class Components
{
  ...
  public static function Button($params = [])
  {
    ...
    $iconHTML = $icon ? Components::Icon($icon) : '';
    if ($href) {
      echo "<a href='$href' " .
        ($id && 'id=' . $id) .
  ...
  public static function Icon($params = []) {
    ...
    echo "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='$classes'>$iconPaths[$icon]</svg>";
  }
}
