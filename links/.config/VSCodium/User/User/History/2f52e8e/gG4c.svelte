  ...
  >
    ...
    >
      ...
      {#if homepage.version.showHomepageMessage}
        <a
          class="group relative mb-5 flex w-max items-center gap-x-2 rounded-full border border-main dark:border-main-dark px-2 py-1 text-sm transition-colors hover:bg-neutral-600/10 focus-visible:bg-neutral-600/20"
      ...
      <div class="mt-8 flex w-full flex-row items-center justify-start gap-8">
        ...
        <Button type="ghost" class="flex flex-row items-center gap-4 rounded-full">
          ...
          <Icon
            icon="line-md:arrow-right"
            class="size-6 rounded-full bg-neutral-200/50 p-1 text-text-heading dark:text-text-heading-dark dark:bg-neutral-700/50"
          />
        </Button>
      </div>
    </div>
