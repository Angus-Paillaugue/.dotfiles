  ...
  >
    ...
    >
      ...
      {#if homepage.version.showHomepageMessage}
        <a
          class="group relative mb-5 flex w-max items-center gap-x-2 rounded-full border border-main px-2 py-1 text-sm transition-colors hocus:bg-neutral-600/10 focus-visible:bg-neutral-600/20 dark:border-main-dark"
          ...
          <Icon
            ...
            class="h-4 w-4 transition-transform duration-500 group-hocus:translate-x-1 group-focus-visible:translate-x-1"
          />
