...
public class LogementTests {
	...
	public void testLogementConstructor() {
		...
		Loyer loyer = new Loyer(1000, 1, LocalDate.now(), LocalDate.now().plusYears(1), ModeDePaiment.BANQUE);
		Charges charges = new Charges(100, 50, 30, 20, 200, 2, 50, 100);
		Logement logement = new Logement(adresse, "RC123", true, 500, "NF123", 300, loyer, charges,
				"Wooden", LocalDate.of(2000, 1, 1), LocalDate.of(2001, 1, 1),
				"No", "No", "Yes", noteEnergetique.A, noteEnergetique.B,
				"REF123", true, "Fiber");

		assertEquals(adresse, logement.getAdresse());
		assertEquals("RC123", logement.getRefCadastrale());
		assertTrue(logement.isBati());
		assertEquals(500, logement.getMontantDepotGarantie(), 0.01);
		...
		assertEquals("Wooden", logement.getTypePorte());
	...
	public void testSurfaceTotale() {
		...
		assertEquals(150.5f, logement.surfaceTotale(), 0.01);
	}
	...
	public void testAddElementEquipementLogement() {
		...
		ElementEquipementLogement equipement = new ElementEquipementLogement("Air Conditioner");
	...
	public void testAddGarage() {
		...
		Garage garage = new Garage(adresse, "RC124", true, 200, "NF124", 100, loyer, charges);
