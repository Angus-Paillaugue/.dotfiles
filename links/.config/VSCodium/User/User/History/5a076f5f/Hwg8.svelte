    ...
    <div class="relative px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:max-w-7xl">
                ...
                <div class="group/item relative py-3">
                  ...
                  ><a aria-label="Home" href="/"
                    ><svg
                      ...
                      ><g
                        opacity="1"
                        style="transform: none; transform-origin: 17.0005px 17.0005px 0px;"
                        ><path
                      ...
                      ><g
                        opacity="1"
                        style="transform: none; transform-origin: 17px 17.0004px 0px;"
                        ><path
        ...
        <div class="pb-24 pt-16 sm:pb-32 sm:pt-24 md:pb-48 md:pt-32">
          <h1
            class="text-balance font-body text-6xl/[0.9] font-medium tracking-tight text-gray-950 sm:text-8xl/[0.8] md:text-9xl/[0.8]"
          >
            Close every deal.
          </h1>
          <p
          ...
          <div class="mt-12 flex flex-col gap-x-6 gap-y-4 sm:flex-row">
            ...
            ><Button
              ...
              variant="secondary"
              href="/pricing">See pricing</Button
            >
          </div>
        </div>
      </div>
        ...
        <div class="mx-auto max-w-2xl lg:max-w-7xl">
          ...
          <div class="pb-16">
            ...
            >
              ...
              <div
                class="grid grid-cols-2 gap-y-10 pb-6 lg:grid-cols-6 lg:gap-8"
              >
                <div class="col-span-2 flex">
                  <div class="group/item relative pt-6 lg:pb-6">
                    <svg
                      viewBox="0 0 15 15"
                      aria-hidden="true"
                      class="absolute -left-2 -top-2 hidden size-[15px] fill-black/10 group-first/item:block"
                    ...
                    ><svg
                      ...
                      ><path d="M8 0H7V7H0V8H7V15H8V8H15V7H8V0Z"></path></svg
                    >
                    <img src="/logo.svg" class="h-9 overflow-visible text-black" alt="">
                  </div>
                </div>
                <!-- Links list -->
                <!-- <div
                ...
                >
                  <div>
                    ...
                    <ul class="mt-6 space-y-4 text-sm/6">
                      <li>
                        <a
                          class="font-medium text-gray-950 data-[hover]:text-gray-950/75"
