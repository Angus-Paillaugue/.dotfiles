...
<div class="flex grow flex-col justify-center overflow-hidden rounded-xl bg-neutral-800/50">
						...
						<tbody>
							{#key submissions}
								{#each submissions as submission}
									<tr
										class="border-b border-border odd:bg-neutral-800/50 even:bg-neutral-900"
										onclick={() => {
