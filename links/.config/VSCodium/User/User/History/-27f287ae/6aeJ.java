...
public class ChargesDAO implements GenericDAO<Charges> {
  ...
  public Charges create(Charges c, int inParent) {
    try {
      ...
      String query = "INSERT INTO Charges (ordureMenageres, entretienPartiesCommunes, eclairagePartiesCommunes, eauPartieFixe, provisionSurCharge, idBienLouable) VALUES (?, ?, ?, ?, ?, ?)";
      System.out.println("Inserting values: " + Arrays.asList(
  ...
  @Override
  public Charges create(Charges t) {
    // TODO Auto-generated method stub
    throw new UnsupportedOperationException("Unimplemented method 'create'");
  }

  @Override
  public void update(Charges t) {
    // TODO Auto-generated method stub
