...
>
  ...
  <Tooltip class={cn("absolute top-2 max-lg:hidden", collapsed ? '-right-10 top-0 mb-2' : 'right-2')} content={collapsed ? m.app_home_layout_nav_sidebar_expand() : m.app_home_layout_nav_sidebar_collapse()} position='right'>
