...
>
  ...
  <Tooltip class={cn("absolute top-2 max-lg:hidden", collapsed ? '-right-10 top-0 mb-2' : 'right-2')} content={collapsed ? '' : "Collapse sidebar"} position={collapsed ? 'right' : 'bottom'}>
