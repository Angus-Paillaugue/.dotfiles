...
<aside
  class={cn(
    'shrink-0 flex-col rounded-xl border border-border bg-card p-2 pt-3 transition-transform duration-300 max-lg:fixed max-lg:bottom-2 max-lg:left-0 max-lg:top-2 max-lg:z-50 max-lg:flex max-lg:w-1/2 mr-2 max-lg:min-w-[300px] lg:w-[16rem]',
    mobileMenuOpened
