...
{#if $showNavbar}
	<div class="fixed bottom-5 left-1/2 -translate-x-1/2 z-[10001]">
		<div class="flex flex-row gap-2 p-2 relative" transition:fly={{ y:'100%', duration:600, easing:backInOut }}>
