...
>
  <div class="flex flex-row gap-2 rounded-full p-2 relative">
    ...
    <a
      href="/"
      class={cn(
        'size-12 sm:size-14 rounded-full bg-neutral-600/50 text-neutral-100 p-2',
    ...
    <button
      ...
      class={cn(
        'size-12 sm:size-14 rounded-full bg-neutral-600/50 text-neutral-100 p-2 flex flex-col items-center justify-center',
