...
{#if $showNavbar}
	<div class="flex flex-row items-center justify-center fixed bottom-5 left-1/2 -translate-x-1/2">
		<div class="flex flex-row gap-2 rounded-full p-2 relative z-[10001]" transition:fly={{ y:'100%', duration:600, easing:backInOut }}>
