...
>
  <button
    ...
    class="items-between flex w-full cursor-pointer flex-row items-center justify-between px-4 py-2 text-base font-semibold -outline-offset-2 transition-colors hover:bg-neutral-200/50 dark:bg-inherit"
  >
