...
public class VuesUtils {
	public static String getInputValue(JPanel pane, String name) {
		return getInputValueFromComponents(pane.getComponents(), name, null);
	}

	public static String getInputValue(JPanel pane, String name, String type) {
		return getInputValueFromComponents(pane.getComponents(), name, type);
	}

	private static String getInputValueFromComponents(Component[] components, String name, String type) {
		for (Component component : components) {
			if (component instanceof JTextField && name.equals(component.getName())) {
				...
				String value = getInputValueFromComponents(((JPanel) component).getComponents(), name, type);
				if (value != null) {
					return value;
				}
			}
