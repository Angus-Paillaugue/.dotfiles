...
public class VuesUtils {
  ...
  private static String getInputValueFromComponents(
      Component[] components, String name, String type) {
    for (Component component : components) {
      if (component instanceof JTextField && name.equals(component.getName())) {
        ...
        String value =
            getInputValueFromComponents(((JPanel) component).getComponents(), name, type);
        if (value != null) {
          return value;
        }
      }
