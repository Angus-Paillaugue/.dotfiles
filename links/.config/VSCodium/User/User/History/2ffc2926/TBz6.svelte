      ...
      <Sheet.Content class="w-full max-w-2xl">
        ...
        >
          ...
          <div class="flex flex-col">
            ...
            />
            <p class="text-muted-foreground text-sm">(Optional): Used for uptime monitoring.</p>
          </div>
          ...
          <div class="flex flex-row items-center gap-4">
            <Checkbox name="monitored" id="monitored" bind:checked={editServerNewServer.monitored} />
    ...
    <Drawer.Root bind:open={editServerModalOpen}>
      <Drawer.Content>
        ...
        >
          ...
          <div class="grid gap-8 px-4 mb-4">
            <div class="flex flex-col gap-2">
              <Label for="deleteServerNameInput">Name</Label>
              <Input
                id="deleteServerNameInput"
...
{#if hasPermission(user?.role, PERMI)}
        ...
        <div class="flex flex-row items-center gap-2">
          <Tooltip.Provider>
            <Tooltip.Root>
              <Tooltip.Trigger>
                <div
                  class="border-border flex flex-row items-center gap-1 rounded border p-1 font-mono"
                >
