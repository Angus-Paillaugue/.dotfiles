    ...
    if (target.getName().equals("saveButton")) {
      ...
      try {
        ...
        if (b.isLocation()) {
          ...
          Logger.log(b.getColocation());
          Logger.log(b.getColocation().getColocataires());
          Logger.log(b.getColocation().getColocataires().size());

          if (b.getColocation() != null && (b.getColocation().getColocataires() != null && b.getColocation().getColocataires().size() == 0)) {
