      ...
      try {
        ...
        if (b.isLocation()) {
          ...
          Location location = new Location(
              ...
              adr,
              VuesUtils.toFloat(VuesUtils.getInputValue(vue.panel, "caution")));
          if (b.getColocation() == null
              || (b.getColocation() != null && b.getColocation().getColocataires().size() == 0)) {
            // Si il n'y a pas encore de colocataire
            b.addColocation(new Colocation());
            b.setColocation(colocationDAO.addColoc(b, location, locataire)); // Ajout de la colocation dans la base de donnée
          } else {
            // Il y a deja des colocataire
            b.setColocation(colocationDAO.addColoc(b, location, locataire));
          }
          new MesAppartements().setVisible(true);
