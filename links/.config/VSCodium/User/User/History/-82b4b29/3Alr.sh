...
compressionRate=$(echo "scale=2; ($originalDirSize - $(du -s -h "$inputPath" | cut -f1)) / $originalSize * 100" | bc)
echo -e " $GREEN✓$NC Reduced the directory size : $originalDirSizeHR → $finalDirSize (-$compressionRate%)"
