...
<div class="grid grid-cols-2 gap-4 items-end justify-between mt-auto py-4">
  {#if previousPage}
    <a href={previousPage.url} class="p-4 rounded-md border border-neutral-300 dark:border-neutral-800 hover:gap-4 flex flex-row gap-2 items-center justify-start">
