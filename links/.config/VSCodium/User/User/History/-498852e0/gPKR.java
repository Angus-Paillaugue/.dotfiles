...
public class AddRentalVue extends JFrame {
  ...
  public AddRentalVue() {
    ...
    addLabelAndComboBox(formPanel, gbc, "Type de bâtiment", Arrays.stream(TypeDeBatiment.values()).map(Enum::), 1);
    ...
    addLabelAndCustomField(rentPanel, gbc, "Charges", new TextField(null, null, "euro-16x16-body.png").build(), 1);
    ...
    addLabelAndComboBox(rentPanel, gbc, "Mode de payment", ModeDePaiment.getNames(), 5);
    addLabelAndCustomField(
        rentPanel, gbc, "Total TTC", new TextField(null, null, "euro-16x16-body.png").build(), 6);
