...
public class AddRentalVue extends JFrame {
  ...
  public AddRentalVue() {
    ...
    addLabelAndCustomField(formPanel, gbc, "Montant taxe foncière",
        new MoneyTextField(null, null).build(), 11);
    ...
    addLabelAndCustomField(
        ...
        new MoneyTextField(null, null).build(), 0);
    addLabelAndCustomField(rentPanel, gbc, "Charges", new MoneyTextField(null, null).build(), 1);
    ...
    addLabelAndCustomField(
        ...
        new MoneyTextField(null, null).build(), 4);
    addLabelAndComboBox(rentPanel, gbc, "Mode de payment", ModeDePaiment.getValues(), 5);
    addLabelAndCustomField(
        rentPanel, gbc, "Total TTC", new MoneyTextField(null, null).build(), 6);
