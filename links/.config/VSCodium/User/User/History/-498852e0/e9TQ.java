...
public class AddRentalVue extends JFrame {
  ...
  public AddRentalVue() {
    ...
    addLabelAndComboBox(formPanel, gbc, "Type de bâtiment", TypeDeBatiment.getValues(), 1);
    ...
    addLabelAndCustomField(formPanel, gbc, "Montant taxe foncière",
        new TextField(null, "", "euro-16x16-body.png").build(), 11);
    ...
    addLabelAndCustomField(
        rentPanel, gbc, "Montant hors charges",
        new TextField(null, "", "euro-16x16-body.png").build(), 0);
    addLabelAndCustomField(rentPanel, gbc, "Charges", new TextField(null, "", "euro-16x16-body.png").build(), 1);
    addLabelAndCustomField(rentPanel, gbc, "Date payment", new DateField("03/05/2024").build(), 2);
    addLabelAndCustomField(rentPanel, gbc, "Date prochaine révision", new DateField("3/05/2026").build(), 3);
    addLabelAndCustomField(
        rentPanel, gbc, "Montant dépôt de garantie",
        new TextField(null, "", "euro-16x16-body.png").build(), 4);
    addLabelAndComboBox(rentPanel, gbc, "Mode de payment", ModeDePaiment.getValues(), 5);
    addLabelAndCustomField(
        rentPanel, gbc, "Total TTC", new TextField(null, "", "euro-16x16-body.png").build(), 6);
