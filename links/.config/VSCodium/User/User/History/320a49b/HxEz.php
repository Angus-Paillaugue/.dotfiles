...
<body>
  ...
  <div class="max-w-screen-sm mx-auto w-full p-4">
    <?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      $name = $_COOKIE['name'];
      $visites = intval($_COOKIE['visites']) + 1 ?? 1;
      ...
      if (isset($name)) {
        ...
        echo '
            <form action="' .
          $loc .
          '" method="post" class="p-4 border mb-8 gap-6 flex flex-col rounded-xl w-full bg-white">
      ...
      echo "<p>Vous avez visité cette page <strong>$visites</strong> fois</p>";
    } ?>
  </div>
