...
<div class="max-w-screen-md mx-auto p-8 flex flex-col gap-8">
  {#each releases.reverse() as release}
    <a href="https://github.com/Angus-Paillaugue/SvelteShine/releases/tag/{release.version}" target="_blank" class="border border-main dark:border-main-dark rounded relative group">
      <div class="p-6">
