...
public class BienLouableDAO implements GenericDAO<BienLouable> {
  ...
  public int create(BienLouable b) {
    try {
      ...
      query = "INSERT INTO Logement (typePorte, datePermisConstruction, dateConstruction, constatAmiante, constatPlomb, constatElectricite, constatEnergetique, emissionGazEffetDeSerre, referenceLogement, meuble, equipementAccesTechnologie) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
