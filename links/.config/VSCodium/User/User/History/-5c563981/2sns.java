...
public class MesDocuments extends JFrame {
  ...
  public MesDocuments() {
    ...
    contractDeLocationButton.addActionListener(
        e -> {
          GenererContractDeLocation genererContractDeLocation = new GenererContractDeLocation(Constants.proprietaire);
          genererContractDeLocation.setVisible(true);
        });
    gbc.gridx = 0;
    gbc.gridy = 0;
