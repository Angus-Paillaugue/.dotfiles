...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if(!isset($nom) || !isset($prenom) || !isset($licence) || !isset($date_de_naissance) || !isset($taille) || !isset($poids)) {
    ErrorHandling::setError('Veuillez remplir tous les champs');
    exit;
  }

  $joueur = new CreerUnJoueur($nom, $prenom, $licence, $date_de_naissance, $taille, $poids);
