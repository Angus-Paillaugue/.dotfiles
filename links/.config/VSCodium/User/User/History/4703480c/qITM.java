...
public class GenererQuittanceDeLoyer extends JFrame {
  ...
  public GenererQuittanceDeLoyer(Proprietaire proprietaire) {
    ...
    radioPanelLocation =
        new JPanel(
            new GridLayout(1, nbLocation, 10, 10)); // Grid layout with three columns and spacing
    ...
    radioPanelColocation =
        new JPanel(
            new GridLayout(1, nbColocation, 10, 10)); // Grid layout with three columns and spacing
