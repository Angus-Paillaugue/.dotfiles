...
require_once __DIR__ . '/../controleur/CreerUnUtilisateur.php';
...
<div class="max-w-xl mx-auto w-full p-4">
  <form action="<?php echo htmlspecialchars(
    $_SERVER['PHP_SELF']
  ); ?>" method="post" class="p-4 space-y-4 flex flex-col rounded-xl w-full bg-neutral-200 dark:bg-neutral-800">
