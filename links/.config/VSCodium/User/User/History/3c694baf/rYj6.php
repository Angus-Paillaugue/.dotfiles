...
require_once dirname(__DIR__) .'app/lib/components.php';
require_once dirname(__DIR__) .'app/lib/error.php';
require_once dirname(__DIR__) .'app/controleur/CreerUnUtilisateur.php';
require_once dirname(__DIR__) .'app/controleur/UtilisateurExiste.php';
