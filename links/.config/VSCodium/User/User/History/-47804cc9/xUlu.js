...
const DATABASE_USERNAME = 'zalando';
const DATABASE_PASSWORD = 'psql "postgres://default:FvitsP0lCy8D@ep-autumn-surf-a2nwwzaf.eu-central-1.aws.neon.tech:5432/verceldb?sslmode=require"$';
const DATABASE_NAME = 'zalando';
// Home assistant ip address (do not use domain name because of TrueNas not being able to resolve it)
