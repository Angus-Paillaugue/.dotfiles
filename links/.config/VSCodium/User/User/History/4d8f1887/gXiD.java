...
public class Proprietaire {
  ...
  public void addLogement(Logement logement, Batiment batiment) {
    System.out.println("Proprietaire.addLogement()");
    System.out.println("Index:"+ this.batiment.indexOf(batiment));
    System.out.println("Batiment:"+ batiment);
    this.batiment.get(this.batiment.indexOf(batiment)).addBienLouable(logement);
  }
