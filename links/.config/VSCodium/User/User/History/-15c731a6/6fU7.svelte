...
<div class="mt-auto grid grid-cols-2 items-end justify-between gap-4 py-4">
  {#if previousPage}
    <a
      ...
      class="flex flex-row items-center justify-start gap-2 rounded-md border border-neutral-300/50 p-2 md:p-4 transition-all hover:gap-4 dark:border-neutral-700/50 h-full"
    >
      <Icon
  ...
  {#if nextPage}
    <a
      href={nextPage.url}
      class="col-start-2 flex flex-row items-center justify-end gap-2 rounded-md border border-neutral-300/50 p-2 md:p-4 h-full transition-all hover:gap-4 dark:border-neutral-700/50"
    >
