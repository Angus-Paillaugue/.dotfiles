...
<div class="commands mb-4 w-full">
  ...
  <div class="overflow-hidden rounded-md border border-main dark:border-main-dark">
    ...
    <div class="commands relative">
      ...
      <button
        tabindex="0"
        class="absolute right-2 top-1/2 flex aspect-square h-[2.5rem] -translate-y-1/2 items-center justify-center rounded-full bg-neutral-950 p-1 text-white transition hocus:scale-105 focus:outline-primary-200 active:scale-90"
        onclick={(e) => {
