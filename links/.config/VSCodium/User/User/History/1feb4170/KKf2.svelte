...
>
  ...
  <div class="flex flex-row item-start gap-2">
    {#if svgs[t.type].component}
      <svgs[t.type].component class={cn('size-4 shrink-0', svgs[t.type].color)} />
    {/if}

    <div class="flex flex-col gap-1 grow">
      <!-- Title -->
      <p class="block text-base font-medium leading-5 text-white-400">{t.title}</p>
      <!-- Message -->
