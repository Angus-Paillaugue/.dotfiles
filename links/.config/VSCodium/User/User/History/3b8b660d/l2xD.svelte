...
>
  ...
  >
    <div class="flex flex-col gap-8">
      <p class="m-0 text-text dark:text-text-heading-dark">{project.name}, {catchphrase}</p>
      <p class="m-0 mt-auto text-text dark:text-text-heading-dark">
        Made with <svg
    ...
    <div class="grid grid-cols-2">
      <ul>
        <li class="m-0 mb-1 list-none text-base font-semibold">
          <a
            href="#pricing"
            class="text-text-heading-dark transition-colors hover:text-text-body dark:text-text-heading dark:hover:text-text-body-dark"
            >Pricing</a
          >
        </li>
        <li class="m-0 mb-1 list-none text-base font-semibold">
