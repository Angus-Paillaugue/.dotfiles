	...
	<div class="mx-auto w-full grow p-4 md:max-w-[888px] md:p-6 lg:max-w-screen-xl">
		...
		>
			...
			<div class="md:text-left">
				...
				<a href="/" class="flex flex-row items-center gap-2 rounded-xl bg-neutral-700 px-3 py-1 text-base font-medium transition-colors hover:bg-neutral-700/50">Go home</a>
			</div>
		</div>
	</div>
{:else}
