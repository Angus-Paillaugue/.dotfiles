<script>
	...
	console.log(m.error_page_page_description({ status: $page.status, message: $page.error.message}))
</script>
...
<svelte:head>
	...
	<meta name="description" content={m.error_page_page_description({ status: $page.status, message: $page.error.message })} />
	<meta
