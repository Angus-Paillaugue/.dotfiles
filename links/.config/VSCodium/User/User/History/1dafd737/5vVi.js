export class TextReveal {
	...
	startAnimation() {
		...
		// Show random characters on all text segments during the delay phase
	...
	#animate(segments) {
		...
		const intervalTime = Math.min(this.#speed / totalSteps, 10); // Ensure minimum interval of 10ms
		this.#interval = setInterval(() => {
			// Reveal characters sequentially across all segments
