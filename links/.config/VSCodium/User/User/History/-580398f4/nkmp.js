...
test('should sort exercises by title', async ({ page }) => {
  ...
  await titleHeader.click();
  const firstExerciseTitleDesc = await page.locator('tbody tr:first-child td:nth-child(3)').innerText();
  const secondExerciseTitleDesc = await page.locator('tbody tr:nth-child(2) td:nth-child(3)').innerText();
