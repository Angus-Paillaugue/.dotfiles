...
public class AjouterLocataire extends JFrame {
  ...
  public AjouterLocataire() {
    ...
    addField(panel, "autreRemuneration", "Autre rémunération:", new JTextField("631.00"));
    addField(panel, "adresse", "Adresse:", new JTextField("126 rue de l'Université, 75355 Paris"));
