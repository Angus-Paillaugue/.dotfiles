...
public class AjouterLocataire extends JFrame {
  ...
  public AjouterLocataire() {
    ...
    addField(panel, numero, "Numéro:", new JTextField("66"));
    addField(panel, rue, "Rue:", new JTextField("rue de l'Université"));
    addField(panel, complement, "Complément:", new JTextField("Bat7"));
    addField(panel, cp, "Code postal:", new JTextField("75355"));
    addField(panel, ville, "Ville:", new JTextField("Paris"));
    addField(panel, email, "E-mail:", new JTextField("jean.lasalle@assemblee.gouv"));
    addField(panel, telephone, "Téléphone:", new JTextField("0606060606"));
    ...
    saveButton.addActionListener(c);
		...
		annulerButton.setName("annulerButton");
