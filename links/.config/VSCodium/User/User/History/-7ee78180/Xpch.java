...
public class AjouterLocataire extends JFrame {
  ...
  public AjouterLocataire() {
    ...
    // Form fields
    addField(panel, "Nom:", new JTextField());
    addField(panel, "Prénom:", new JTextField());
    addField(panel, "Date de naissance:", new JTextField());
    addField(panel, "Lieu de naissance:", new JTextField());
