...
public class AjouterLogement extends JFrame {
  ...
  public AjouterLogement() {
    ...
    JTextField superficieField = new IntegerTextField("surfaceHabitable").build();
    gbc.gridx = 1;
    formPanel.add(superficieField, gbc);
    JLabel superficieFieldUnitLabel = new JLabel("m²");
    gbc.gridx = 2;
    formPanel.add(superficieFieldUnitLabel, gbc);
    gbc.gridx = 0;
    ...
    gbc.gridwidth = 1;
    gbc.weightx = 1.0;
    formPanel.add(new JLabel("Surface totale"), gbc);
    JTextField surfaceTotaleField = new IntegerTextField("surfaceTotale").build();
    gbc.gridx = 1;
    formPanel.add(surfaceTotaleField, gbc);
    JLabel surfaceTotaleFieldUnitLabel = new JLabel("m²");
    gbc.gridx = 2;
    formPanel.add(surfaceTotaleFieldUnitLabel, gbc);
    gbc.gridx = 0;

    addIntegerTextFieldAndLabel(formPanel, gbc, "nbPieces", "Nombre de pièces", 7);
    ...
    addLabelAndTextField(
        ...
        new MoneyTextField(null, null, "indexEau").build(),
        5);
    addLabelAndCustomField(
        chargesPanel,
        gbc,
        "Prix eau (m3)",
        new MoneyTextField(null, null, "prixEauMetreCube").build(),
        6);
    ...
    addLabelAndTextField(assurancePanel, assuranceGbc, "typeAssurance", "Type assurance", 0);
    addLabelAndTextField(assurancePanel, assuranceGbc, "nomAssureur", "Nom assureur", 1);
    addLabelAndCustomField(
      assurancePanel,
      assuranceGbc,
      "Numéro assurance",
      new IntegerTextField("numeroContractAssurance").build(),
      2);
    addLabelAndCustomField(
        assurancePanel,
        assuranceGbc,
        "Prime assurance",
        new MoneyTextField(null, null, "primeAssurance").build(),
        3);
  ...
  private void addIntegerTextFieldAndLabel(JPanel panel, GridBagConstraints gbc, String name, String labelText,
      int gridy) {
    gbc.gridx = 0;
    gbc.gridy = gridy;
    gbc.gridwidth = 1;
    ...
    JFormattedTextField textField = new IntegerTextField(name).build();
    gbc.gridx = 1;
    gbc.gridwidth = 2;
    panel.add(textField, gbc);
  }
  ...
  private void addLabelAndCustomField(
      JPanel panel, GridBagConstraints gbc, String labelText, JComponent customField, int gridy) {
    gbc.gridx = 0;
    gbc.gridy = gridy;
    gbc.gridwidth = 1;
    panel.add(new JLabel(labelText), gbc);
