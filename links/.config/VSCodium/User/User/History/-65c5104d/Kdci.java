...
public class AjouterLogement extends JFrame {
  ...
  public AjouterLogement() {
    ...
    addLabelAndCustomField(
        ...
        0);
    // addLabelAndCustomField(
    //    rentPanel, gbc, "Charges", new MoneyTextField(null, null, "montantCharges").build(), 2);
    addLabelAndCustomField(
        rentPanel,
        gbc,
    ...
    new MoneyTextField(null, null, "montantDepotGarantie").build(),
    5);*/
    addLabelAndComboBox(
    ...
    TitledBorder assuranceBorder = BorderFactory.createTitledBorder("Charges");
    ...
    addLabelAndCustomField(
        ...
        assuranceGbc,
        "Assurance :",
        new MoneyTextField(null, null, "assurance").build(),
        0);
