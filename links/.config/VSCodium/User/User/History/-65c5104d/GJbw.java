...
public class AjouterLogement extends JFrame {
  ...
  public AjouterLogement() {
    ...
    addLabelAndTextField(assuranceGbc, assuranceGbc, "typeAssurance", "Type assurance", 0);
    addLabelAndTextField(assuranceGbc, assuranceGbc, "nomAssureur", "Nom assureur", 1);
    addLabelAndCustomField(
      assurancePanel,
      assuranceGbc,
      "Type assurance :",
