...
public class AjouterLogement extends JFrame {
  ...
  public AjouterLogement() {
    ...
    addLabelAndCustomField(formPanel, gbc, "nbPieces", "Nombre de pièces", 7);
    ...
    addLabelAndTextField(chargesPanel, gbc, "prixEauMetreCube", "Prix eau (m3)", 6);
  ...
  private void addIntegerTextFieldAndLabel(JPanel panel, GridBagConstraints gbc, String name, String labelText, int gridy) {
    gbc.gridx = 0;
    gbc.gridy = gridy;
    gbc.gridwidth = 1;
    panel.add(new JLabel(labelText), gbc);
