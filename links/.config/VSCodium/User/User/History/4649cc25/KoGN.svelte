...
<div class="w-full">
  <div class="relative h-fit w-full">
    <ul
      class="flex flex-row overflow-x-auto no-scrollbar flex-nowrap gap-2 border-b-2 border-neutral-300/50 dark:border-neutral-800 mb-2 relative"
    >
  ...
  <div class="border border-neutral-300/50 dark:border-neutral-800 rounded-md overflow-hidden">
    <div class="flex flex-row gap-2 px-4 py-2">
      <div class="size-3 bg-neutral-300 dark:bg-neutral-800 rounded-full"></div>
      <div class="size-3 bg-neutral-300 dark:bg-neutral-800 rounded-full"></div>
      <div class="size-3 bg-neutral-300 dark:bg-neutral-800 rounded-full"></div>
    </div>
    <div class="text-neutral-300 relative commands">
