...
export const load = async ({ params, locals }) => {
	...
	const correctUrl = urlHealer.identifier.join(exercise.slug, exercise.id);
	if (urlSlug !== correctUrl)
		redirect(307, `/app/exercises/${urlHealer.identifier.join(exercise.slug, exercise.id)}`);
