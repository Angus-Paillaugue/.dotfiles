              ...
              <tbody>
                {#each tableLogs as log, i}
                  ...
                  <tr in:fade={{ duration:500, delay: 1000 * i }}>
                    <td class="py-2 px-4 text-sm text-thin text-muted-foreground"><p class="line-clamp-1">{log.id}</p></td>
                    <td class="py-2 px-4 text-sm text-thin text-muted-foreground">
                      <LogLevel level={log.status} class="text-xs py-0.2 px-1" />
                    </td>
                    <td class="py-2 px-4 text-sm text-thin text-muted-foreground"><p class="line-clamp-1">{log.timestamp}</p></td>
                    <td class="py-2 px-4 text-sm text-thin text-muted-foreground">
                      <p class="line-clamp-1">{log.message}</p>
                    </td>
                  </tr>
                {/each}
              </tbody>
