...
<div class="flex flex-col">
  ...
  <div class="mt-4 grid grid-cols-1 gap-8 lg:grid-cols-3" bind:this={bentoGrid}>
    ...
    >
      <div class="grid lg:grid-cols-6 w-full p-4 relative">
        <!-- Text editor -->
              ...
              <tbody>
                {#each tableLogs as log, i}
                  ...
                  <tr in:fade={{ duration:500, delay: 1000 * i }}>
                    <td class="py-2 px-4 line-clamp-1 text-sm text-thin text-muted-foreground">{log.id}</td>
                    <td class="py-2 px-4 line-clamp-1 text-sm text-thin text-muted-foreground">
                      <LogLevel level={log.status} class="text-xs py-0.2 px-1" />
                    </td>
                    <td class="py-2 px-4 line-clamp-1 text-sm text-thin text-muted-foreground">{log.timestamp}</td>
                    <td class="py-2 px-4 line-clamp-1 text-sm text-thin text-muted-foreground">
                      {log.message}
                    </td>
                  </tr>
