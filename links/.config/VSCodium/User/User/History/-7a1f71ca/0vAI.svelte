<script lang="ts">
  import { Timer, Container, TriangleAlert, Info, OctagonAlert, Database, RefreshCcw } from 'lucide-svelte';
  ...
  <div class="mt-4 grid grid-cols-1 gap-8 lg:grid-cols-3" bind:this={bentoGrid}>
    ...
    >
      <div class="grid gap-4 lg:grid-cols-6 w-full items-center p-4 relative">
        ...
        >
          <RefreshCcw class={cn("size-8", isRegeneratingLogsTable && 'animate-rotate')} />
          Regenerate
        </Button>
        <!-- Table -->
