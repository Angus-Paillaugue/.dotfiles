...
public class GarantDAOTests {
  ...
  public void setUp() throws SQLException {
    ...
    Logement logement = new Logement(adresse, 0.0F, 0.0F "refCadastrale", true, "numeroFiscal", 100.f, 1, 100.f,
        100.f, true, 3, LocalDate.of(2022, 02, 5), LocalDate.of(2022, 02, 5), "constatAmiante",
        "constatPlomb", "constatElectricite", "constatEnergetique", "emissionGazEffetDeSerre",
        "referenceLogement", true, true);
