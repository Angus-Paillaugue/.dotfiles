...
public class GarantDAOTests {
  ...
  public void setUp() throws SQLException {
    ...
    Charges charges = new Charges(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0, LocalDate.now());
    Logement logement = new Logement(adresse, 0.0F, 0.0F, "refCadastrale", true, "numeroFiscal", 100.f, loyer, charges);
