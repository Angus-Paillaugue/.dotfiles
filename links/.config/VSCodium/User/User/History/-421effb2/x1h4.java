...
public class GarantDAOTests {
  ...
  public void setUp() throws SQLException {
    ...
    this.logement = new Logement(adresse, 0.0F, 0.0F, "refCadastrale", true, "numeroFiscal", 100.f, loyer, charges,
        LocalDate.now(), LocalDate.now(), "constatAmiante", "constatPlomb", "constatElectricite", null, null,
        "referenceLogement", true, "equipementAccesTechnologie");
  ...
  public void testSupprimerGarant() {
    ...
    this.location = garantDAO.supprimerGarant(this.personne, this.location);
    System.out.println(this.location);
  ...
  public void testSupprimerTousLesGarants() {
    ...
    locationDAO.create(location, logement);
    this.location = garantDAO.ajouterGarant(this.personne, this.location);
    this.location = garantDAO.supprimerTousLesGarants(this.location);
    assertEquals(0, this.location.getLocataires().size());
  }
}
