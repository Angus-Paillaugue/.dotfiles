		...
		<div class="absolute -top-full max-lg:-translate-x-1/2 max-lg:-mt-2 max-lg:left-1/2 lg:left-full lg:ml-2 lg:top-0 rounded-lg overflow-hidden">
			<div class="flex flex-row gap-px">
				<Tooltip
					...
					delay={100}
					class="size-8 bg-neutral-800"
					position="bottom"
				>
					<button
						aria-label="Start timer"
						class="flex flex-col items-center justify-center size-8 text-neutral-300 bg-neutral-900 lg:bg-neutral-800"
						onclick={() => {
				...
				{#if timer !== null}
					<div class="flex flex-row gap-px w-fit" transition:slide={{ axis: 'x', duration:500 }}>
						<!-- Time display -->
						<div class="flex flex-col items-center px-2 justify-center text-center text-neutral-400 h-8 bg-neutral-900 lg:bg-neutral-800">
							{formatTime(timer)}
						</div>
						<!-- Play/Pause button -->
						<button
							class="flex size-8 bg-neutral-900 text-neutral-300 lg:bg-neutral-800 flex-col items-center justify-center"
