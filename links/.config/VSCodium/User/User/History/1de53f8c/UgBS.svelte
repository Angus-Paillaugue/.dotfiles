...
>
  ...
  <div class="flex flex-row items-center text-sm justify-center py-4 gap-2 rounded-2xl text-text-body w-full max-w-md" style="background-color: #{CARDS_COLORS[0]};">
    <p>No account yet ?</p>
