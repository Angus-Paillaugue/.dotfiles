<script lang="ts">
  ...
  const baseClasses = 'rounded transition-colors flex w-full flex-col w-fit items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed px-3 py-1 text-base font-sans font-medium';
