...
import { formatDate, cn, formatBytes, stripMD, urlHealer } from './utils';
...
test('Sanitize path', () => {
  const sanitizedUrl = urlHealer.sanitize('slug%23-text-23');

  expect(sanitizedUrl).toEqual('https://example.com');
});
