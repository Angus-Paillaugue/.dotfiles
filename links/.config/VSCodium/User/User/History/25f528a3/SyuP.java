...
import controleurs.ControleurAjouterGarant;
import modele.Location;
import modele.Personne;
import modele.SituationFamiliale;
import modele.TypeDeContratDeTravail;

public class AjouterGarant extends JFrame {
  private static final long serialVersionUID = 1L;
  public Location location;
  public Personne locataire;
  public JPanel panel;

  public AjouterGarant(Personne p, Location loc, Boolean isColocation) {
    this.location = loc;
    this.locataire = p;
    String titre = "Ajouter un garant au locataire" + " " + loc.getLocataires().get(0);
    setTitle(titre);
    setSize(800, 800);
    ...
    addField(panel, "id", "Identifiant:", new JTextField());
    addField(
        panel,
        "autreRemuneration",
        "Autre rémunération:",
        new MoneyTextField(null, null, "autreRemuneration").build());
    addField(panel, "numero", "Numero:", new JTextField());
    ...
    ControleurAjouterGarant c = new ControleurAjouterGarant(this, isColocation);
