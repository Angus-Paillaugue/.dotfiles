...
<div class="w-full h-[250px] relative overflow-hidden">
	...
	<div class="max-w-screen-xl py-10 px-4 mx-auto h-full relative flex flex-col items-center justify-between">
		<Tooltip class="absolute top-10 left-4" name="Go to paths list">
			<button class="rounded bg-neutral-300/10 text-neutral-300 p-1">
