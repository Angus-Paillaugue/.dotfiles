...
<div class="w-full h-[200px] relative overflow-hidden">
	<div class="absolute inset-0">
		...
		<div class="absolute inset-0 opacity-10 bg-[linear-gradient(to_top,#FFF_0%,transparent_5%),linear-gradient(to_left,#FFF_0%,transparent_5%)] [mask-image:linear-gradient(#FFFFFF,rgba(0,0,0,0))]" style="background-size:20px 20px"></div>
	</div>
