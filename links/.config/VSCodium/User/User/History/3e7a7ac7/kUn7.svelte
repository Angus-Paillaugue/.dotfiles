...
<div class="w-full h-[200px] relative overflow-hidden">
	<div class="absolute inset-0">
		<div class="absolute left-1/2 top-1/2 h-full w-full max-w-screen-md -translate-x-1/2 -translate-y-3/4 rounded-full opacity-70 blur-[60px] bg-yellow-500/10"></div>
