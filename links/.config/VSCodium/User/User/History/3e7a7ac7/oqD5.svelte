...
<div class="w-full h-[200px] relative overflow-hidden">
	<div class="absolute inset-0">
		<div class="absolute left-1/2 top-1/2 h-[300px] w-[1020px] -translate-x-1/2 -translate-y-3/4 rounded-[100%] opacity-70 blur-[60px] bg-yellow-500/10"></div>
		<div class="absolute inset-0 opacity-10 bg-[linear-gradient(to_top,#FFF_0%,transparent_5%),linear-gradient(to_left,#FFF_0%,transparent_5%)] [mask-image:linear-gradient(50%_50%_at_center_center,transparent,white)]" style="background-size:20px 20px"></div>
	</div>
