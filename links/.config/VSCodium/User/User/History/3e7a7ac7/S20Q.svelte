<script>
	import { TestTubeDiagonal, CircleCheckBig, Circle } from 'lucide-svelte';
...
<div class="w-full h-[200px] relative overflow-hidden">
	<div class="absolute inset-0">
		<div class="absolute left-1/2 top-1/2 h-[300px] w-[1020px] -translate-x-1/2 -translate-y-3/4 rounded-[100%] opacity-70 blur-[60px] bg-[#36270B]"></div>
	...
	<div class="max-w-screen-xl py-10 mx-auto h-full relative flex flex-col items-center justify-between">
		...
		<button class="bg-neutral-100 px-4 py-1 rounded-full text-neutral-900 flex flex-row gap-2 items-center">
			Start
		</button>
	</div>
</div>
