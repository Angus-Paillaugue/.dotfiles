...
public class Constants {
	...
	public static Personne locataire1 = new Personne("Jean", "Dupont", 1, LocalDate.of(2004, 10, 3), "Lieu naissance",
			SituationFamiliale.CELIBATAIRE, "Profession", "Employeur", TypeDeContratDeTravail.CDI, 1500.0F, 0.0F, "email", "telephone", adresseLogement1);
	public static Personne garant1 = new Personne("Pierre", "Durand", 2, LocalDate.of(1992, 10, 3), "Lieu naissance",
			SituationFamiliale.CELIBATAIRE, "Profession", "Employeur", TypeDeContratDeTravail.CDI, 1500.0F, 0.0F, "email",
			"telephone", adresseLogement1);
	public static Personne garant2 = new Personne("Paul", "Martin", 3, LocalDate.of(1992, 10, 3), "Lieu naissance",
			SituationFamiliale.CELIBATAIRE, "Profession", "Employeur", TypeDeContratDeTravail.CDI, 1500.0F, 0.0F, "email",
			"telephone", adresseLogement1);
	public static ArrayList<Personne> listGarants1 = new ArrayList<Personne>();
	public static Location location1 = new Location(
			locataire1, listGarants1, LocalDate.of(2018, 1, 1), adresseLogement1, 1000.0F);
	public static Logement logement1 = new Logement(adresseLogement1, "12345678AB", true, 1250.0F, "123456789012", 950.0F,
			location1, loyer1, null, "Droite", LocalDate.of(2018, 1, 1), LocalDate.of(2019, 2, 2), "/chemin/constatAmiante.pdf", "/chemin/constatPlomb.pdf", "/chemin/constatElec.pdf", noteEnergetique.A, noteEnergetique.C, "Ref logement", true, "Equipement fibre...");
