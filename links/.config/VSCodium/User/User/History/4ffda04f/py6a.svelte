...
<style>
  /* Hide the folder-close icon and show the folder-open icon when the details element is open */
  ...
  /* Show the folder-close icon and hide the folder-open icon when the details element is closed */
