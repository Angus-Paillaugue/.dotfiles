...
public class Loyer {
  ...
  public boolean equals(Object obj) {
    ...
    System.out.println(Objects.equals(dateDerniereRevision, other.dateDerniereRevision));
    System.out.println(Objects.equals(dateProchaineRevision, other.dateProchaineRevision));
    System.out.println(Objects.equals(id, other.id));
    System.out.println(Objects.equals(idBienLouable, other.idBienLouable));
    System.out.println(Objects.equals(jourVersement, other.jourVersement));
    System.out.println(Objects.equals(modeDePaiment, other.modeDePaiment));
    System.out.println(Float.floatToIntBits(montantHorsCharge) == Float.floatToIntBits(other.montantHorsCharge));
    System.out.println(
        Float.floatToIntBits(provisionSurChargesMensuel) == Float.floatToIntBits(other.provisionSurChargesMensuel));
