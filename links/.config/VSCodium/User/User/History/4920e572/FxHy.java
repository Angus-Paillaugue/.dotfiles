...
public class Loyer {
  ...
  public void setDateVersement(int jourVersement) {
	...
	public String toString() {
		return "Loyer [dateDerniereRevision=" + dateDerniereRevision + ", dateProchaineRevision=" + dateProchaineRevision
				+ ", jourVersement=" + jourVersement + ", modeDePaiment=" + modeDePaiment + ", montantHorsCharge="
				+ montantHorsCharge + "]";
	}
}
