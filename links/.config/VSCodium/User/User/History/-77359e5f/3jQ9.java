...
public class MoneyTextField extends JTextField {
	...
	/**
	 * Constructs a MoneyTextField component with a label, a formatted text field
	 * for numeric input,
	 * and an icon.
	 *
	...
	public MoneyTextField(String label, Number value, String name) {
		...
		NumberFormat format = NumberFormat.getNumberInstance(Constants.LOCALE);
		format.setMaximumFractionDigits(2); // Allow for two decimal points
		format.setMinimumFractionDigits(2); // Ensure two decimal points are always shown
