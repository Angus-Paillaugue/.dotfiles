...
<section class="max-w-screen-xl mx-auto p-4" id="about">
	...
	<div class="flex flex-col lg:flex-row gap-10">
		...
		<!-- Portrait -->
		<div class="max-w-[300px] w-full aspect-square grow bg-no-repeat bg-cover bg-center" style="border-radius: 28% 72% 22% 78% / 39% 23% 77% 61%; animation: morph 8s ease-in-out infinite; background-image: url('/myFace.jpg');"></div>
	</div>
