...
<section class="max-w-screen-xl mx-auto p-4" id="about">
	...
	<!-- About paragraph, CV and portrait -->
	<div class="flex flex-col lg:flex-row gap-10">
		...
		<!-- Portrait -->
		<div class="max-w-[300px] w-full aspect-square grow bg-no-repeat bg-cover bg-center" style="border-radius: 28% 72% 22% 78% / 39% 23% 77% 61%; animation: morph 8s ease-in-out infinite; background-image: url('/myFace.jpg');" use:reveal></div>
	</div>
...
<style>
	...
	@keyframes -global-morph {
		0%, 100% {
			border-radius: 40% 50% 70% 50%/50% 40% 50% 30%;
		}
		50% {
			border-radius: 30% 70% 10% 30%/70% 30% 70% 30%;
		}
	}
</style>
