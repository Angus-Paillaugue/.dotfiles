...
<section class="max-w-screen-xl mx-auto p-4" id="about">
	...
	<div class="flex flex-row">
		...
		<div class="w-full aspect-square bg-no-repeat bg-cover bg-center border-2 border-primary shadow-2xl" style="border-radius: 28% 72% 22% 78% / 39% 23% 77% 61%; transform: rotate(0deg); animation: morph 8s ease-in-out infinite; background-image: url('/myFace.jpg');"></div>
	</div>
