<script>
  ...
  const baseClasses =
    'px-4 py-2 text-lg block rounded active:scale-90 transition-all font-medium flex flex-row items-center justify-center';
  ...
  const typeClasses = {
    ...
    square:
      'size-12 rounded p-0',
    circle:
      'p-2 size-12 rounded-full text-primary-950 bg-primary-300 dark:bg-primary-400 dark:text-primary-950 hocus:bg-primary-400 dark:hocus:bg-primary-500',
    ghost:
  ...
  const isStyled = !type.includes('noStyle');
