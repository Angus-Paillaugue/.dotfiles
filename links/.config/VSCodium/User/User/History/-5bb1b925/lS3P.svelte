<script>
  ...
  const typeClasses = {
    ...
    circle:
      'p-2 aspect-square rounded-full text-primary-950 bg-primary-300 dark:bg-primary-400 dark:text-primary-950 hocus:bg-primary-400 dark:hocus:bg-primary-500',
    ghost:
