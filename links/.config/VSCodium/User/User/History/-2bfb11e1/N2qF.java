...
public class Personne {
	...
	public Personne(String nom, String prenom, int idLocataire, Date dateNaissance, String lieuNaissance,
			SituationFamiliale situationFamiliale, String profession, String employeur,
			TypeDeContratDeTravail typeDeContratDeTravail, float remunerationMensuelleNette, float autresRevenus,
