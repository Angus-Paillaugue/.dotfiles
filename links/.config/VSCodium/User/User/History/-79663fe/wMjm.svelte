...
<Textarea class="resize-none min-h-full transition-all text-base p-3 overflow-y-auto" rows={1} {placeholder} onkeyup={onKeyDown} bind:ref={textarea} bind:value {...restProps} />
