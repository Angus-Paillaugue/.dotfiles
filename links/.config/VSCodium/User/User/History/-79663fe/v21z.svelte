<script lang="ts">
  ...
  let textarea: HTMLInputElement | null = $state(null);
...
<Textarea class="resize-none min-h-full transition-all text-base p-3 overflow-y-auto" rows={1} {placeholder} onkeyup={onKeyDown} bind:this={textarea} bind:value {...restProps} />
