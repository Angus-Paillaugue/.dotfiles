...
>
  ...
  <Definition.Prop type="string" path="description">A description of the page (displayed a the ).</Definition.Prop>
  <Definition.Prop type="string" path="lastModified">The date at witch the file has last been modified.</Definition.Prop>
</Definition>
