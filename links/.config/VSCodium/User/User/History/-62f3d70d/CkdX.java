...
public class ReviserLoyer extends JFrame {
  ...
  public ReviserLoyer(Logement logement) {
    ...
    mainPanel.add(oldIrlInput, BorderLayout.CENTER);
    JPanel newIrlInput = new TextField("Ancien IRL", "", "", "newIewValue").build();
    mainPanel.add(newIrlInput, BorderLayout.CENTER);
