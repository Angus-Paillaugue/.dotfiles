    ...
    <tbody>
      {#each definition.content as prop}
        <tr class="border-b border-neutral-300/50 dark:border-neutral-700/50">
          <td class="p-2">
            <p
              class="font-bold px-1 rounded bg-primary-700/50 border border-primary-600 text-black dark:text-white w-fit text-sm m-0"
            >
              {prop.name}
            </p>
          </td>
          <td class="p-2">
            <p
              class="font-bold px-1 rounded bg-neutral-600 dark:bg-neutral-800 text-black dark:text-white w-fit text-sm m-0"
            >
              {prop?.default ?? ' - '}
            </p>
          </td>
