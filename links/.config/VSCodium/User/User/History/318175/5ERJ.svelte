...
<div class="rounded-md border border-neutral-300/50 dark:border-neutral-800">
  <div
  ...
  <table class="w-full table-auto">
    <thead>
      <tr
        class="border-b border-neutral-300/50 dark:border-neutral-800 whitespace-nowrap text-base font-medium"
      >
    ...
    <tbody>
      {#each definition.content as prop}
        <tr class="border-b border-neutral-300/50 dark:border-neutral-800">
          <td class="p-2">
            <p
          ...
          <td class="p-2">
            <p
              class="font-bold px-1 rounded bg-neutral-600 dark:bg-neutral-800 text-white w-fit text-sm"
            >
              {prop?.default ?? ' - '}
            </p>
          </td>
