...
<div class="rounded-md border border-neutral-300 dark:border-neutral-800">
  ...
  {#each definitions as definition}
    ...
    <table>
      ...
      <tbody>
        {#each definition.props as prop}
          <tr>
            <td class="p-2 border
              border-neutral-300 dark:border-neutral-800">{prop.name}</td>
            <td class="p-2 border
              border-neutral-300 dark:border-neutral-800">{prop.default}</td>
            <td class="p-2 border
              border-neutral-300 dark:border-neutral-800">{prop.type}</td>
          </tr>
        {/each}
      </tbody>
    </table>
