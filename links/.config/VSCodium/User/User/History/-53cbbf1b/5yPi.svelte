...
<nav
  class="w-full px-4 sticky top-0 z-40 max-lg:h-16 lg:p-4 bg-white dark:bg-neutral-900 flex flex-row justify-between items-center border-b border-neutral-300/50 dark:border-neutral-800"
>
  <div class="flex flex-row gap-2 max-lg:pl-12">
