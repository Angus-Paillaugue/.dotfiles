...
<nav
  class="w-full px-4 sticky top-0 z-40 max-xl:h-16 xl:p-4 bg-white dark:bg-neutral-900 flex flex-row justify-between items-center border-b border-neutral-300/50 dark:border-neutral-800"
>
