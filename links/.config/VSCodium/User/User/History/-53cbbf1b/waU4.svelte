...
<nav
  class="sticky top-0 z-40 flex w-full flex-row items-center justify-between border-b border-neutral-300/50 bg-white/75 px-4 dark:border-neutral-700/50 dark:bg-neutral-900/75 backdrop-blur max-xl:h-16 h-24"
>
