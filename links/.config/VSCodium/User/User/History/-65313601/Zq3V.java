...
public class BienLouableTests {
	...
	public void testTotalCoutAssurance() {
		...
		Assurance assurance1 = new AssuranceImpl(typeContratAssurance.HABITATION, "Assureur1", 123, 100);
		Assurance assurance2 = new AssuranceImpl(typeContratAssurance.HABITATION, "Assureur2", 456, 200);
