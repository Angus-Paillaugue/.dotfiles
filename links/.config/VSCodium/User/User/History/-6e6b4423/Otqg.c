...
int main()
{
  ...
  socklen_t len23 char buffer[MAXBUFFERLEN];
  ...
  ecode = getnameinfo((struct sockaddr *)&myinfo, sizeof(myinfo), 58 serverAddr, MAXHOSTLEN, 59 serverPort, MAXPORTLEN, 60 NI_NUMERICHOST | NI_NUMERICSERV);
  if (ecode != 0)
  {
