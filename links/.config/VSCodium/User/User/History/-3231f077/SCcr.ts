import { FinalFrontendConfig, FinalBackendConfig } from './types';
...
const defaultFrontendConfig: FinalFrontendConfig = {
  port: 3000,
  host: '0.0.0.0'
};
...
export const getFrontendConfig = (): FinalFrontendConfig => {
  return deepMerge(defaultFrontendConfig, frontendConfig) as FinalFrontendConfig;
}
