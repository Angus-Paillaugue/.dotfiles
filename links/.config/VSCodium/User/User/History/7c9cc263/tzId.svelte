<script>
	...
	const baseToastClasses = 'border border-neutral-700/50 bg-neutral-800/50 text-neutral-100 relative p-4 rounded-xl backdrop-blur-xl';
...
>
	{#each $toasts.slice(0, 4) as t (toast.id)}
		<div
			role="alert"
