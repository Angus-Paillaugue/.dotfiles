...
<div class="w-screen h-screen bg-primary">
	<div class="max-w-[2000px] h-full w-full mx-auto flex flex-row p-2 md:p-6 lg:p-8 gap-8">
		...
		>
			<a href="/" aria-label="Go home" id='logo' class="h-8 flex flex-col items-center relative">
				<h2 class="font-base text-lg transition-transform left-0 right-0 text-center absolute top-full ease-back-out duration-300">{$t('sidebar.occupation')}</h2>
				<h1 class="font-semibold text-xl bg-primary">Angus Paillaugue</h1>
			</a>
