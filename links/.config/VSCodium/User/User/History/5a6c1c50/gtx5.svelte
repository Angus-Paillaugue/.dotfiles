...
<div class="h-full grow flex flex-col rounded-xl overflow-hidden">
	<div class="flex flex-row p-2 shrink-0 bg-neutral-800">
		<Tooltip content="Format Code <kbd>Alt</kbd> <kbd>Shift</kbd> <kbd>F</kbd>" position="bottom" delay={100}>
			<button onclick={formatCode} class="flex flex-roe gap-2 items-center">
