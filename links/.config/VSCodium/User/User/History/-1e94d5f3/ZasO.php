...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $update->execute();
  header('Location: /vue/dashbaord/rencontre.php?id=' . $rencontre->getId());
}
?>
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) .
  ...
  http_build_query(
    $_GET
  ); ?>" class="max-w-screen-xl w-full mx-auto p-4 rounded-xl border space-y-6 border-neutral-300/50 dark:border-neutral-900">
  ...
  <div class="grid grid-cols-2 gap-4">
    ...
    Components::Button([
      ...
      'variant' => 'danger',
      'type' => 'button',
      'href' => '/vue/dashbaord/rencontre.php?id=' . $rencontre->getId(),
    ]);
    Components::Button([
      'label' => 'Enregistrer',
      'variant' => 'primary',
