...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) .
  ...
  http_build_query(
    $_GET
  ); ?>" class="max-w-screen-xl w-full mx-auto p-4 rounded-xl border space-y-6 border-primary-100">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    for ($i = 0; $i < 16; $i++) {
      $feuille = $rencontre->getFeuilleMatch()
        ...
        : null;
      echo "<div class='p-4 rounded-lg border gap-4 border-primary-100 grid grid-cols-2'>";
