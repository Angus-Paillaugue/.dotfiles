...
def removeBg(inputPath, outputDirectory):
    ...
    try:
        ...
        outputPath = os.join(outputDirectory, os.path.splitext(inputPath)[0] + '.png')
...
if __name__ == "__main__":
    ...
    imageFiles = [f for f in os.listdir(inputDirectory) if os.path.isfile(os.path.join(inputDirectory, f))]
    print(f"Found {len(imageFiles)} image files in the input directory.")
