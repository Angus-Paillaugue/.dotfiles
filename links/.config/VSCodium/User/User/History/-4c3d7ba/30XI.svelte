...
{#if selectedItems.size > 0}
  <div class="fixed bottom-0 left-0 right-0 bg-card p-4 flex flex-row items-center justify-between">
    <p class="text-neutral-100 font-mono text-base">{selectedItems.size} items selected</p>
    <button class="bg-neutral-700 text-neutral-100 font-mono text-base px-4 py-2 rounded-xl">Create outfit</button>
  </div>
{/if}
