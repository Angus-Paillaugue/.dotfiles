...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  if (empty($_POST['date_heure']) || empty($_POST['equipe_adverse']) || empty($_POST['lieu'])) {
    ErrorHandling::setError('Veuillez remplir tous les champs');
    exit(header('Location: /vue/dashboard/add-rencontre.php', true, 303));
  }
  ...
  exit(header('Location: /vue/dashboard/rencontre.php?id=' . $idRencontre));
  exit();
}
?>
