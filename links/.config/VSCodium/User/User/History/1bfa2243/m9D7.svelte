...
<div
  class="flex w-full flex-col items-center justify-center lg:justify-between rounded-2xl bg-secondary px-4 pt-12 md:px-6 md:pt-24 min-h-[calc(100dvh-4rem-1rem-50px)] mb-14"
>
  ...
  <div class="grow w-full h-full flex flex-col max-lg:hidden">
    <div class="p-3 aspect-video w-full mt-auto translate-y-14 rounded-3xl border border-primary bg-background relative overflow-hidden">
      ...
      <div class="bg-background overflow-hidden rounded-2xl shadow size-full">
        {#if $mode === 'dark'}
