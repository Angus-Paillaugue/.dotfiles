...
>
  ...
  <div class="grow w-full h-full flex flex-col max-lg:hidden">
    <div class="p-3 aspect-video w-full mt-auto translate-y-14 rounded-3xl border-2 border-primary bg-background relative overflow-hidden">
      ...
      <div class="bg-background overflow-hidden rounded-2xl shadow size-full relative cursor-none hover:cursor-none" bind:this={fakeCursorContainer}>
        <div class="absolute z-10 drop-shadow-sm transition-opacity flex flex-col" style="top: {fakeCursorPos.y}px; left: {fakeCursorPos.x}px; opacity: {fakeCursorOpacity};">
        ...
        <div class="bg-primary shadow-md text-sm font-medium px-2 absolute z-10 transition-opacity py-0.5 translate-x-5 translate-y-5 text-primary-foreground rounded" style="top: {$fakeCursorNameTagPos.y}px; left: {$fakeCursorNameTagPos.x}px; opacity: {fakeCursorOpacity};">You</div>
        {#if $mode === 'dark'}
