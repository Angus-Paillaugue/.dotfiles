...
>
  ...
  <div class="grow w-full h-full flex flex-col">
    <div class="p-2 aspect-video w-full mt-auto translate-y-[50px] rounded-xl border border-primary bg-background relative overflow-hidden">
      <div class="absolute inset-0 bg-primary/15 -z-10"></div>
      <div class="bg-background overflow-hidden rounded-lg shadow size-full">
        {#if $mode === 'dark'}
