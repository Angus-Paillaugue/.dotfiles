...
public class Constants {
  ...
  public static final LineBorder BORDER = new LineBorder(BODY_COLOR, 1);
  ...
  public static Adresse adresseProprietaire =
      new Adresse("8", "Avenue de rangueil", "Toulouse", "31400");
  public static Proprietaire proprietaire =
      new Proprietaire("Thierry", "Millan", adresseProprietaire, "tm@univ-tlse3.fr", "0606060606");

  public static Adresse adresseLogement1 =
  ...
  public static Loyer loyer1 =
      new Loyer(750.0F, 05, LocalDate.of(2024, 8, 11), LocalDate.of(2025, 9, 11), ModeDePaiment.CB);
  public static Charges charges1 = new Charges(200.0F, 10.0F, 10.0F, 5.0F, 45.0F);
  public static Personne locataire1 =
      new Personne(
          "Dupont",
          "Jean",
          1,
          ...
          "telephone",
          adresseLogement1);
  public static Personne locataire2 =
      new Personne(
          "Jean",
          "Lassalle",
          2,
          ...
          "telephone",
          adresseLogement1);
  public static Personne garant1 =
      new Personne(
          "Pierre",
          "Durand",
          2,
          LocalDate.of(1992, 10, 3),
          "Lieu naissance",
          SituationFamiliale.CELIBATAIRE,
          "Profession",
          "Employeur",
          ...
          "telephone",
          adresseLogement1);
  public static Personne garant2 =
      new Personne(
          "Paul",
          "Martin",
          3,
          ...
          "telephone",
          adresseLogement1);
  public static ArrayList<Personne> listGarants1 = new ArrayList<Personne>();
  public static Location location1 =
      new Location(locataire1, listGarants1, LocalDate.of(2018, 1, 1), adresseLogement1, 1000.0F);
  public static Location location2 =
      new Location(locataire2, listGarants1, LocalDate.of(2019, 5, 1), adresseLogement1, 1000.0F);
  public static Colocation colocation1 =
      new Colocation(new LinkedList<Location>(Arrays.asList(location1, location2)));
  public static Logement logement1 =
      new Logement(
          adresseLogement1,
          "12345678AB",
          true,
          ...
          true,
          "Equipement fibre...");
  public static Logement logement2 =
      new Logement(
          adresseLogement1,
          "12345678AB",
          true,
  ...
  static {
    batiment1.getBiensLouables().add(logement1);
    batiment1.getBiensLouables().add(logement2);
    batiment1.getBiensLouables().get(0).addLocation(location1);
    batiment1.getBiensLouables().get(1).addColocation(colocation1);

    proprietaire.getBatiment().add(batiment1);
  }
  //////////////////////////////////////////////////////
}
