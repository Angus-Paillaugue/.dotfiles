...
public class TpJdbcMaj {
	...
	public static void main(String[] args) throws SQLException {
		...
		dlCrSt.executeUpdate(
				"DELETE FROM AFFECTER WHERE (DEBSEMC, GRPC) IN (SELECT DEBSEMC, GRPC FROM CRENEAU WHERE HEUREDC = '11:00' AND (DEBSEMC, JOURC, HEUREDC, GRPC) IN (SELECT DEBSEMC, JOURC, HEUREDC, GRPC FROM ENSEIGNER WHERE ENSC = 'PGM'))");
