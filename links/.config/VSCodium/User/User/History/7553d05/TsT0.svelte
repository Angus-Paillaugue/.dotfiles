        ...
        <div class="p-2" id="results">
          {#each results as result, index}
            ...
            >
              ...
              <ChevronRight
                class="group-hover:opacity-100 text-primary size-6 text-muted-foreground shrink-0 opacity-0 transition-opacity group-focus:opacity-100 [.group.selected_&]:opacity-100"
              />
            </a>
          {/each}
        </div>
