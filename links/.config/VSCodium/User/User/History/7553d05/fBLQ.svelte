...
{#if open}
  ...
  ></button>
  <div class="fixed z-40 left-4 right-4 top-4 sm:top-6 sm:right-6 sm:left-6 md:top-12 md:left-1/2 md:-translate-x-1/2 max-w-screen-md w-full">
    <div
      class="no-scrollbar w-full md:max-w-[300px] overflow-hidden overflow-y-auto rounded-2xl bg-background"
