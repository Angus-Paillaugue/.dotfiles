...
{#if activePath}
	...
	<div class="absolute flex flex-col justify-end inset-0 pt-14 z-40">
		<div class="border max-h-full min-h-[80vh] overflow-y-auto no-scrollbar border-neutral-700/50 border-b-0 rounded-t-xl w-full bg-neutral-900" transition:slide={{ axis:'y', duration:500, easing:backOut }}>
