...
{#if activePath}
	<div class="inset-0 absolute bg-neutral-900/50 backdrop-blur-md z-20" transition:fade={{ duration:400 }}></div>
	<div class="absolute flex flex-col justify-end inset-0 pt-14 z-40">
		<div class="border max-h-full overflow-y-auto no-scrollbar border-neutral-700/50 border-b-0 rounded-t-xl w-full bg-neutral-900" transition:slide={{ axis:'y', duration:500, easing:backOut }}>
			<div class="max-w-screen-lg mx-auto w-full min-h-[80vh]">
