...
<script>
  ...
  let commands = [{name:'npm', command:"npm install angus"}, {name:'pnpm pnpm pnpm', command:"pnpm install angus"}, {name:'bun', command:"bun add angus && bun add angus && bun add angus && bun add angus"}]
</script>
