  ...
  <div class="grid gap-4 lg:grid-cols-6 w-full items-center p-4 relative">
    ...
    <div class="flex flex-col items-center justift-center">
      ...
      >
        ...
        <div class="border-button absolute -inset-1 rounded-lg border border-border after:content-[''] after:absolute after:w-full after:aspect-square after:top-1/2 after:left-1/2 after:-trasnlate-x-1/2 after:-translate-y-1/2"></div>
      </Button>
    </div>
    <!-- Table -->
