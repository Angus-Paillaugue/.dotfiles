    ...
    if (target.getName() != null && target.getName().equals("cancel")) {
      ...
      try {
        ...
        Assurance assurance = new Assurance(
            VuesUtils.toFloat(VuesUtils.getInputValue(this.vue.mainPanel, "montantAssurance")),
            VuesUtils.toLocalDate(VuesUtils.getInputValue(this.vue.mainPanel, "dateAssurance")),
            VuesUtils.getInputValue(this.vue.mainPanel, "assurance"));
        );
