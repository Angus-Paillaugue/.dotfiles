      ...
      try {
        ...
        Charges charges =
            new Charges(
                ...
                VuesUtils.toFloat(VuesUtils.getInputValue(this.vue.mainPanel, "eclairageCommun")),
        ...
        Assurance assurance = new Assurance(
            VuesUtils.getInputValue(this.vue.mainPanel, "typeAssurance"),
            VuesUtils.getInputValue(this.vue.mainPanel, "nomAssureur"),
            VuesUtils.toInt(VuesUtils.getInputValue(this.vue.mainPanel, "numeroContractAssurance")),
            VuesUtils.toFloat(VuesUtils.getInputValue(this.vue.mainPanel, "primeAssurance")));
