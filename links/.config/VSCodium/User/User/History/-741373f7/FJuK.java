    ...
    if (target.getName() != null && target.getName().equals("cancel")) {
      ...
      try {
        ...
        LocalDate dateConstruction =
          ...
          System.out.println(this.vue.getFiles());
        String constatAmiante = this.vue.getFiles().get("constatAmiante");

        String constatPlomb = this.vue.getFiles().get("constatPlomb");

        String constatElectricite = this.vue.getFiles().get("constatElectricite");
