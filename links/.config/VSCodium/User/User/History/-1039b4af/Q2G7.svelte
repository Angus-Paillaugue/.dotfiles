  ...
  const projects = [
    {
      ...
      bgColor:'bg-blue-600',
      image:'https://images.unsplash.com/photo-1632210006854-4b3b3b3b3b3b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwyMjIwNzR8MHwxfGFsbHwxf'
    },
    {
      date:2024,
      name:'Project 2',
...
<section id="projects" class="max-w-screen-xl mx-auto p-2 lg:p-4">
  ...
  <div class="flex flex-row col-[content] gap-8 relative transition-transform duration-300 ease-in-out mt-20" bind:this={projectsCarousel}>
    {#each projects as project}
      <div class="aspect-square group rounded-xl bg-blue-600 relative flex flex-col w-full md:w-1/3 p-4 shrink-0 group/card">
        ...
        <div class="h-0 overflow-hidden flex flex-col justify-between group-hover/card:grow duration-300 ease-in transition-all">
