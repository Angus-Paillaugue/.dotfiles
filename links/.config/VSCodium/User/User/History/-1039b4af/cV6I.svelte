...
<section id="projects" class="max-w-screen-xl mx-auto p-2 lg:p-4">
  ...
  <div class="flex flex-row-items-center justify-end gap-8 mt-4">
    <button class="rounded-full p-1 disabled:text-neutral-400 transition-colors c:bg-neutral-300/50 group/button" aria-label="Carousel previous" onclick={() => {carouselIndex = Math.max(carouselIndex - 1, 0)}} disabled={carouselIndex === 0}>
