...
<div class="hidden grow flex-col overflow-hidden max-lg:flex">
	<div
		class="mb-2 grid shrink-0 grid-cols-3 flex-nowrap overflow-x-auto rounded-full bg-neutral-900"
	>
		<button
			class={cn(
				'flex flex-row items-center justify-center gap-2 rounded-full px-3 py-1 text-lg font-semibold transition-colors',
				mobileActiveTabIndex != 0 ? 'text-neutral-400 hover:bg-neutral-900/50' : 'bg-neutral-800'
			)}
		...
		<button
			class={cn(
				'flex flex-row items-center justify-center gap-2 rounded-full px-3 py-1 text-lg font-semibold transition-colors',
				mobileActiveTabIndex != 1 ? 'text-neutral-400 hover:bg-neutral-900/50' : 'bg-neutral-800'
			)}
		...
		<button
			class={cn(
				'flex flex-row items-center justify-center gap-2 rounded-full px-3 py-1 text-lg font-semibold transition-colors',
				mobileActiveTabIndex != 2 ? 'text-neutral-400 hover:bg-neutral-900/50' : 'bg-neutral-800'
			)}
...
<PaneGroup
	...
	class="!hidden grow overflow-hidden lg:!flex"
	style="height: auto;"
...
>
	...
	<PaneResizer class="group relative flex w-2 items-center justify-center">
		<div class="flex h-7 w-[2px] items-center justify-center rounded-sm bg-neutral-800"></div>
		<div
			class="absolute bottom-0 left-1/2 top-0 w-[2px] -translate-x-1/2 rounded-full transition-colors group-hover:bg-neutral-600"
		></div>
	</PaneResizer>
