...
<!-- Code action buttons -->
<div class="lg:mx-auto z-30 w-52 mb-2 max-lg:fixed max-lg:top-3 max-lg:left-1/2 max-lg:-translate-x-1/2">
	<div class="relative grid grid-cols-2 items-center gap-px">
		...
		<!-- Timer -->
		<div
			class="absolute overflow-hidden rounded-lg left-full top-0 ml-2 lg:block hidden"
		>
	...
	>
		<button
			class={cn(
				...
				mobileActiveTabIndex != 0 ? 'text-neutral-400' : 'bg-neutral-800'
			)}
...
<PaneGroup
	...
	class="!hidden !h-[calc(100vh-20rem)] grow overflow-hidden lg:!flex"
	style="height: auto;"
