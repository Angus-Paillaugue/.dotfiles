 ...
 * Each toast has a unique identifier, a title, a message, and a timeout duration after which it is automatically removed.
 *
 * @class
 */
export class toast {
	 ...
	 *
	 * @param {Object} options - The options for the success toast.
	 * @param {string} options.title - The title of the toast.
	 * @param {string} options.message - The message of the toast.
	 * @param {number} [options.timeout] - The duration (in milliseconds) before the toast disappears.
	 */
