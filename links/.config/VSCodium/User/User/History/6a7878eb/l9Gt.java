...
public class LoyerTests {
  ...
  public void testLoyerConstructor() {
    ...
    assertEquals(jourVersement, loyer.get());
  ...
  public void testToString() {
    Loyer loyer =
        new Loyer(1000, 1, LocalDate.of(2022, 1, 1), LocalDate.of(2023, 1, 1), ModeDePaiment.CB);
    String expected =
        "Loyer [dateDerniereRevision=2022-01-01, dateProchaineRevision=2023-01-01, jourVersement=1, modeDePaiment=CB, montantHorsCharge=1000.0]";
