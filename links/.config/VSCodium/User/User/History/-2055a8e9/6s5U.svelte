...
>
  <div class="relative w-full h-full">
    ...
    >
      <h1
        class="text-2xl m-0 w-fit font-bold text-center bg-gradient-to-r from-primary-500 via-purple-500 to-primary-500 dark:from-primary-500 dark:via-purple-500 dark:to-primary-500 bg-clip-text text-transparent dark:text-transparent inline-block"
