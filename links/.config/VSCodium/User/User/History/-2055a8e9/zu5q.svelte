...
<div class="isolate w-full flex flex-col dark:bg-white bg-neutral-900">
  <main class="rounded-b-[32px] overflow-clip dark:bg-neutral-900 bg-white">
    ...
    <section class="max-w-screen-xl mx-auto grid grid-cols-6 gap-2 my-24">
      <div
        class="border border-neutral-300/50 dark:border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-3 rounded-md xl:rounded-tl-3xl relative"
      >
        <img
          ...
          alt=""
        />
        <div class="absolute left-0 right-0 bottom-0 h-2/3 pointer-events-none bg-gradient-to-b from-transparent dark:to-neutral-900 to-white from-50% to-80%"></div>
      ...
      <div
        class="border border-neutral-300/50 dark:border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-3 rounded-md relative"
      >
        <img
      ...
      <div
        class="border border-neutral-300/50 dark:border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-2 rounded-md relative"
      >
        <img
