...
<div class="isolate w-full flex flex-col dark:bg-white bg-neutral-900">
  <main class="rounded-b-[32px] overflow-clip dark:bg-neutral-900 bg-white">
    ...
    <section class="max-w-screen-xl mx-auto grid grid-cols-6 gap-2 my-24">
      <div
        class="border border-neutral-300/50 dark:border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-3 rounded-md relative overflow-hidden:rounded-tl-[50px]"
      >
        <img
      ...
      <div
        class="border border-neutral-300/50 dark:border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-3 rounded-md relative overflow-hidden :rounded-tr-[50px]"
      >
        <img
      ...
      <div
        class="border border-neutral-300/50 dark:border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-2 rounded-md relative overflow-hidden :rounded-bl-[50px]"
      >
        <img
      ...
      <div
        class="border border-neutral-300/50 dark:border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-2 rounded-md relative overflow-hidden :rounded-br-[50px]"
      >
        <img
