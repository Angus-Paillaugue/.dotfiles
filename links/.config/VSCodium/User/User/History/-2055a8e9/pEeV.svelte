<script>
  ...
  function onScroll() {
    ...
    if (window.scrollY + (screenHeight / 3) * 2 > screenHeight) {
...
<div class="isolate w-full flex flex-col dark:bg-white bg-neutral-900">
  <main class="rounded-b-[32px] overflow-clip dark:bg-neutral-900 bg-white">
    ...
    <section class="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-6 gap-2 px-2 md:px-10 md:my-24">
      <div
        class="border border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-1 md:col-span-3 rounded-md relative overflow-hidden md:rounded-tl-[50px] max-md:rounded-t-[50px] bg-neutral-900"
      >
        <img
          ...
          alt=""
        />
        <div class="absolute left-0 right-0 bottom-0 h-2/3 pointer-events-none bg-gradient-to-b from-transparent to-neutral-900 to-40%"></div>
        <div class="absolute bottom-0 left-0 right-0 flex text-center justify-center flex-col gap-2 p-4 xl:p-8">
          <h1 class="text-base font-medium m-0 text-neutral-100">Gorgeous out of the box</h1>
          <span>Opinionated when you're lazy, but infinitely flexible when you need it to be</span>
        </div>
      </div>
      <div
        class="border border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-1 md:col-span-3 rounded-md relative overflow-hidden md:rounded-tr-[50px] bg-neutral-900"
      >
        <img
          ...
          alt=""
        />
        <div class="absolute left-0 right-0 bottom-0 h-2/3 pointer-events-none bg-gradient-to-b from-transparent to-neutral-900 col-span-1 md:col-span-2 to-40%"></div>
        <div class="absolute bottom-0 left-0 right-0 flex text-center justify-center flex-col gap-2 p-4 xl:p-8">
          <h1 class="text-base font-medium m-0 text-neutral-100">Developer forward</h1>
          <span>Content is powered by markdown and lives alongside your codebase</span>
        </div>
      </div>
      <div
        class="border border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-1 md:col-span-2 rounded-md relative overflow-hidden md:rounded-bl-[50px] bg-neutral-900"
      >
        <img
        ...
        <div class="absolute left-0 right-0 bottom-0 h-2/3 pointer-events-none bg-gradient-to-b from-transparent to-neutral-900 to-40%"></div>
        <div class="absolute bottom-0 left-0 right-0 flex text-center justify-center flex-col gap-2 p-4 xl:p-8">
          <h1 class="text-base font-medium m-0 text-neutral-100">Built for performance</h1>
          <span>Meticulously designed and optimized for a great user experience</span>
        </div>
      </div>
      <div
        class="border border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-1 md:col-span-2 rounded-md relative overflow-hidden bg-neutral-900"
      >
        <img
        ...
        <div class="absolute left-0 right-0 bottom-0 h-2/3 pointer-events-none bg-gradient-to-b from-transparent to-neutral-900 to-40%"></div>
        <div class="absolute bottom-0 left-0 right-0 flex text-center justify-center flex-col gap-2 p-4 xl:p-8">
          <h1 class="text-base font-medium m-0 text-neutral-100">Conversion as a priority</h1>
          <span>Crafted for more user engagement and conversions</span>
        </div>
      </div>
      <div
        class="border border-neutral-700/50 p-4 xl:p-8 text-center flex flex-col items-center gap-2 col-span-1 md:col-span-2 rounded-md relative overflow-hidden md:rounded-br-[50px] max-md:rounded-b-[50px] bg-neutral-900"
      >
        <img
        ...
        <div class="absolute left-0 right-0 bottom-0 h-2/3 pointer-events-none bg-gradient-to-b from-transparent to-neutral-900 to-40%"></div>
        <div class="absolute bottom-0 left-0 right-0 flex text-center justify-center flex-col gap-2 p-4 xl:p-8">
          <h1 class="text-base font-medium m-0 text-neutral-100">Effortlessly maintained</h1>
