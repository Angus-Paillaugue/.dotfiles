...
By default, environment variables are generated randomly when building the app first and stores in the root `.env` file. If you want to change them you can and they will be automatically transferred
...
Server monitoring is done automatically.
