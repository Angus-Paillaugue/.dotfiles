...
installEclipse() {
  ...
  cd ~/Downloads
  wget https://ftp.fau.de/eclipse/oomph/products/eclipse-inst-linux64.tar.gz -O eclipse-inst-linux64.tar.gz
...
installDocker() {
  ...
  cd ~/Downloads
  wget https://desktop.docker.com/linux/main/amd64/docker-desktop-4.12.0-amd64.deb -O docker-desktop.deb
