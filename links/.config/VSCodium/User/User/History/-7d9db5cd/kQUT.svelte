<script lang="ts">
  ...
  import logInImageDark from '$lib/assets/logInImageDark.jpg';
  import logInImageLight from '$lib/assets/logInImageLight.jpg';
...
>
  ...
  <div class="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
    {#if $theme === 'dark'}
      <img src={logInImageDark} alt="" class="absolute inset-0 object-cover" />
    {:else}
      <img src='/src/lib/assets/logInImageLight.jpg' alt="" class="absolute inset-0 object-cover" />
    {/if}
    <div
