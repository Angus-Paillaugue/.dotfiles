...
require_once __DIR__ . '/../../controleur/AjouterUnCommentaire.php';
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $ajoutCommentaire = new AjouterUnCommentaire($joueur->getId(), $commentaire);
  $ajoutCommentaire->execute();
  header('Location: joueur.php?id=' . $joueur->getId(), true, 303);
}
?>

<form method="POST" action="<?php echo  ?>" class="max-w-screen-xl w-full mx-auto p-4 rounded-xl border space-y-4 border-neutral-300/50">
  <h1>
