...
<form method="POST" action="<?php echo '/controleur/CreerUnCommentaire.php?' .
  http_build_query(
    $_GET
  ); ?>" class="max-w-screen-xl w-full mx-auto p-4 rounded-xl border space-y-4 border-neutral-300/50 dark:border-neutral-900">
  <h1>
    Ajouter un commentaire
  </h1>
  <input type="hidden" id="id" value="<?php echo $joueur->getId(); ?>">
