...
<div
  class="flex flex-col items-center justify-center relative p-10 rounded-xl border border-border bg-secondary lg:col-span-2"
>
  <div bind:this={containerRef} class="flex flex-col items-center justify-center relative rounded-xl border border-border bg-secondary">
    <!--  Gradient Line -->
    <div
