...
<div
  class="flex flex-col items-center justify-between p-10 rounded-xl border border-border bg-secondary lg:col-span-2"
>
  <div bind:this={containerRef} class="flex h-full w-full grow flex-col items-center justify-center relative">
    <!--  Gradient Line -->
    <div
