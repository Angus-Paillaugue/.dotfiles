export const doc = [
  {
    name: 'Button',
    description:
      'This component renders a button or an anchor element based on the presence of the `href` prop. It supports various styles and types, which can be customized through props.',
    params: [
      {
        type: 'any',
        name: 'children',
        description:
          'The content to be rendered inside the button or anchor element.',
        required: true
      },
      {
        type: 'string',
