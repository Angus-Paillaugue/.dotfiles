...
public class RegularisationDesChargesControleur implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    Logement b = this.vue.getBienLouable();
    JComponent target = (JComponent) e.getSource();
    // TODO: Fix buttons actions not working
      ...
      case "calculer":
        {
          try {
            ...
            float propositionNewProvisions = (float) Math
                .ceil(b.getCharges().provisionSurChargeAnnuel() + totalRestantDu);
