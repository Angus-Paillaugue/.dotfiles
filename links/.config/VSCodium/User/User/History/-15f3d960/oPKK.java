  ...
  public void actionPerformed(ActionEvent e) {
    ...
    switch (target.getName()) {
      ...
      case "reviser":
        ...
        float prixDuMetreCubeDEau = VuesUtils.toFloat(VuesUtils.getInputValue(this.vue.mainPanel, "prixEauMetreCube"));
        ...
        this.vue.dispose();
        new ModalSuccess("Succès", "Charges régilarisés avec succes", null)
        break;
    }
  }
}
