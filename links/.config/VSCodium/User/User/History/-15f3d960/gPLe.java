      ...
      case "reviser":
        {
          ...
          float sousTotalFixe =
              eclairageCommun + orduresMenageres + entretienCommun + eauPartieFixe;
          ...
          float provisionSurChargeAnnuel = VuesUtils
              .toFloat(VuesUtils.getInputValue(this.vue.mainPanel, "provisionSurChargeAnnuel"));
