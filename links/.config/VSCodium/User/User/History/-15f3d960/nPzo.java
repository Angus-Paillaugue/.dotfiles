  ...
  public void actionPerformed(ActionEvent e) {
    ...
    switch (target.getName()) {
      ...
      case "calculer": {
        ...
        float sousTotalFixe = VuesUtils.toFloat(VuesUtils.getInputValue(this.vue.mainPanel, "eclairageCommun")) + VuesUtils.toFloat(VuesUtils.getInputValue(this.vue.mainPanel, "orduresMenageres")) + VuesUtils.toFloat(VuesUtils.getInputValue(this.vue.mainPanel, "entretienPartiesCommunes"));
