  ...
  class sql_connector {
    ...
    public function run_query($sql, ...$params)
    {
      try {
        ...
        // }
        var_dump($params); // array(6) { [0]=> string(5) "Angus" [1]=> string(10) "Paillaugue" [2]=> string(23) "15 allee des puits clos" [3]=> string(5) "33400" [4]=> string(7) "Talence" [5]=> string(10) "0606060606" }
        if(count($params) > 0) {
