...
public class HistoriqueDesCharges extends JFrame {
  ...
  public HistoriqueDesCharges(Logement b) {
    this.b = b;
    setTitle("Charges");
    ...
    rentPanel.add(reviewRentButton, gbc);
    JButton cancelButton = new Button("Fermer").build();
    cancelButton.setName("cancel");
    cancelButton.addActionListener(
        e -> {
          new DetailAppartement(this.b).setVisible(true);
          this.dispose();
        });
    gbc.gridx = 1;
    rentPanel.add(cancelButton, gbc);
