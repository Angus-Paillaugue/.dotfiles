<?php
  ...
  class Button {
    ...
    public function __construct($params = [])
    {
      ...
      $disabled = Helpers::e($params['disabled'], "false", "true");
      echo $disabled;
      ...
      $this->component = "<button type='submit' class='cursor-pointer transition-all duration-200 ease-in-out px-4 py-2 font-medium rounded-lg disabled:opacity-50 disabled:cursor-not-allowed   $variantClasses[$variant] $class' disabled='$disabled' type='$type'>$label</button>";
    }
