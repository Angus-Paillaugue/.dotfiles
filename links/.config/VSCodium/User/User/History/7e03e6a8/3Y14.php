<?php
  ...
  class Button {
    ...
    public function __construct($params = [])
    {
      ...
      $this->component = "<button type='submit' class='button cursor-pointer transition-all duration-200 ease-in-out px-4 py-2 font-medium rounded-lg disabled:opacity-50 disabled:cursor-not-allowed $variantClasses[$variant] $class' $disabled type='$type'>$label</button>";
    }
