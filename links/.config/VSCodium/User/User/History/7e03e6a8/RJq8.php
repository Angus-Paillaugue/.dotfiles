<?php
  class Helpers {
    public static function e($val, $default = '') {
  ...
  class Button {
    ...
    public function __construct($params = [])
    {
      ...
      $disabled = Helpers::e($params['disabled'], '');
  ...
  class Input {
    ...
    public function __construct($params = [])
    {
      $placeholder = Helpers::e($params['placeholder']) ? $params['placeholder'] : '')''
      $id = Helpers::e($params['id']) ? $params['id'] : 'primary')''
      $label = Helpers::e($params['label']) ? "<label for='input'>".$params['label']."</label>" : '')''
      $type = Helpers::e($params['type']) ? $params['type'] : 'text')''
      $class = Helpers::e($params['class']) ? $params['class'] : '')''
      $this->component = "
