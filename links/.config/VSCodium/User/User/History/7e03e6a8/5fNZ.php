<?php
  class Helpers {
    public static function e($val, $default = '', $ifTrue) {
      return isset($val) ? isset($ifTrue) ? $ifTrue : $val : $default;
    }
  }
  ...
  class Button {
    ...
    public function __construct($params = [])
    {
      ...
      $disabled = Helpers::e($params['disabled'], false);
      echo $disabled;
      ...
      $this->component = "<button type='submit' class='button $variantClasses[$variant] $class' disabled='$disabled' type='$type'>$label</button>";
    }
