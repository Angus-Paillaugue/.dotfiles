<?php
  ...
  class Alert {
    ...
    public function __construct($params = [])
    {
      ...
      $this->component = "<div class='rounded-lg p-4 flex flex-row border gap-4 items-center before:size-10 before:bg-cover before:bg-center before:bg-no-repeat before:block $variantClasses[$variant] $class'>$text</div>";
    }
