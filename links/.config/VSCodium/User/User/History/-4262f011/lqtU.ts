 ...
 * @param dateStyle - The style of the date. Defaults to 'medium'.
 * @param locales - The locale to use for formatting. Defaults to 'en'.
 * @returns The formatted date.
 */
export function formatDate(date: Date, dateStyle: 'full' | 'long' | 'medium' | 'short' = 'medium', locales: string = 'en'): string {
 ...
 */
export function accordion(node: HTMLElement, isOpen: boolean = false) {
...
export const urlHealer = {
	...
	identifier: {
		 ...
		 */
		join: (slug: string, id: number) => `${slug}-${id}`
	},
	/**
