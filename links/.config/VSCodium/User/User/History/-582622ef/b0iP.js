export const doc = [
  ...
  },
  {
    name: 'Group',
    description:
      'This component is a wrapper for multiple Collapsible components.',
    params: [
      {
        type: 'any',
        name: 'children',
        required: true,
        description: 'The Collapsible components to render.'
      },
      {
        type: 'string',
        name: 'class',
        description:
          'Additional CSS classes to apply to the Collapsible group container.'
      },
      {
        type: 'object',
        name: 'restProps',
        description:
          'Any additional props to be spread onto the Collapsible group container.'
      }
    ]
  }
];
