<script>
  ...
  $effect(() => {
    if(visible === "closed") {
      ...
      // terminal.addWelcomeMessage();
      terminal.terminalPush(`Welcome to my terminal website!`);
		  terminal.terminalPush(`Type [BG-WHITE]'help'[/BG-WHITE] to see available commands.`);
    }
  })
</script>
...
<Window title="Terminal" bind:visible class="text-neutral-100 ligatures-normal font-semibold tracking-normal">
