...
<PaneGroup direction="horizontal" class="h-[calc(100vh-2.5rem)]" autoSaveId="adminAddExercisePage">
	<!-- Left part -->
	<Pane defaultSize={50} class="flex flex-col grow h-full gap-4">
		<!-- Error -->
		{#if error}
			<div
				transition:scale
		...
		<div class="flex flex-col grow bg-neutral-900 h-full rounded-xl overflow-y-auto">
			<div class="p-4 grow flex flex-col overflow-y-auto">
				...
				<div class="flex flex-col grow mt-4">
					...
					<div id="pageContainer" class="flex flex-col overflow-y-auto grow shrink-0">
