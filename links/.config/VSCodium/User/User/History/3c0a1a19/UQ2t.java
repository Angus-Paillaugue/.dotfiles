...
public class UserProfileVue extends JFrame {
	...
	public UserProfileVue(Personne personne) {
		...
		JLabel nameLabel = new JLabel(personne.getNom() + " " + personne.getPrenom(), JLabel.CENTER); // Center the label text
		...
		detailsListPanel.add(createDetailLabel("Date de naissance", personne.getDateNaissance().toString()));
		detailsListPanel.add(createDetailLabel("Ville de naissance", personne.getLieuNaissance()));
		detailsListPanel.add(createDetailLabel("Situation familiale", personne.getSituationFamiliale().toString()));
		...
		workPanel.add(createDetailLabel("Contrat de travail", personne.getTypeDeContratDeTravail().toString()));
		workPanel.add(createDetailLabel("Revenu NET", Formatters.formatCurrency(personne.getRemunerationMensuelleNette())));
		workPanel.add(createDetailLabel("Autres revenus", Formatters.formatCurrency(personne.getAutresRevenus())));
