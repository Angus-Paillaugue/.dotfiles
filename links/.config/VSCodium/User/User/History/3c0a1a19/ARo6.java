	...
	public class UserProfileVue extends JFrame {
	    ...
	    public UserProfileVue() {
	        ...
	        profileImage.setIcon(new CustomImage(Constants.PP_PATH + "Jean.jpg").resize(150, 200).build());
	        profileImage.setBorder(BorderFactory.createLineBorder(Color.BLACK));
	        profilePanel.add(profileImage, BorderLayout.WEST);

	        // Name and Details
	        JPanel detailsPanel = new JPanel(new BorderLayout());
	        detailsPanel.setLayout(new BorderLayout());

	        JLabel nameLabel = new JLabel("Mr. Jean Lassalle", JLabel.CENTER); // Center the label text
	        ...
	        TitledBorder titleBorder = BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Constants.BODY_COLOR), "Travail");
	        ...
	        workPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10), titleBorder), BorderFactory.createEmptyBorder(10, 10, 10, 10)));
	    ...
	    public static void main(String[] args) {
	        SwingUtilities.invokeLater(UserProfileVue::new);
	    }
	}
