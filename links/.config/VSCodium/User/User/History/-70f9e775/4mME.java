...
public class LocationTests {
	...
	public void testSinglePersonConstructor() {
		Personne locataire = new Personne("Doe", "John", 1, LocalDate.of(1990, 1, 1), "Springfield", null, "Engineer",
				"Company", null, 3000, 500, "john.doe@example.com", "1234567890", null);
		List<Personne> garants = Arrays.asList(new Personne("Doe", "Jane", 2, LocalDate.of(1992, 2, 2), "Springfield", null,
				"Doctor", "Hospital", null, 4000, 600, "jane.doe@example.com", "0987654321", null));
	...
	public void testTwoPersonConstructor() {
		Personne locataire1 = new Personne("Doe", "John", 1, LocalDate.of(1990, 1, 1), "Springfield", null, "Engineer",
				"Company", null, 3000, 500, "john.doe@example.com", "1234567890", null);
		Personne locataire2 = new Personne("Smith", "Jane", 3, LocalDate.of(1993, 3, 3), "Springfield", null, "Teacher",
				"School", null, 3500, 400, "jane.smith@example.com", "1122334455", null);
		List<Personne> garants = Arrays.asList(new Personne("Doe", "Jane", 2, LocalDate.of(1992, 2, 2), "Springfield", null,
				"Doctor", "Hospital", null, 4000, 600, "jane.doe@example.com", "0987654321", null));
		LocalDate dateContrat = LocalDate.now();
		Adresse lieuDeContrat = new Adresse("123", "Main St", "Springfield", "12345");
	...
	public void testAddGarant() {
		...
		Location location = new Location(locataire, garants, dateContrat, lieuDeContrat, caution);
		Personne newGarant = new Personne("Doe", "Jane", 2, LocalDate.of(1992, 2, 2), "Springfield", null, "Doctor",
				"Hospital", null, 4000, 600, "jane.doe@example.com", "0987654321", null);
	...
	public void testTotalRevenusLocataires() {
		...
		assertEquals(3500, location.TotalRevenusLocataires(), 0.01);
	}
}
