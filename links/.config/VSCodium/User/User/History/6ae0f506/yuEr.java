...
public class DateField {
  ...
  /**
   * A custom date input field component that allows users to enter and validate dates.
   * The date format used is "dd/MM/yyyy".
   *
   * <p>This component consists of a formatted text field for date input and an icon.
   * It restricts input to digits and '/' characters, and validates the date format
   * when the field loses focus. If the date is invalid, the background color of the
   * field changes to indicate an error.
   *
   * @param value the initial date value as a string in the format "dd/MM/yyyy". If the value is null or invalid, the current date is used.
   */
