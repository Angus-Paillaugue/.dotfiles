...
# Install the create-sk-template script
sudo cp create-sk-template.sh /usr/local/bin/create-sk-template
sudo chmod +x /usr/local/bin/create-sk-template

echo -e " ${GREEN}✓${NC} The SvelteKit template creator script have been installed successfully."
