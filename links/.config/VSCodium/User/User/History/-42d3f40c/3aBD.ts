...
const addMoveButtonsEventListeners = (index: number) => {
  const moveUpButton = document.getElementById(`bookmark-${index}-move-up-button`) as HTMLButtonElement;
  const moveDownButton = document.getElementById(`bookmark-${index}-move-down-button`) as HTMLButtonElement;
