    ...
    <div id="bookmark-user-defined-item-${index}" class="bg-neutral-800 p-2 rounded-md grid grid-flow-row gap-4">
      <div class="grid grid-cols-[auto_max-content_max-content]">
        ...
        <div class="grid grid-cols-4 gap-2">
          ${index === 0 ? "" : `<button id="bookmark-${index}-move-bookmark-up" class="bg-neutral-500 hover:bg-neutral-600 transition aspect-square rounded-md cursor-pointer">
            <i class="text-white ri-arrow-up-line"></i>
          </button>`}
          ${index === bookmarksUserDefinedList.children.length - 1 ? "" : `<button id="bookmark-${index}-move-bookmark-down" class="bg-neutral-500 hover:bg-neutral-600 transition aspect-square rounded-md cursor-pointer">
