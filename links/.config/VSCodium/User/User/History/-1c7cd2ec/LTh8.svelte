<script>
  ...
  $inspect($scrollPercentage)
</script>

<nav
  class="sticky top-0 z-20 h-16 w-full border-b border-main bg-white/50 px-4 backdrop-blur dark:border-main-dark dark:bg-neutral-900/50 xl:h-24"
>
  <div class="flex flex-row items-center justify-between relative w-full h-full">
    ...
    <div class="absolute h-px top-full left-0 right-0">
      <div class="bg-primary-400 h-px" style:width={$scrollPercentage+"%"}></div>
    </div>
  </div>
</nav>
