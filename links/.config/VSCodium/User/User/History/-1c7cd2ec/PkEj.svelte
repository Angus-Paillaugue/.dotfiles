<script>
  ...
  function getLocaleConfig() {
    ...
    const matchingLocale = configLocales.find((configLocale) => configLocale.includes($locale));
    const localeConfig = configLocales.includes($locale) ? locale : i18n.defaultLocale;
