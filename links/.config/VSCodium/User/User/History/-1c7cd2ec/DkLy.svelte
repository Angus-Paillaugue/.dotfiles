...
<nav
  class="sticky top-0 z-20 h-16 w-full border-b border-main bg-white/50 backdrop-blur dark:border-main-dark dark:bg-neutral-900/50 xl:h-24 flex flex-row items-center justify-between px-4"
>
