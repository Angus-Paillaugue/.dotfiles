<script>
  ...
  import PageListCollapsible from './PageListCollapsible.svelte';
...
{#if style === 'details'}
  ...
  >
    {#each pages as page}
      {#if isNested(page)}
        <PageListCollapsible summary={page.name} classes={{itemBaseClasses, itemColors, activeItemColors}} open={developSidebar}>
