<script>
  ...
  onMount(() => {
    ...
    lenis.on('scroll', (event) => {
      ...
      const maxScrollValue = document.documentElement.scrollHeight - event.dimensions.scrollHeight;
      const progress = scrollValue / maxScrollValue;
      const trigger = scrollValue + progress * maxScrollValue;
      console.log(trigger);
    });
