            ...
            <Card.Root>
              <Card.Header>
                <div class="flex flex-row items-center justify-between">
                  ...
                  <div class="p-1 rounded border border-border font-mono items-center flex flex-row gap-1"><span class="text-sm font-base">ID:</span><span class="font-bold text-base">{server.id}</span></div>
                </div>
              </Card.Header>
              <Card.Content>
