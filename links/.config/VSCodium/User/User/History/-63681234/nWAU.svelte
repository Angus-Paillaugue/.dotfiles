  ...
  <div class="gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
    <Card.Root>
      ...
      <Card.Content>
        ...
        <div class="grid grid-cols-1 md:gris-cols-2 gap-8">
            ...
            <Card.Root>
              ...
              <Card.Content>
                <div class="flex justify-between">
                  <div>
                    <p class="text-sm text-muted-foreground">Status: {server.isOnline}</p>
                  </div>
                  <div>
                    <Button href={`/servers/${server.id}`}>Manage</Button>
                  </div>
                </div>
              </Card.Content>
            </Card.Root>
