...
<div class="z-50 fixed inset-0 grid grid-cols-12 grid-rows-12 pointer-events-none">
	{#each { length : 12 * 12} as _, i}
		<div class="w-full h-full bg-white felx flex-col items-center justify-center" style="opacity: 1;" style:animation={isLoaded && `2s ease ${i* 10}ms forwards fade`}>
			{#if i === (12 * 12) / 2}
				<svg xmlns="http://www.w3.org/2000/svg" class="size-12 text-black" viewBox="0 0 24 24">
