	...
	>
		...
		>
			...
			<div class="grid grid-cols-2 md:grid-cols-2 gap-8 w-full mt-4">
				<button
					class="sticky bottom-0 left-0 right-0 flex flex-row items-center justify-center text-lg font-medium gap-2 w-full px-4 py-2 bg-neutral-800 rounded-full text-text-heading-dark disabled:opacity-50 disabled:cursor-not-allowed transition-all"
					onclick={() => {
				...
				>
				<button
					class="sticky bottom-0 left-0 right-0 flex flex-row items-center justify-center text-lg font-medium gap-2 w-full px-4 py-2 bg-neutral-100 rounded-full text-text-heading disabled:opacity-50 disabled:cursor-not-allowed transition-all"
					onclick={() => {
						confirmCloseModalVisible = false;
					}}>No, cancel</button
				>
	...
	>
		...
		>
			...
			<div class="grow flex overflow-y-hidden w-full flex-col p-6 pt-0">
				...
				<!-- Save button -->
				<button
					class="flex flex-row items-center justify-center text-lg font-medium gap-2 w-full h-12 bg-neutral-800 rounded-full text-text-heading-dark disabled:bg-neutral-600 disabled:cursor-not-allowed transition-all mt-6 relative overflow-hidden"
