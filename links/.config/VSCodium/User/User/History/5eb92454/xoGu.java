...
public class Logger {
  ...
  public static void log(String message) {
    System.out.println("[" + ANSI_COLORS.get("") + "LOG" + ANSI_COLORS.get("RESET") + "]: " + message);
  }
  ...
  public static void success(String message) {
    System.out.println(ANSI_GREEN + "✓ " + ANSI_COLORS.get("RESET") + message);
  }
  ...
  public static void warn(String message) {
    System.out.println(ANSI_YELLOW + "! " + ANSI_COLORS.get("RESET") + message);
  }
}
