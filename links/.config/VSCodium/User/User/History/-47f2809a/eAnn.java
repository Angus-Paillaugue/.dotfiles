...
public class ChargesDAOTests {
  ...
  public void testCreate() {
    ...
    Charges charge2 = chargesDAO.create(c, idBienLouable);
    System.out.println("Test:"+charge1.getId());
    System.out.println("Test:"+charge2.getId());
    assertNotEquals(charge1.getId(), charge2.getId());
  }
