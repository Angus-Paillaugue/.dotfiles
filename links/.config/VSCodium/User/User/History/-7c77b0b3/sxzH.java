 	  	...
 	  	Connector db = Connector.getInstance();
			...
			if (results != null) {
				this.proprietaire = new Proprietaire(
					(String) results.get("nom"),
					(String) results.get("prenom"),
					new Adresse(
						(String) results.get("numero"),
						(String) results.get("adresse"),
						(String) results.get("ville"),
						(String) results.get("code_postal")
					),
					(String) results.get("mail"),
					(String) results.get("telephone")
				);
