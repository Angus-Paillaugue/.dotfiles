...
export class Draggable {
    ...
    const closeBtn = this._element.querySelector('.closeBtn');
    const minimizeBtn = this._element.querySelector('.minimizeBtn');
    const maximizeBtn = this._element.querySelector('.maximizeBtn');
