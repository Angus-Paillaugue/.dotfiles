...
public class TextField {
   ...
   *
   * @param label the text to be displayed as a label on the left side of the text field, can be
   *     null
  ...
  public TextField(String label, String value, String iconName) {
	...
	public TextField(String label, String value, String iconName, String name) {
		this.panel = new JPanel(new BorderLayout());
		this.panel.setBackground(null);
   ...
   *
   * @param label the text to be displayed as the label on the left side of the text field; if null,
