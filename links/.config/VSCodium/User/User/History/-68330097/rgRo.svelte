<script lang="ts">
  ...
  $inspect(playerDragMove)
</script>

{#if isPlayerFullScreen && $currentlyPlayingSong && player?.song}
	<!-- svelte-ignore a11y_no_static_element_interactions -->
	<div class="absolute inset-0 z-20 bg-background transition-transform duration-75" transition:fly={{ y: '100%', duration: 300 }} onmousedown={onPlayerMouseDown} onmouseup={onPlayerMouseUp} onmousemove={onPlayerMouseMove} ondrag={onPlayerMouseMove} ondragstart={onPlayerMouseDown} ondragend={onPlayerMouseUp}>
		<div
		...
		>
			...
			<div class="flex flex-col">
				{#key player.song}
          <div class="w-full relative aspect-square" style:transform={`translateX(${playerDragMove}px)`}>
