...
<div bind:this={cursor} class="w-full h-full z-50 transition-all fixed pointer-events-none max-md:hidden">
  <div class="relative h-full w-full pointer-events-none">
    <div class="absolute -translate-x-1/2 -translate-y-1/2 transition-colors w-0 h-0 shadow-[0_0_50px_20px_rgba(200,200,200,0.5)] dark:shadow-[0_0_0px_1px_rgba(0,0,0,1)]" style="top: {$coords.y}px; left: {$coords.x}px;"></div>
  </div>
</div>
