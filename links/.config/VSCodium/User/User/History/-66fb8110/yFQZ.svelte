                ...
                <button
                  ...
                  onclick={() => {
                    ...
                    if (isInUsersCategories) {
                      ...
                      console.log('Provider', providerExists, displayedCategories[activeProviderIndex].id, unsavedCategories.map((p) => p.id));
                      if (!providerExists) {
                        const provider = displayedCategories[activeProviderIndex];
                        provider.categories = [newItem];
                        unsavedCategories.push(provider);
                      } else {

                        unsavedCategories[activeProviderIndex].categories.push(
                          newItem
                        );
                      }
                    }
